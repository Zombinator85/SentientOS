...
mic_bridge.py – Captures microphone audio, converts speech to text, and infers emotions from spectral features.
...
valence, arousal, and dominance from your voice using spectral analysis and
modulates speech output accordingly. Interruptions are detected while the agent
speaks, and a small Flask demo (``browser_voice.py``) allows in-browser
experimentation.
