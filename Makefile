...
mypy-forge:
	$(PYTHON) -m mypy --strict --follow-imports=skip sentientos/cathedral_forge.py sentientos/forge_progress.py sentientos/forge.py sentientos/forge_cli/main.py sentientos/forge_cli/context.py sentientos/forge_cli/types.py sentientos/forge_cli/commands_queue.py sentientos/forge_cli/commands_sentinel.py sentientos/forge_cli/commands_train.py sentientos/forge_cli/commands_env_cache.py sentientos/forge_cli/commands_observatory.py sentientos/forge_cli/commands_provenance.py sentientos/forge_cli/commands_canary.py sentientos/forge_daemon.py sentientos/forge_queue.py sentientos/forge_index.py sentientos/forge_status.py sentientos/contract_sentinel.py sentientos/forge_progress_contract.py sentientos/forge_campaigns.py sentientos/forge_provenance.py sentientos/forge_replay.py sentientos/audit_reconcile.py sentientos/audit_doctor.py
