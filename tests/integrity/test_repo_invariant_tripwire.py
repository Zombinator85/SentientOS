...
FEDERATION_MODULE_ALLOWLIST = {
    ...
    "improvement_custody_runway",
    "improvement_dissemination_receipt",
    "improvement_intake_receipt",
    "improvement_lineage_comparison_receipt",
    "improvement_local_variant_artifact",
    "poller",
    "replay",
    "summary",
