...
def test_default_matrix_includes_promotion_gate_steps() -> None:
    ...
    assert "real_live_memory_commit_adapter_readiness_envelope_tests" in labels
    ...
    assert "real_executor_execution_commit_plan_gate_tests" in labels
    assert "real_executor_execution_commit_window_packet_tests" in labels
    assert "real_live_memory_commit_execution_gate_tests" in labels
    ...
    assert "future_live_memory_commit_execution_gate_tests" in labels
