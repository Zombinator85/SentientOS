...
This file records our audit integrity issues and their healing. Mismatched hashes from the early days remain visible so reviewers can trace how the protocol matured.
...
- 2025-12 Migration Sprint planning underway to collect recurring schema integrity issues.
...
- Integrity issue at entry #1: prev hash mismatch.
...
- Integrity issues at entries #993-1075: missing `data`, `prev_hash`, and `rolling_hash` due to truncated CLI output.
