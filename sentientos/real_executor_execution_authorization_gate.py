"""Deterministic metadata-only real executor execution authorization gate builder.

This module consumes supplied Real Executor Execution Authorization Packet evidence
and explicit Real Executor Execution Authorization Gate candidates. It emits
review metadata for a later Real Executor Execution Permit Packet only. It never enables, activates, invokes, locks, writes,
...
RealExecutorExecutionAuthorizationGateStatus = Literal[
    "real_executor_execution_authorization_gate_ready",
    ...
    "real_executor_execution_authorization_gate_invalid",
    "real_executor_execution_authorization_gate_failed",
]
RealExecutorExecutionAuthorizationGateDecision = Literal[
...
REAL_EXECUTOR_EXECUTION_AUTHORIZATION_GATE_CANDIDATE_TYPES = frozenset({
...
READY_REAL_EXECUTOR_EXECUTION_AUTHORIZATION_PACKET_DECISIONS = frozenset({
...
FAIL_STATUSES = {"real_executor_execution_authorization_gate_blocked", "real_executor_execution_authorization_gate_invalid", "real_executor_execution_authorization_gate_failed"}

EVIDENCE_MATCH_FIELDS: tuple[tuple[str, str, str, str], ...] = (
    ("real_executor_execution_authorization_packet", "claimed_real_executor_execution_authorization_packet_digest", "digest", "claimed_real_executor_execution_authorization_packet_decision"),
...
EVIDENCE_DECISION_RECORD_FIELDS = {
    "real_executor_execution_authorization_packet": "real_executor_execution_authorization_gate_primary_packet_decision",
...
NON_NOOP_METADATA_FIELDS = (
    "authorization_gate_readiness_metadata",
    "authorization_packet_confirmation_metadata",
    ...
    "future_real_executor_execution_permit_packet_requirement_metadata",
)

INVARIANTS: dict[str, bool] = {
    "real_executor_execution_authorization_gate_is_not_execution_authorization": True,
    "real_executor_execution_authorization_gate_is_not_permission_to_execute": True,
    "real_executor_execution_authorization_gate_is_not_executor_run": True,
    "real_executor_execution_authorization_gate_is_not_executor_execution": True,
    "real_executor_execution_authorization_gate_is_not_executor_invocation": True,
    "real_executor_execution_authorization_gate_is_not_runtime_enablement": True,
    "real_executor_execution_authorization_gate_is_not_runtime_flag_flip": True,
    "real_executor_execution_authorization_gate_is_not_live_commit_execution": True,
    "real_executor_execution_authorization_gate_is_not_enabled_executor": True,
    "real_executor_execution_authorization_gate_is_not_executor_enablement": True,
    "real_executor_execution_authorization_gate_is_not_executor_activation": True,
    "real_executor_execution_authorization_gate_is_not_lock_acquisition": True,
    "real_executor_execution_authorization_gate_is_not_lockfile_creation": True,
    "real_executor_execution_authorization_gate_is_not_memory_write": True,
    "real_executor_execution_authorization_gate_is_not_memory_deletion": True,
    "real_executor_execution_authorization_gate_is_not_memory_purge": True,
    "real_executor_execution_authorization_gate_is_not_index_mutation": True,
    "real_executor_execution_authorization_gate_is_not_capsule_persistence": True,
    "real_executor_execution_authorization_gate_is_not_tomb_completion": True,
    "real_executor_execution_authorization_gate_is_not_prompt_assembly": True,
    "real_executor_execution_authorization_gate_is_not_live_context_retrieval": True,
    "real_executor_execution_authorization_gate_is_not_action_execution": True,
    "real_executor_execution_authorization_gate_is_not_external_disclosure": True,
    "real_executor_execution_authorization_gate_is_not_truth": True,
    "real_executor_execution_authorization_gate_is_not_policy": True,
    "real_executor_execution_authorization_gate_is_not_authority": True,
    "real_executor_execution_authorization_gate_is_not_consent": True,
    "authorization_gate_readiness_is_metadata_only": True,
    "authorization_packet_confirmation_is_metadata_only": True,
    ...
    "future_real_executor_execution_permit_packet_required": True,
...
class RealExecutorExecutionAuthorizationGateFinding:
    severity: str; code: str; message: str; candidate_id: str = ""; record_id: str = ""
    def to_dict(self) -> dict[str, Any]: return asdict(self)

@dataclass(frozen=True)
class RealExecutorExecutionAuthorizationGatePolicy:
...
@dataclass(frozen=True)
class RealExecutorExecutionAuthorizationGateCandidate:
    ...
    @staticmethod
    def from_mapping(payload: Mapping[str, Any]) -> "RealExecutorExecutionAuthorizationGateCandidate":
        return RealExecutorExecutionAuthorizationGateCandidate(str(payload.get("candidate_id") or ""), str(payload.get("record_id") or ""), str(payload.get("candidate_type") or ""), tuple(str(v) for v in payload.get("operator_scope_keys", ())), _as_mapping(payload.get("metadata")), _as_mapping(payload.get("real_executor_execution_authorization_gate_claims") or payload.get("claims")))
    @property
    def is_noop(self) -> bool: return self.candidate_type in {"noop_real_executor_execution_authorization_gate_candidate", "noop_real_executor_execution_authorization_gate_candidate"}

@dataclass(frozen=True)
class RealExecutorExecutionAuthorizationGateMetadataRecord:
...
@dataclass(frozen=True)
class RealExecutorExecutionAuthorizationGateRecord:
    candidate_id: str; record_id: str; candidate_type: str; real_executor_execution_authorization_gate_decision: RealExecutorExecutionAuthorizationGateDecision
    ...
    authorization_gate_readiness_records: tuple[RealExecutorExecutionAuthorizationGateMetadataRecord, ...]
    authorization_packet_confirmation_records: tuple[RealExecutorExecutionAuthorizationGateMetadataRecord, ...]
    execution_authority_denial_records: tuple[RealExecutorExecutionAuthorizationGateMetadataRecord, ...]
    final_authorization_hold_point_records: tuple[RealExecutorExecutionAuthorizationGateMetadataRecord, ...]
    emergency_stop_confirmation_records: tuple[RealExecutorExecutionAuthorizationGateMetadataRecord, ...]
    rollback_readiness_records: tuple[RealExecutorExecutionAuthorizationGateMetadataRecord, ...]
    verification_readiness_records: tuple[RealExecutorExecutionAuthorizationGateMetadataRecord, ...]
    audit_readiness_records: tuple[RealExecutorExecutionAuthorizationGateMetadataRecord, ...]
    ...
    runtime_flag_target_state_is_active_runtime_state: bool = False; authorization_packet_confirmation_is_not_executor_execution: bool = False
    execution_hold_points_are_live_execution: bool = False; operator_review_cannot_override_hard_blockers: bool = True
    future_real_executor_execution_permit_packet_required: bool = True; future_real_live_memory_commit_execution_required: bool = True; future_post_execution_audit_required: bool = True
    digest: str = ""
    def to_dict(self) -> dict[str, Any]: return asdict(self)
    def with_digest(self) -> "RealExecutorExecutionAuthorizationGateRecord": return replace(self, digest=_digest({k: v for k, v in self.to_dict().items() if k != "digest"}))

@dataclass(frozen=True)
class RealExecutorExecutionAuthorizationGatePacket:
    schema_version: str; records: tuple[RealExecutorExecutionAuthorizationGateRecord, ...]; digest: str = ""; forbidden_next_steps: tuple[str, ...] = FORBIDDEN_NEXT_STEPS
    def to_dict(self) -> dict[str, Any]:
        payload = asdict(self); payload.update(INVARIANTS); return payload
    def with_digest(self) -> "RealExecutorExecutionAuthorizationGatePacket": return replace(self, digest=_digest({k: v for k, v in self.to_dict().items() if k != "digest"}))

@dataclass(frozen=True)
class RealExecutorExecutionAuthorizationGateReport:
    status: RealExecutorExecutionAuthorizationGateStatus; findings: tuple[RealExecutorExecutionAuthorizationGateFinding, ...]; summary_counts: Mapping[str, int]; digest: str = ""
...
@dataclass(frozen=True)
class RealExecutorExecutionAuthorizationGateResult:
    status: RealExecutorExecutionAuthorizationGateStatus; packet: RealExecutorExecutionAuthorizationGatePacket | None; report: RealExecutorExecutionAuthorizationGateReport; digest: str
...
def build_default_policy() -> RealExecutorExecutionAuthorizationGatePolicy: return RealExecutorExecutionAuthorizationGatePolicy()

def validate_policy(policy: RealExecutorExecutionAuthorizationGatePolicy | None = None) -> dict[str, Any]:
    active = policy or build_default_policy(); findings: list[RealExecutorExecutionAuthorizationGateFinding] = []
    if not active.default_deny or not active.metadata_only:
        findings.append(RealExecutorExecutionAuthorizationGateFinding("error", "policy_not_metadata_only_default_deny", "policy must remain metadata-only and default-deny"))
    for name in ("real_executor_enabled", "real_executor_runtime_enablement_enabled", "real_executor_enablement_enabled", "real_executor_invocation_enabled", "real_executor_run_enabled", "real_executor_activation_enabled", "real_lock_acquisition_enabled", "lockfile_creation_enabled", "real_memory_root_access_enabled"):
        if bool(getattr(active, name)):
            findings.append(RealExecutorExecutionAuthorizationGateFinding("error", name, f"{name} must remain false"))
    return {"status": "valid" if not findings else "invalid", "policy": active.to_dict(), "findings": [f.to_dict() for f in findings]}

def _blocked(code: str, findings: Sequence[RealExecutorExecutionAuthorizationGateFinding] = ()) -> RealExecutorExecutionAuthorizationGateResult:
    all_findings = tuple(findings) or (RealExecutorExecutionAuthorizationGateFinding("error", code, code),)
    report = RealExecutorExecutionAuthorizationGateReport("real_executor_execution_authorization_gate_blocked", all_findings, {"blocked": 1})
    report = replace(report, digest=_digest(report.to_dict()))
    return RealExecutorExecutionAuthorizationGateResult("real_executor_execution_authorization_gate_blocked", None, report, _digest(report.to_dict()))

def _metadata_record(kind: str, candidate: RealExecutorExecutionAuthorizationGateCandidate, metadata: Mapping[str, Any]) -> RealExecutorExecutionAuthorizationGateMetadataRecord:
    return RealExecutorExecutionAuthorizationGateMetadataRecord(kind, candidate.candidate_id, candidate.record_id, _digest(dict(metadata)))

def _valid_candidate(candidate: RealExecutorExecutionAuthorizationGateCandidate) -> bool:
    return bool(_ID_RE.match(candidate.candidate_id)) and bool(_ID_RE.match(candidate.record_id)) and candidate.candidate_type in REAL_EXECUTOR_EXECUTION_AUTHORIZATION_GATE_CANDIDATE_TYPES

def _real_executor_execution_authorization_packet_and_record(payload: Mapping[str, Any]) -> tuple[Mapping[str, Any], Mapping[str, Any]] | RealExecutorExecutionAuthorizationGateResult:
    packet = _as_mapping(payload.get("real_executor_execution_authorization_packet"))
    if not packet: return _blocked("missing_real_executor_execution_authorization_packet")
    records = packet.get("records")
    if not isinstance(records, Sequence) or isinstance(records, (str, bytes)) or not records: return _blocked("invalid_real_executor_execution_authorization_packet")
    record = _as_mapping(records[0])
    if not str(packet.get("digest") or "") or not str(record.get("digest") or ""): return _blocked("invalid_real_executor_execution_authorization_packet")
    return packet, record

def _candidate_list(payload: Mapping[str, Any]) -> Sequence[Any] | RealExecutorExecutionAuthorizationGateResult:
    candidates = payload.get("real_executor_execution_authorization_gate_candidates")
    if not isinstance(candidates, Sequence) or isinstance(candidates, (str, bytes)) or not candidates: return _blocked("missing_real_executor_execution_authorization_gate_candidate")
    return candidates

def _check_required_metadata(raw: Mapping[str, Any], candidate: RealExecutorExecutionAuthorizationGateCandidate) -> RealExecutorExecutionAuthorizationGateResult | None:
    ...
    for field in NON_NOOP_METADATA_FIELDS:
        if not isinstance(raw.get(field), Mapping) or not raw.get(field):
            return _blocked(f"missing_{field}", [RealExecutorExecutionAuthorizationGateFinding("error", f"missing_{field}", f"missing required non-noop metadata: {field}", candidate.candidate_id, candidate.record_id)])
    return None

def _check_evidence(raw: Mapping[str, Any], packet: Mapping[str, Any], record: Mapping[str, Any], candidate: RealExecutorExecutionAuthorizationGateCandidate) -> RealExecutorExecutionAuthorizationGateResult | None:
    decision = str(record.get("real_executor_execution_authorization_packet_decision") or "")
    if decision not in READY_REAL_EXECUTOR_EXECUTION_AUTHORIZATION_PACKET_DECISIONS:
        return _blocked("real_executor_execution_authorization_packet_not_ready", [RealExecutorExecutionAuthorizationGateFinding("error", "real_executor_execution_authorization_packet_not_ready", "real executor execution authorization packet is not ready by default", candidate.candidate_id, candidate.record_id)])
    for label, candidate_digest_field, record_digest_field, candidate_decision_field in EVIDENCE_MATCH_FIELDS:
        actual_digest = str(packet.get("digest") if label == "real_executor_execution_authorization_packet" else record.get(record_digest_field) or "")
        if label == "real_executor_execution_authorization_packet":
            actual_decision = str(record.get("real_executor_execution_authorization_packet_decision") or "")
        else:
        ...
        if str(raw.get(candidate_digest_field) or "") != actual_digest:
            return _blocked(f"{label}_digest_mismatch", [RealExecutorExecutionAuthorizationGateFinding("error", f"{label}_digest_mismatch", f"{label} digest mismatch", candidate.candidate_id, candidate.record_id)])
        if str(raw.get(candidate_decision_field) or "") != actual_decision:
            return _blocked(f"{label}_decision_mismatch", [RealExecutorExecutionAuthorizationGateFinding("error", f"{label}_decision_mismatch", f"{label} decision mismatch", candidate.candidate_id, candidate.record_id)])
    return None

def _check_scope(packet_record: Mapping[str, Any], candidate: RealExecutorExecutionAuthorizationGateCandidate, policy: RealExecutorExecutionAuthorizationGatePolicy) -> RealExecutorExecutionAuthorizationGateResult | None:
    if not policy.require_scope_alignment or candidate.candidate_type in {"mixed_real_executor_execution_authorization_gate_candidate", "mixed_real_executor_execution_authorization_gate_candidate"}: return None
    ...
    if upstream and candidate.operator_scope_keys != upstream:
        return _blocked("scope_mismatch", [RealExecutorExecutionAuthorizationGateFinding("error", "scope_mismatch", "real executor execution authorization gate candidate scope does not align with upstream evidence", candidate.candidate_id, candidate.record_id)])
    return None

def _claims_findings(candidate: RealExecutorExecutionAuthorizationGateCandidate) -> tuple[RealExecutorExecutionAuthorizationGateFinding, ...]:
    return tuple(RealExecutorExecutionAuthorizationGateFinding("error", code, f"forbidden real executor execution authorization gate claim blocked: {key}", candidate.candidate_id, candidate.record_id) for key, code in FORBIDDEN_CLAIM_CODES.items() if candidate.claims.get(key) is True)

def _decision(candidate: RealExecutorExecutionAuthorizationGateCandidate, findings: Sequence[RealExecutorExecutionAuthorizationGateFinding]) -> RealExecutorExecutionAuthorizationGateDecision:
    if candidate.is_noop: return "real_executor_execution_authorization_gate_noop"
    if candidate.candidate_type in {"operator_review_real_executor_execution_authorization_gate_candidate", "operator_review_real_executor_execution_authorization_gate_candidate"}: return "real_executor_execution_authorization_gate_deferred_for_operator_review"
    if any(f.severity == "warning" for f in findings) or candidate.candidate_type in {"mixed_real_executor_execution_authorization_gate_candidate", "mixed_real_executor_execution_authorization_gate_candidate"}: return "real_executor_execution_authorization_gate_ready_with_warnings"
    return "real_executor_execution_authorization_gate_ready_for_later_real_executor_execution_permit_packet"

def _safe_actions(decision: RealExecutorExecutionAuthorizationGateDecision) -> tuple[str, ...]:
    if decision == "real_executor_execution_authorization_gate_noop": return ("record_noop_metadata", "continue_review_without_executor_authority")
    if decision == "real_executor_execution_authorization_gate_deferred_for_operator_review": return ("operator_review_metadata", "resolve_without_overriding_hard_blockers")
    return ("review_real_executor_execution_authorization_gate_metadata", "prepare_separate_future_real_executor_execution_permit_packet_request")

def evaluate_real_executor_execution_authorization_gate(payload: Mapping[str, Any], policy: RealExecutorExecutionAuthorizationGatePolicy | None = None) -> RealExecutorExecutionAuthorizationGateResult:
    active_policy = policy or build_default_policy(); policy_validation = validate_policy(active_policy)
    if policy_validation["status"] != "valid": return _blocked("invalid_policy", tuple(RealExecutorExecutionAuthorizationGateFinding(**f) for f in policy_validation["findings"]))
    pair = _real_executor_execution_authorization_packet_and_record(payload)
    if isinstance(pair, RealExecutorExecutionAuthorizationGateResult): return pair
    authorization_packet, packet_record = pair
    candidates_raw = _candidate_list(payload)
    if isinstance(candidates_raw, RealExecutorExecutionAuthorizationGateResult): return candidates_raw
    findings: list[RealExecutorExecutionAuthorizationGateFinding] = []; records: list[RealExecutorExecutionAuthorizationGateRecord] = []
    try:
        for raw_value in candidates_raw:
            raw = _as_mapping(raw_value); candidate = RealExecutorExecutionAuthorizationGateCandidate.from_mapping(raw)
            if not _valid_candidate(candidate): return _blocked("invalid_real_executor_execution_authorization_gate_candidate", [RealExecutorExecutionAuthorizationGateFinding("error", "invalid_real_executor_execution_authorization_gate_candidate", "invalid real executor execution authorization gate candidate", candidate.candidate_id, candidate.record_id)])
            ...
            for check in (_check_required_metadata(raw, candidate), _check_scope(packet_record, candidate, active_policy), _check_evidence(raw, authorization_packet, packet_record, candidate)):
                if check is not None: return check
            if candidate.candidate_type in {"mixed_real_executor_execution_authorization_gate_candidate", "mixed_real_executor_execution_authorization_gate_candidate"} and candidate.metadata.get("diagnostic_warning") is True:
                findings.append(RealExecutorExecutionAuthorizationGateFinding("warning", "mixed_scope_diagnostic", "mixed real executor execution authorization gate diagnostics allowed as warnings only", candidate.candidate_id, candidate.record_id))
            decision = _decision(candidate, findings)
            records.append(RealExecutorExecutionAuthorizationGateRecord(
                candidate.candidate_id, candidate.record_id, candidate.candidate_type, decision,
                str(authorization_packet.get("digest") or ""), str(packet_record.get("real_executor_execution_authorization_packet_decision") or ""),
                ...
                (_metadata_record("authorization_gate_readiness", candidate, _as_mapping(raw.get("authorization_gate_readiness_metadata") or raw.get("metadata"))),),
                (_metadata_record("authorization_packet_confirmation", candidate, _as_mapping(raw.get("authorization_packet_confirmation_metadata") or raw.get("real_executor_execution_authorization_gate_prerequisite_metadata"))),),
                (_metadata_record("execution_authority_denial", candidate, _as_mapping(raw.get("execution_authority_denial_metadata") or raw.get("real_executor_execution_authorization_gate_hold_point_metadata"))),),
        ...
        for record in records:
            counts[record.real_executor_execution_authorization_gate_decision] = counts.get(record.real_executor_execution_authorization_gate_decision, 0) + 1
            counts[record.candidate_type] = counts.get(record.candidate_type, 0) + 1
        decisions = {r.real_executor_execution_authorization_gate_decision for r in records}
        if counts["warning_count"] or "real_executor_execution_authorization_gate_ready_with_warnings" in decisions: status: RealExecutorExecutionAuthorizationGateStatus = "real_executor_execution_authorization_gate_ready_with_warnings"
        elif decisions <= {"real_executor_execution_authorization_gate_noop"}: status = "real_executor_execution_authorization_gate_noop"
        elif decisions <= {"real_executor_execution_authorization_gate_deferred_for_operator_review"}: status = "real_executor_execution_authorization_gate_deferred_for_operator_review"
        else: status = "real_executor_execution_authorization_gate_ready"
        packet = RealExecutorExecutionAuthorizationGatePacket(active_policy.schema_version, tuple(records)).with_digest()
        report = RealExecutorExecutionAuthorizationGateReport(status, tuple(findings), dict(sorted(counts.items())))
        report = replace(report, digest=_digest(report.to_dict()))
        return RealExecutorExecutionAuthorizationGateResult(status, packet, report, _digest({"packet": packet.to_dict(), "report": report.to_dict()}))
    except Exception as exc:
        return _blocked("failed", [RealExecutorExecutionAuthorizationGateFinding("error", "failed", str(exc))])

def evaluate_packet(payload: Mapping[str, Any], policy: RealExecutorExecutionAuthorizationGatePolicy | None = None) -> RealExecutorExecutionAuthorizationGateResult:
    return evaluate_real_executor_execution_authorization_gate(payload, policy)

__all__ = [
    "EVIDENCE_MATCH_FIELDS", "FAIL_STATUSES", "FORBIDDEN_NEXT_STEPS", "INVARIANTS", "NON_NOOP_METADATA_FIELDS",
    "READY_REAL_EXECUTOR_EXECUTION_AUTHORIZATION_PACKET_DECISIONS", "REAL_EXECUTOR_EXECUTION_AUTHORIZATION_GATE_CANDIDATE_TYPES", "RealExecutorExecutionAuthorizationGateCandidate",
    "RealExecutorExecutionAuthorizationGateFinding", "RealExecutorExecutionAuthorizationGateMetadataRecord", "RealExecutorExecutionAuthorizationGatePacket", "RealExecutorExecutionAuthorizationGatePolicy",
    "RealExecutorExecutionAuthorizationGateRecord", "RealExecutorExecutionAuthorizationGateReport", "RealExecutorExecutionAuthorizationGateResult", "build_default_policy",
    "evaluate_packet", "evaluate_real_executor_execution_authorization_gate", "validate_policy",
]
