...
def _validate_handoff_minimum_fields(intent: Mapping[str, Any]) -> list[str]:
    return validate_handoff_minimum_fields_kernel(intent)
...
def resolve_unified_orchestration_result(
    ...
    *,
    ...
    return resolve_unified_orchestration_result_kernel(
        repo_root,
        handoff=handoff,
        handoff_packet=handoff_packet,
        executor_log_path=executor_log_path,
        resolve_orchestration_result=resolve_orchestration_result,
        resolve_handoff_packet_fulfillment_lifecycle=resolve_handoff_packet_fulfillment_lifecycle,
        iso_utc_now=_iso_utc_now,
        unified_result_classifications=_UNIFIED_RESULT_CLASSIFICATIONS,
        unified_result_resolution_paths=_UNIFIED_RESULT_RESOLUTION_PATHS,
    )
...
def derive_packetization_gate(
    ...
    return derive_packetization_gate_kernel(
        next_move_proposal,
        next_move_proposal_review,
        trust_confidence_posture,
        operator_attention_recommendation,
        anti_sovereignty_payload=_anti_sovereignty_payload,
        packetization_gating_outcomes=_PACKETIZATION_GATING_OUTCOMES,
...
def resolve_handoff_packet_fulfillment_lifecycle(
    ...
    return resolve_handoff_packet_fulfillment_lifecycle_kernel(
        repo_root,
        handoff_packet,
        read_jsonl=_read_jsonl,
        staged_external_lifecycle_states=_STAGED_EXTERNAL_LIFECYCLE_STATES,
...
def resolve_current_orchestration_next_move_brief(
    ...
    *,
    ...
    return _CURRENT_STATE_PROJECTIONS.resolve_current_orchestration_next_move_brief_projection(
        ...
        anti_sovereignty_payload_builder=_anti_sovereignty_payload,
        iso_utc_now=_iso_utc_now,
        current_orchestration_next_move_brief_id_builder=_current_orchestration_next_move_brief_id,
        current_orchestration_next_move_classifications=_CURRENT_ORCHESTRATION_NEXT_MOVE_CLASSIFICATIONS,
        current_orchestration_next_move_postures=_CURRENT_ORCHESTRATION_NEXT_MOVE_POSTURES,
        current_orchestration_next_move_brief_postures=_CURRENT_ORCHESTRATION_NEXT_MOVE_BRIEF_POSTURES,
        current_orchestration_state=current_orchestration_state,
        current_orchestration_watchpoint=current_orchestration_watchpoint,
        watchpoint_satisfaction=watchpoint_satisfaction,
        re_evaluation_trigger_recommendation=re_evaluation_trigger_recommendation,
...
def resolve_current_orchestration_export_packet(
    ...
    *,
    ...
    return _CURRENT_STATE_PROJECTIONS.resolve_current_orchestration_export_packet_projection(
        ...
        anti_sovereignty_payload_builder=_anti_sovereignty_payload,
        iso_utc_now=_iso_utc_now,
        current_orchestration_export_packet_id_builder=_current_orchestration_export_packet_id,
        current_orchestration_export_packet_classifications=_CURRENT_ORCHESTRATION_EXPORT_PACKET_CLASSIFICATIONS,
        current_orchestration_export_packet_maturity=_CURRENT_ORCHESTRATION_EXPORT_PACKET_MATURITY,
        current_orchestration_state=current_orchestration_state,
        current_orchestration_watchpoint=current_orchestration_watchpoint,
        current_orchestration_watchpoint_brief=current_orchestration_watchpoint_brief,
        watchpoint_satisfaction=watchpoint_satisfaction,
...
def admit_orchestration_intent(
    ...
    *,
    ...
    outcome, details = resolve_admission_handoff_outcome_kernel(
        intent,
        validate_handoff_minimum_fields=_validate_handoff_minimum_fields,
        handoff_outcomes=_HANDOFF_OUTCOMES,
        admit_internal_maintenance_intent=_INTERNAL_MAINTENANCE_ADAPTER.admit_internal_maintenance_intent,
