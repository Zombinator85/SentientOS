...
from sentientos import orchestration_current_projection
...
_CURRENT_WATCHPOINT_BRIEF_WAIT_KINDS = {
...
_CURRENT_RE_EVALUATION_BASIS_CLASSIFICATIONS = {
    "satisfaction_driven_re_evaluation",
    "operator_resolution_driven_re_evaluation",
    "internal_result_driven_re_evaluation",
    "external_fulfillment_driven_re_evaluation",
    "continuity_uncertainty_driven_re_evaluation",
    "no_current_re_evaluation_basis",
}

_CURRENT_RE_EVALUATION_BASIS_PRIMARY_DRIVERS = {
    "satisfaction",
    "result_closure",
    "operator_input",
...
_CURRENT_ORCHESTRATION_NEXT_MOVE_CLASSIFICATIONS = {
...
_CURRENT_ORCHESTRATION_NEXT_MOVE_POSTURES = {
    "wake_ready",
    "cautionary",
    "blocked",
    "not_applicable",
...
_CURRENT_ORCHESTRATION_NEXT_MOVE_BRIEF_POSTURES = {
    "informational_only",
    "conservative_hold",
    "blocked",
}
...
_CURRENT_ORCHESTRATION_RESOLUTION_PATH_CENTERS = {
    "proposal",
    "packet",
    "operator",
...
_CURRENT_ORCHESTRATION_CLOSURE_WAIT_PRIMARY = {
    "operator",
    "internal_result",
    "external_fulfillment",
    "packet_continuity",
...
_CURRENT_ORCHESTRATION_CLOSURE_POSTURES = {
    "blocked",
    "cautionary",
    "informational",
}
...
def _current_re_evaluation_basis_brief_id(
    *,
    ...
    return f"reb-{digest.hexdigest()[:16]}"


def _current_orchestration_next_move_brief_id(
    *,
    current_orchestration_state_id: str,
    orchestration_watchpoint_id: str,
    watchpoint_satisfaction_id: str,
        ...
        json.dumps(
            {
                ...
                "re_evaluation_trigger_id": re_evaluation_trigger_id,
                "orchestration_resumption_candidate_id": orchestration_resumption_candidate_id,
                "next_move_classification": next_move_classification,
            },
            sort_keys=True,
        ).encode("utf-8")
    )
...
def _current_orchestration_resolution_path_brief_id(
    *,
    current_orchestration_state_id: str,
    orchestration_watchpoint_id: str,
    watchpoint_satisfaction_id: str,
    ...
    return f"orp-{digest.hexdigest()[:16]}"


def _current_orchestration_closure_brief_id(
    *,
    current_orchestration_state_id: str,
    orchestration_watchpoint_id: str,
    watchpoint_satisfaction_id: str,
...
def resolve_current_orchestration_resumption_candidate(
    ...
    *,
    ...
    return orchestration_current_projection.resolve_current_orchestration_resumption_candidate_projection(
        repo_root,
        ...
        resumption_candidate_id_builder=_resumption_candidate_id,
        ...
        re_evaluation_recommendations=_RE_EVALUATION_RECOMMENDATIONS,
        re_evaluation_expected_actors=_RE_EVALUATION_EXPECTED_ACTORS,
        watchpoint_satisfaction_statuses=_WATCHPOINT_SATISFACTION_STATUSES,
...
def resolve_current_resumed_operation_readiness_verdict(
    *,
    ...
    return orchestration_current_projection.resolve_current_resumed_operation_readiness_verdict_projection(
        anti_sovereignty_payload_builder=_anti_sovereignty_payload,
        normalized_current_surface_boundaries_builder=_normalized_current_surface_boundaries,
        current_resumed_operation_readiness_id_builder=_current_resumed_operation_readiness_id,
        resumed_operation_readiness_verdicts=_RESUMED_OPERATION_READINESS_VERDICTS,
        current_orchestration_state=current_orchestration_state,
        current_orchestration_watchpoint=current_orchestration_watchpoint,
        watchpoint_satisfaction=watchpoint_satisfaction,
        re_evaluation_trigger_recommendation=re_evaluation_trigger_recommendation,
...
def resolve_current_orchestration_watchpoint_brief(
    repo_root: Path,
    *,
    current_orchestration_state: Mapping[str, Any] | None = None,
    current_orchestration_watchpoint: Mapping[str, Any] | None = None,
    ...
    return orchestration_current_projection.resolve_current_orchestration_watchpoint_brief_projection(
        repo_root,
        anti_sovereignty_payload_builder=_anti_sovereignty_payload,
        iso_utc_now=_iso_utc_now,
        watchpoint_brief_id_builder=_watchpoint_brief_id,
        current_watchpoint_brief_wait_kinds=_CURRENT_WATCHPOINT_BRIEF_WAIT_KINDS,
        resolve_current_orchestration_state=resolve_current_orchestration_state,
        resolve_current_orchestration_watchpoint=resolve_current_orchestration_watchpoint,
        resolve_watchpoint_satisfaction=resolve_watchpoint_satisfaction,
        resolve_re_evaluation_trigger_recommendation=resolve_re_evaluation_trigger_recommendation,
        ...
        derive_operator_resolution_influence=derive_operator_resolution_influence,
        current_orchestration_state=current_orchestration_state,
        current_orchestration_watchpoint=current_orchestration_watchpoint,
        watchpoint_satisfaction=watchpoint_satisfaction,
        re_evaluation_trigger_recommendation=re_evaluation_trigger_recommendation,
...
def resolve_current_orchestration_pressure_signal(
    ...
    *,
    ...
    return orchestration_current_projection.resolve_current_orchestration_pressure_signal_projection(
        repo_root,
        anti_sovereignty_payload_builder=_anti_sovereignty_payload,
        iso_utc_now=_iso_utc_now,
        current_orchestration_pressure_id_builder=_current_orchestration_pressure_id,
        current_orchestration_pressure_classes=_CURRENT_ORCHESTRATION_PRESSURE_CLASSES,
        current_orchestration_pressure_drivers=_CURRENT_ORCHESTRATION_PRESSURE_DRIVERS,
        resolve_current_orchestration_state=resolve_current_orchestration_state,
        resolve_current_orchestration_watchpoint=resolve_current_orchestration_watchpoint,
        resolve_watchpoint_satisfaction=resolve_watchpoint_satisfaction,
        resolve_re_evaluation_trigger_recommendation=resolve_re_evaluation_trigger_recommendation,
...
def resolve_current_orchestration_wake_readiness_detector(
    ...
    *,
    ...
    return orchestration_current_projection.resolve_current_orchestration_wake_readiness_detector_projection(
        anti_sovereignty_payload_builder=_anti_sovereignty_payload,
        current_wake_readiness_detector_id_builder=_current_wake_readiness_detector_id,
        iso_utc_now=_iso_utc_now,
        current_wake_readiness_classifications=_CURRENT_WAKE_READINESS_CLASSIFICATIONS,
        current_wake_readiness_postures=_CURRENT_WAKE_READINESS_POSTURES,
        current_orchestration_state=current_orchestration_state,
        current_orchestration_watchpoint=current_orchestration_watchpoint,
        watchpoint_satisfaction=watchpoint_satisfaction,
        re_evaluation_trigger_recommendation=re_evaluation_trigger_recommendation,
...
def resolve_current_re_evaluation_basis_brief(
    repo_root: Path,
    *,
    current_orchestration_state: Mapping[str, Any] | None = None,
    current_orchestration_watchpoint: Mapping[str, Any] | None = None,
...
def resolve_current_orchestration_next_move_brief(
    ...
    *,
    ...
    if classification not in _CURRENT_ORCHESTRATION_NEXT_MOVE_CLASSIFICATIONS:
        classification = "hold_for_operator_review_next"
    ...
    if move_posture not in _CURRENT_ORCHESTRATION_NEXT_MOVE_POSTURES:
        move_posture = "cautionary"
    ...
    if brief_posture not in _CURRENT_ORCHESTRATION_NEXT_MOVE_BRIEF_POSTURES:
        brief_posture = "conservative_hold"
    ...
    return {
        ...
        "resolved_at": _iso_utc_now(),
        "current_orchestration_next_move_brief_id": _current_orchestration_next_move_brief_id(
            current_orchestration_state_id=state_id,
            orchestration_watchpoint_id=watchpoint_id,
            watchpoint_satisfaction_id=satisfaction_id,
            re_evaluation_trigger_id=trigger_id,
...
def resolve_current_orchestration_handoff_packet_brief(
    ...
    *,
    ...
    return orchestration_current_projection.resolve_current_orchestration_handoff_packet_brief_projection(
        repo_root,
...
def resolve_current_operator_facing_orchestration_brief(
    ...
    *,
    ...
    return orchestration_current_projection.resolve_current_operator_facing_orchestration_brief_projection(
        repo_root,
        _anti_sovereignty_payload=_anti_sovereignty_payload,
...
def resolve_current_orchestration_resolution_path_brief(
    repo_root: Path,
    *,
    current_orchestration_state: Mapping[str, Any] | None = None,
    current_orchestration_watchpoint: Mapping[str, Any] | None = None,
    ...
    return orchestration_current_projection.resolve_current_orchestration_resolution_path_brief_projection(
        repo_root,
        _anti_sovereignty_payload=_anti_sovereignty_payload,
...
def resolve_current_orchestration_closure_brief(
    repo_root: Path,
    *,
    current_orchestration_state: Mapping[str, Any] | None = None,
    current_orchestration_watchpoint: Mapping[str, Any] | None = None,
    ...
    return orchestration_current_projection.resolve_current_orchestration_closure_brief_projection(
        repo_root,
        _anti_sovereignty_payload=_anti_sovereignty_payload,
        _current_orchestration_closure_brief_id=_current_orchestration_closure_brief_id,
        _CURRENT_ORCHESTRATION_CLOSURE_BRIEF_CLASSIFICATIONS=_CURRENT_ORCHESTRATION_CLOSURE_BRIEF_CLASSIFICATIONS,
        _CURRENT_ORCHESTRATION_CLOSURE_WAIT_PRIMARY=_CURRENT_ORCHESTRATION_CLOSURE_WAIT_PRIMARY,
        _CURRENT_ORCHESTRATION_CLOSURE_POSTURES=_CURRENT_ORCHESTRATION_CLOSURE_POSTURES,
        current_orchestration_state=current_orchestration_state,
        current_orchestration_watchpoint=current_orchestration_watchpoint,
        current_orchestration_watchpoint_brief=current_orchestration_watchpoint_brief,
        watchpoint_satisfaction=watchpoint_satisfaction,
...
def resolve_current_orchestration_coherence_brief(
    ...
    *,
    ...
    return orchestration_current_projection.resolve_current_orchestration_coherence_brief(
        repo_root,
        anti_sovereignty_payload_builder=_anti_sovereignty_payload,
        current_orchestration_state=current_orchestration_state,
        current_orchestration_watchpoint=current_orchestration_watchpoint,
...
def resolve_current_orchestration_digest(
    ...
    *,
    ...
    return orchestration_current_projection.resolve_current_orchestration_digest(
        repo_root,
        anti_sovereignty_payload_builder=_anti_sovereignty_payload,
        current_orchestration_state=current_orchestration_state,
        current_orchestration_watchpoint=current_orchestration_watchpoint,
...
def resolve_current_orchestration_transition_brief(
    ...
    *,
    ...
    return orchestration_current_projection.resolve_current_orchestration_transition_brief(
        repo_root,
        anti_sovereignty_payload_builder=_anti_sovereignty_payload,
        current_orchestration_state=current_orchestration_state,
        current_orchestration_watchpoint=current_orchestration_watchpoint,
...
def resolve_current_orchestration_export_packet_consumer_receipt(
    ...
    *,
    ...
    return orchestration_current_projection.resolve_current_orchestration_export_packet_consumer_receipt(
        repo_root,
        anti_sovereignty_payload_builder=_anti_sovereignty_payload,
...
def resolve_current_orchestration_handoff_acceptance_posture(
    ...
    *,
    ...
    return orchestration_current_projection.resolve_current_orchestration_handoff_acceptance_posture(
        repo_root,
        anti_sovereignty_payload_builder=_anti_sovereignty_payload,
        current_orchestration_export_packet=current_orchestration_export_packet,
