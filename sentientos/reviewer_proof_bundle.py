...
def build_reviewer_proof_bundle_payload(
    *,
    ...
    contents: dict[str, str] = {
        ...
        "real_live_memory_commit_adapter_readiness_envelope_capability": _pretty_json({"artifact_kind": "real_live_memory_commit_adapter_readiness_envelope_capability", "capability_id": "real_live_memory_commit_adapter_readiness_envelope", "category": "memory_distillation", "status": "implemented", "authority_level": "metadata_verification_only", "metadata_only": True, "proof_command_not_run": True, "cli_reference": "scripts/build_real_live_memory_commit_adapter_readiness_envelope.py", "matrix_reference": "scripts/run_work_item_review_packet_matrix.py", "docs_reference": "docs/architecture/real_live_memory_commit_adapter_readiness_envelope.md", "blocked_or_deferred_surfaces": ["future explicit runtime execution gate", "future operator runtime confirmation", "real live memory commit adapter execution", "real memory-root access", "runtime memory write", "runtime memory deletion", "runtime memory purge", "live index mutation", "capsule persistence", "tomb completion", "prompt assembly", "live context retrieval", "provider/network/GitHub calls", "external disclosure", "action execution", "authority escalation", "policy creation", "consent inference", "truth inference", "sandbox bypass", "real-root admission bypass", "final-review bypass"], "forbidden_next_steps": ["write_live_memory_now", "delete_live_memory_now", "purge_live_memory_now", "mutate_vector_index", "mutate_live_index", "persist_capsule_now", "complete_tomb_now", "assemble_prompt_now", "retrieve_live_context", "execute_action_ingress", "direct_adapter_execution", "bypass_sandbox_commit_adapter", "bypass_real_root_admission_gate", "bypass_final_live_commit_review_gate", "bypass_future_explicit_runtime_execution_gate", "bypass_operator_runtime_confirmation", "enable_external_disclosure"], "explicit_non_authority_boundaries": list(EXPLICIT_NON_AUTHORITY_BOUNDARIES)}),
