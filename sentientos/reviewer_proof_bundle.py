...
REVIEWER_PROOF_ARTIFACT_KINDS = frozenset(
    {
        ...
        "household_presence_camera_operator_grant_renewal_request_packet_capability",
        ...
        "governed_memory_writer_adapter_capability",
        "memory_commit_plan_packet_capability",
        "memory_commit_operator_approval_packet_capability",
        "memory_commit_execution_gate_capability",
        "live_memory_commit_dry_run_adapter_capability",
        "live_commit_safety_interlock_capability",
        "sandboxed_live_memory_commit_adapter_capability",
        "sandboxed_live_memory_commit_adapter_gate_capability",
        "real_memory_root_admission_gate_capability",
        "real_memory_root_admission_packet_capability",
        "real_live_memory_commit_adapter_readiness_gate_capability",
        "real_live_memory_commit_adapter_readiness_envelope_capability",
        "explicit_live_memory_runtime_execution_gate_capability",
        "real_live_memory_commit_executor_plan_packet_capability",
        "live_executor_lock_lease_gate_capability",
        "live_executor_preflight_packet_capability",
        "live_executor_activation_record_capability",
        "live_executor_invocation_harness_capability",
        ...
        "real_executor_execution_invocation_gate_capability",
        "real_executor_execution_preflight_packet_capability",
        "real_executor_execution_preflight_gate_capability",
        "real_executor_execution_lock_lease_packet_capability",
        "real_executor_execution_lock_lease_gate_capability",
...
BUNDLE_FILE_NAMES = {
    ...
    "work_item_lifecycle_attestation_index_verifier_capability": "work_item_lifecycle_attestation_index_verifier_capability.json",
    "work_item_lifecycle_attestation_review_digest_capability": "work_item_lifecycle_attestation_review_digest_capability.json",
    "work_item_lifecycle_attestation_review_digest_verifier_capability": "work_item_lifecycle_attestation_review_digest_verifier_capability.json",
    "work_item_lifecycle_attestation_review_digest_index_capability": "work_item_lifecycle_attestation_review_digest_index_capability.json",
    "work_item_lifecycle_attestation_review_digest_index_verifier_capability": "work_item_lifecycle_attestation_review_digest_index_verifier_capability.json",
    "household_presence_camera_capture_review_decision_ledger_capability": "household_presence_camera_capture_review_decision_ledger_capability.json",
    "household_presence_camera_operator_review_trend_ledger_capability": "household_presence_camera_operator_review_trend_ledger_capability.json",
    "household_presence_camera_operator_grant_renewal_request_packet_capability": "household_presence_camera_operator_grant_renewal_request_packet_capability.json",
    ...
    "selective_memory_distillation_receipt_gate_capability": "selective_memory_distillation_receipt_gate_capability.json",
    "selective_memory_tomb_receipt_verifier_capability": "selective_memory_tomb_receipt_verifier_capability.json",
    "governed_memory_writer_adapter_capability": "governed_memory_writer_adapter_capability.json",
    "memory_commit_plan_packet_capability": "memory_commit_plan_packet_capability.json",
    "memory_commit_operator_approval_packet_capability": "memory_commit_operator_approval_packet_capability.json",
    "memory_commit_execution_gate_capability": "memory_commit_execution_gate_capability.json",
    "live_memory_commit_dry_run_adapter_capability": "live_memory_commit_dry_run_adapter_capability.json",
    "live_commit_safety_interlock_capability": "live_commit_safety_interlock_capability.json",
    "sandboxed_live_memory_commit_adapter_capability": "sandboxed_live_memory_commit_adapter_capability.json",
    "sandboxed_live_memory_commit_adapter_gate_capability": "sandboxed_live_memory_commit_adapter_gate_capability.json",
    "real_memory_root_admission_gate_capability": "real_memory_root_admission_gate_capability.json",
    "real_memory_root_admission_packet_capability": "real_memory_root_admission_packet_capability.json",
    "real_live_memory_commit_adapter_readiness_gate_capability": "real_live_memory_commit_adapter_readiness_gate_capability.json",
    "real_live_memory_commit_adapter_readiness_envelope_capability": "real_live_memory_commit_adapter_readiness_envelope_capability.json",
    "explicit_live_memory_runtime_execution_gate_capability": "explicit_live_memory_runtime_execution_gate_capability.json",
    "real_live_memory_commit_executor_plan_packet_capability": "real_live_memory_commit_executor_plan_packet_capability.json",
    "live_executor_lock_lease_gate_capability": "live_executor_lock_lease_gate_capability.json",
    "live_executor_preflight_packet_capability": "live_executor_preflight_packet_capability.json",
    "live_executor_activation_record_capability": "live_executor_activation_record_capability.json",
    "live_executor_invocation_harness_capability": "live_executor_invocation_harness_capability.json",
    ...
    "real_executor_execution_invocation_gate_capability": "real_executor_execution_invocation_gate_capability.json",
    "real_executor_execution_preflight_packet_capability": "real_executor_execution_preflight_packet_capability.json",
    "real_executor_execution_preflight_gate_capability": "real_executor_execution_preflight_gate_capability.json",
    "real_executor_execution_lock_lease_packet_capability": "real_executor_execution_lock_lease_packet_capability.json",
    "real_executor_execution_lock_lease_gate_capability": "real_executor_execution_lock_lease_gate_capability.json",
...
def build_default_reviewer_proof_commands() -> tuple[ReviewerProofCommandRecord, ...]:
    commands = (
        ...
        (("python", "-m", "scripts.run_tests", "-q", "tests/test_host_resource_runtime.py", "tests/test_build_host_resource_runtime_script.py"), "Run admitted read-only host resource observation runtime closure tests."),
        (("python", "-m", "scripts.run_tests", "-q", "tests/test_host_privilege_review_runtime.py", "tests/test_build_host_privilege_review_runtime_script.py", "tests/test_privilege_broker.py", "tests/test_actuation_fulfillment.py"), "Run admitted host privilege review and fulfillment rehearsal runtime tests."),
...
def build_reviewer_proof_bundle_payload(
    *,
    ...
    contents: dict[str, str] = {
        ...
        "host_privilege_review_rehearsal_runtime_posture": _pretty_json({"artifact_kind": "host_privilege_review_rehearsal_runtime_posture", "capability_id": "host_privilege_review_rehearsal_runtime", "status": "implemented", "authority_level": "rehearsal_only", "metadata_only": True, "proof_statement": "Same-tick host proposal receipts are admitted for metadata classification only, linked through broker review and fulfillment rehearsal evidence, projected into World-State, and never grant host effects.", "source_paths": ["sentientos/host_privilege_review_runtime.py", "scripts/build_host_privilege_review_runtime.py", "sentientosd.py", "apps/dashboard/main.py"], "proof_tests": ["tests/test_host_privilege_review_runtime.py", "tests/test_build_host_privilege_review_runtime_script.py"], "matrix_lane": "host_privilege_review_rehearsal_runtime_tests", "forbidden_downstream_effects": {"privileged_execution_performed": False, "operator_approval_fabricated": False, "host_mutation_performed": False, "fulfillment_granted": False, "effect_proven": False, "rollback_executed": False}, "explicit_non_authority_boundaries": list(EXPLICIT_NON_AUTHORITY_BOUNDARIES)}),
        "world_state_evidence_board_snapshot": _pretty_json({"artifact_kind": "world_state_evidence_board_snapshot", "capability_id": "world_state_evidence_board", "status": "implemented", "authority_level": "metadata_verification_only", "metadata_only": True, "proof_statement": "The World-State Evidence Board is a deterministic read-only projection with explicit false decision, admission, execution, adoption, and repository-mutation authority fields.", "source_paths": ["sentientos/world_state_board.py", "sentientos/world_state_sources.py", "scripts/build_world_state_board.py", "sentientosd.py", "apps/dashboard/main.py"], "proof_tests": ["tests/test_world_state_board.py", "tests/test_world_state_sources.py", "tests/test_build_world_state_board_script.py", "tests/test_dashboard_world_state.py", "tests/test_sentientosd_runtime_closure.py"], "matrix_lane": "world_state_evidence_board_tests", "forbidden_downstream_effects": {"decision_performed": False, "admission_performed": False, "execution_performed": False, "adoption_performed": False, "repository_mutation_performed": False, "model_invoked": False, "host_effect_performed": False}, "explicit_non_authority_boundaries": list(EXPLICIT_NON_AUTHORITY_BOUNDARIES)}),
        "genesis_local_model_proposal_advice_posture": _pretty_json({"artifact_kind": "genesis_local_model_proposal_advice_posture", "capability_id": "genesis_local_model_proposal_advice", "status": "implemented", "authority_level": "proposal_only", "metadata_only": True, "proof_statement": "Governed Genesis local-model advice is one bounded untrusted candidate inside K; it is not approval, adoption, repository mutation, tool use, memory access, or provider/network authority.", "source_paths": ["sentientos/genesis_model_advice.py", "sentientos/genesis_forge.py", "sentientos/governed_local_model_invocation.py", "sentientosd.py"], "proof_tests": ["tests/test_genesis_model_advice.py", "tests/test_build_genesis_model_advice_script.py", "tests/test_governed_local_model_invocation.py", "tests/test_genesis_forge.py", "tests/test_sentientosd_runtime_closure.py"], "matrix_lane": "genesis_model_advice_runtime_closure_tests", "forbidden_downstream_effects": {"approved": False, "adopted": False, "lineage_integrated": False, "repository_mutation_performed": False, "tool_invoked": False, "memory_written": False, "remote_service_called": False}, "explicit_non_authority_boundaries": list(EXPLICIT_NON_AUTHORITY_BOUNDARIES)}),
        ...
        "governed_memory_writer_adapter_capability": _pretty_json({"artifact_kind": "governed_memory_writer_adapter_capability", "capability_id": "governed_memory_writer_adapter", "category": "memory_distillation", "status": "implemented", "authority_level": "metadata_verification_only", "metadata_only": True, "proof_command_not_run": True, "cli_reference": "scripts/build_governed_memory_writer_adapter.py", "matrix_reference": "scripts/run_work_item_review_packet_matrix.py", "docs_reference": "docs/architecture/governed_memory_writer_adapter.md", "blocked_or_deferred_surfaces": ["runtime memory write", "runtime memory deletion", "capsule persistence", "tomb completion", "vector index mutation", "prompt assembly", "provider/network/GitHub calls", "external disclosure", "action execution", "authority escalation", "policy creation", "consent inference", "truth inference"], "forbidden_next_steps": ["write_live_memory_now", "delete_memory_now", "purge_memory_now", "silently_write_memory", "silently_delete_memory", "mutate_vector_index", "assemble_prompt_now", "retrieve_live_context", "execute_action_ingress", "infer_truth_from_writer", "infer_authority_from_writer", "convert_writer_receipt_to_policy", "convert_writer_to_action", "bypass_tomb_verifier", "enable_external_disclosure"], "explicit_non_authority_boundaries": list(EXPLICIT_NON_AUTHORITY_BOUNDARIES)}),
        "memory_commit_plan_packet_capability": _pretty_json({"artifact_kind": "memory_commit_plan_packet_capability", "capability_id": "memory_commit_plan_packet", "category": "memory_distillation", "status": "implemented", "authority_level": "metadata_verification_only", "metadata_only": True, "proof_command_not_run": True, "cli_reference": "scripts/build_memory_commit_plan_packet.py", "matrix_reference": "scripts/run_work_item_review_packet_matrix.py", "docs_reference": "docs/architecture/memory_commit_plan_packet.md", "blocked_or_deferred_surfaces": ["runtime memory write", "runtime memory deletion", "capsule persistence", "tomb completion", "vector index mutation", "prompt assembly", "provider/network/GitHub calls", "external disclosure", "action execution", "authority escalation", "policy creation", "consent inference", "truth inference"], "forbidden_next_steps": ["write_live_memory_now", "delete_live_memory_now", "purge_live_memory_now", "persist_capsule_now", "persist_summary_now", "apply_protection_now", "apply_merge_now", "complete_tomb_now", "execute_commit_plan_now", "mutate_vector_index", "assemble_prompt_now", "retrieve_live_context", "execute_action_ingress", "infer_truth_from_commit_plan", "infer_authority_from_commit_plan", "infer_consent_from_commit_plan", "convert_commit_plan_to_policy", "convert_commit_plan_to_action", "bypass_live_boundary_admission", "enable_external_disclosure"], "explicit_non_authority_boundaries": list(EXPLICIT_NON_AUTHORITY_BOUNDARIES)}),
        "memory_commit_operator_approval_packet_capability": _pretty_json({"artifact_kind": "memory_commit_operator_approval_packet_capability", "capability_id": "memory_commit_operator_approval_packet", "category": "memory_distillation", "status": "implemented", "authority_level": "metadata_verification_only", "metadata_only": True, "proof_command_not_run": True, "cli_reference": "scripts/build_memory_commit_operator_approval_packet.py", "matrix_reference": "scripts/run_work_item_review_packet_matrix.py", "docs_reference": "docs/architecture/memory_commit_operator_approval_packet.md", "blocked_or_deferred_surfaces": ["runtime memory write", "runtime memory deletion", "capsule persistence", "tomb completion", "vector index mutation", "prompt assembly", "provider/network/GitHub calls", "external disclosure", "action execution", "authority escalation", "policy creation", "consent inference", "truth inference", "approval execution"], "forbidden_next_steps": ["write_live_memory_now", "delete_live_memory_now", "purge_live_memory_now", "persist_capsule_now", "persist_summary_now", "apply_protection_now", "apply_merge_now", "complete_tomb_now", "execute_commit_plan_now", "execute_operator_approval_now", "treat_approval_as_execution", "mutate_vector_index", "assemble_prompt_now", "retrieve_live_context", "execute_action_ingress", "infer_truth_from_operator_approval", "infer_authority_from_operator_approval", "infer_consent_from_operator_approval", "convert_operator_approval_to_policy", "convert_operator_approval_to_action", "bypass_commit_plan_packet", "enable_external_disclosure"], "explicit_non_authority_boundaries": list(EXPLICIT_NON_AUTHORITY_BOUNDARIES)}),
        "memory_commit_execution_gate_capability": _pretty_json({"artifact_kind": "memory_commit_execution_gate_capability", "capability_id": "memory_commit_execution_gate", "category": "memory_distillation", "status": "implemented", "authority_level": "metadata_verification_only", "metadata_only": True, "proof_command_not_run": True, "cli_reference": "scripts/build_memory_commit_execution_gate.py", "matrix_reference": "scripts/run_work_item_review_packet_matrix.py", "docs_reference": "docs/architecture/memory_commit_execution_gate.md", "blocked_or_deferred_surfaces": ["runtime memory write", "runtime memory deletion", "live memory commit adapter", "future live dry-run", "capsule persistence", "tomb completion", "vector index mutation", "prompt assembly", "provider/network/GitHub calls", "external disclosure", "action execution", "authority escalation", "policy creation", "consent inference", "truth inference", "commit plan execution", "operator approval execution"], "forbidden_next_steps": ["write_live_memory_now", "delete_live_memory_now", "purge_live_memory_now", "persist_capsule_now", "persist_summary_now", "apply_protection_now", "apply_merge_now", "complete_tomb_now", "run_live_commit_now", "execute_commit_plan_now", "execute_operator_approval_now", "execute_memory_commit_execution_gate_now", "treat_gate_as_execution", "mutate_vector_index", "assemble_prompt_now", "retrieve_live_context", "execute_action_ingress", "infer_truth_from_execution_gate", "infer_authority_from_execution_gate", "infer_consent_from_execution_gate", "convert_execution_gate_to_policy", "convert_execution_gate_to_action", "bypass_commit_plan_packet", "bypass_operator_approval_packet", "enable_external_disclosure"], "explicit_non_authority_boundaries": list(EXPLICIT_NON_AUTHORITY_BOUNDARIES)}),
        "live_memory_commit_dry_run_adapter_capability": _pretty_json({"artifact_kind": "live_memory_commit_dry_run_adapter_capability", "capability_id": "live_memory_commit_dry_run_adapter", "category": "memory_distillation", "status": "implemented", "authority_level": "metadata_verification_only", "metadata_only": True, "proof_command_not_run": True, "cli_reference": "scripts/build_live_memory_commit_dry_run_adapter.py", "matrix_reference": "scripts/run_work_item_review_packet_matrix.py", "docs_reference": "docs/architecture/live_memory_commit_dry_run_adapter.md", "blocked_or_deferred_surfaces": ["runtime memory write", "runtime memory deletion", "live memory commit adapter", "live commit safety interlock", "capsule persistence", "summary persistence", "tomb completion", "vector index mutation", "prompt assembly", "provider/network/GitHub calls", "external disclosure", "action execution", "authority escalation", "policy creation", "consent inference", "truth inference", "commit plan execution", "operator approval execution", "execution gate bypass"], "forbidden_next_steps": ["write_live_memory_now", "delete_live_memory_now", "purge_live_memory_now", "mutate_raw_fragment", "mutate_vector_index", "mutate_distilled_memory", "persist_capsule_now", "persist_summary_now", "apply_protection_now", "apply_merge_now", "complete_tomb_now", "run_live_commit_now", "execute_dry_run_as_commit", "execute_commit_plan_now", "execute_operator_approval_now", "treat_dry_run_as_execution", "treat_dry_run_as_live_commit", "call_append_memory", "call_purge_memory", "call_apply_forgetting_curve", "call_curate_memory", "call_summarize_memory", "assemble_prompt_now", "retrieve_live_context", "execute_action_ingress", "infer_truth_from_dry_run", "infer_authority_from_dry_run", "infer_consent_from_dry_run", "convert_dry_run_to_policy", "convert_dry_run_to_action", "bypass_execution_gate", "bypass_operator_approval_packet", "bypass_commit_plan_packet", "bypass_live_boundary_admission", "bypass_governed_writer_adapter", "bypass_tomb_verifier", "bypass_receipt_gate", "bypass_distillation_contract", "bypass_operator_review", "enable_external_disclosure"], "explicit_non_authority_boundaries": list(EXPLICIT_NON_AUTHORITY_BOUNDARIES)}),
        "live_commit_safety_interlock_capability": _pretty_json({"artifact_kind": "live_commit_safety_interlock_capability", "capability_id": "live_commit_safety_interlock", "category": "memory_distillation", "status": "implemented", "authority_level": "metadata_verification_only", "metadata_only": True, "proof_command_not_run": True, "cli_reference": "scripts/build_live_commit_safety_interlock.py", "matrix_reference": "scripts/run_work_item_review_packet_matrix.py", "docs_reference": "docs/architecture/live_commit_safety_interlock.md", "blocked_or_deferred_surfaces": ["runtime memory write", "runtime memory deletion", "live memory commit adapter", "final live commit review", "capsule persistence", "summary persistence", "tomb completion", "vector index mutation", "prompt assembly", "provider/network/GitHub calls", "external disclosure", "action execution", "authority escalation", "policy creation", "consent inference", "truth inference", "dry-run adapter bypass", "execution gate bypass"], "forbidden_next_steps": ["write_live_memory_now", "delete_live_memory_now", "purge_live_memory_now", "mutate_raw_fragment", "mutate_vector_index", "mutate_distilled_memory", "persist_capsule_now", "persist_summary_now", "apply_protection_now", "apply_merge_now", "complete_tomb_now", "run_live_commit_now", "execute_dry_run_as_commit", "execute_interlock_as_commit", "execute_commit_plan_now", "execute_operator_approval_now", "treat_interlock_as_execution", "treat_interlock_as_live_commit", "call_append_memory", "call_purge_memory", "call_apply_forgetting_curve", "call_curate_memory", "call_summarize_memory", "assemble_prompt_now", "retrieve_live_context", "execute_action_ingress", "infer_truth_from_interlock", "infer_authority_from_interlock", "infer_consent_from_interlock", "convert_interlock_to_policy", "convert_interlock_to_action", "bypass_dry_run_adapter", "bypass_execution_gate", "bypass_operator_approval_packet", "bypass_commit_plan_packet", "bypass_live_boundary_admission", "bypass_governed_writer_adapter", "bypass_tomb_verifier", "bypass_receipt_gate", "bypass_distillation_contract", "bypass_operator_review", "enable_external_disclosure"], "explicit_non_authority_boundaries": list(EXPLICIT_NON_AUTHORITY_BOUNDARIES)}),
        "sandboxed_live_memory_commit_adapter_capability": _pretty_json({"artifact_kind": "sandboxed_live_memory_commit_adapter_capability", "capability_id": "sandboxed_live_memory_commit_adapter", "category": "memory_distillation", "status": "implemented", "authority_level": "metadata_verification_only", "metadata_only": True, "proof_command_not_run": True, "cli_reference": "scripts/build_sandboxed_live_memory_commit_adapter.py", "matrix_reference": "scripts/run_work_item_review_packet_matrix.py", "docs_reference": "docs/architecture/sandboxed_live_memory_commit_adapter.md", "blocked_or_deferred_surfaces": ["later sandboxed live memory commit adapter gate", "future real live memory commit execution", "future post-execution audit", "real memory-root access", "real memory-root admission", "live memory write", "commit execution/application", "live adapter creation/admission", "executor invocation/activation/release/permit/authorization", "runtime enablement", "lock acquisition", "lockfile creation", "prompt materialization", "live context retrieval", "external disclosure", "action execution", "authority grants"], "forbidden_next_steps": ["admit_real_memory_root_now", "write_live_memory_now", "bypass_safety_interlock", "execute_commit_now", "invoke_executor_now", "enable_runtime_now", "create_lockfile_now", "create_or_admit_live_adapter_now", "grant_authority_now"], "explicit_non_authority_boundaries": list(EXPLICIT_NON_AUTHORITY_BOUNDARIES)}),        "sandboxed_live_memory_commit_adapter_gate_capability": _pretty_json({"artifact_kind": "sandboxed_live_memory_commit_adapter_gate_capability", "capability_id": "sandboxed_live_memory_commit_adapter_gate", "category": "memory_distillation", "status": "implemented", "authority_level": "metadata_verification_only", "metadata_only": True, "proof_command_not_run": True, "cli_reference": "scripts/build_sandboxed_live_memory_commit_adapter_gate.py", "matrix_reference": "scripts/run_work_item_review_packet_matrix.py", "docs_reference": "docs/architecture/sandboxed_live_memory_commit_adapter_gate.md", "blocked_or_deferred_surfaces": ["later sandboxed live memory commit adapter packet", "future real live memory commit execution", "future post-execution audit", "real memory-root access", "real memory-root admission", "live memory write", "commit execution/application", "live adapter creation/admission", "executor invocation/activation/release/permit/authorization", "runtime enablement", "lock acquisition", "lockfile creation", "prompt materialization", "live context retrieval", "external disclosure", "action execution", "authority grants"], "forbidden_next_steps": ["admit_real_memory_root_now", "write_live_memory_now", "bypass_safety_interlock", "execute_commit_now", "invoke_executor_now", "enable_runtime_now", "create_lockfile_now", "create_or_admit_live_adapter_now", "grant_authority_now"], "explicit_non_authority_boundaries": list(EXPLICIT_NON_AUTHORITY_BOUNDARIES)}),

        "real_memory_root_admission_packet_capability": _pretty_json({"artifact_kind": "real_memory_root_admission_packet_capability", "capability_id": "real_memory_root_admission_packet", "category": "memory_distillation", "status": "implemented", "authority_level": "metadata_verification_only", "metadata_only": True, "proof_command_not_run": True, "cli_reference": "scripts/build_real_memory_root_admission_packet.py", "matrix_reference": "scripts/run_work_item_review_packet_matrix.py", "docs_reference": "docs/architecture/real_memory_root_admission_packet.md", "blocked_or_deferred_surfaces": ["later sandboxed live memory commit adapter", "future real live memory commit execution", "real memory-root admission", "live memory write", "executor authority", "lock acquisition", "live adapter admission", "external disclosure", "action execution"], "forbidden_next_steps": ["admit_real_memory_root_now", "write_live_memory_now", "bypass_safety_interlock", "execute_commit_now", "invoke_executor_now", "enable_runtime_now", "create_lockfile_now", "create_or_admit_live_adapter_now", "grant_authority_now"], "explicit_non_authority_boundaries": list(EXPLICIT_NON_AUTHORITY_BOUNDARIES)}),
        "real_memory_root_admission_gate_capability": _pretty_json({"artifact_kind": "real_memory_root_admission_gate_capability", "capability_id": "real_memory_root_admission_gate", "category": "memory_distillation", "status": "implemented", "authority_level": "metadata_verification_only", "metadata_only": True, "proof_command_not_run": True, "cli_reference": "scripts/build_real_memory_root_admission_gate.py", "matrix_reference": "scripts/run_work_item_review_packet_matrix.py", "docs_reference": "docs/architecture/real_memory_root_admission_gate.md", "blocked_or_deferred_surfaces": ["future real live memory commit adapter", "real memory-root access", "runtime memory write", "runtime memory deletion", "runtime memory purge", "live index mutation", "prompt assembly", "live context retrieval", "provider/network/GitHub calls", "external disclosure", "action execution", "authority escalation", "policy creation", "consent inference", "truth inference", "sandbox bypass", "real-root admission bypass"], "forbidden_next_steps": ["write_live_memory_now", "delete_live_memory_now", "purge_live_memory_now", "mutate_vector_index", "mutate_live_index", "assemble_prompt_now", "retrieve_live_context", "execute_action_ingress", "bypass_sandbox_commit_adapter", "bypass_real_root_admission_gate", "bypass_safety_interlock", "bypass_execution_gate", "bypass_operator_approval_packet", "bypass_commit_plan_packet", "bypass_live_boundary_admission", "bypass_governed_writer_adapter", "bypass_tomb_verifier", "bypass_receipt_gate", "bypass_distillation_contract", "enable_external_disclosure"], "explicit_non_authority_boundaries": list(EXPLICIT_NON_AUTHORITY_BOUNDARIES)}),
        "real_live_memory_commit_adapter_readiness_gate_capability": _pretty_json({"artifact_kind": "real_live_memory_commit_adapter_readiness_gate_capability", "capability_id": "real_live_memory_commit_adapter_readiness_gate", "category": "memory_distillation", "status": "implemented", "authority_level": "metadata_verification_only", "metadata_only": True, "proof_command_not_run": True, "cli_reference": "scripts/build_real_live_memory_commit_adapter_readiness_gate.py", "matrix_reference": "scripts/run_work_item_review_packet_matrix.py", "docs_reference": "docs/architecture/real_live_memory_commit_adapter_readiness_gate.md", "blocked_or_deferred_surfaces": ["future real live memory commit adapter readiness envelope", "future real live-memory commit execution", "future post-execution audit", "real executor enablement", "real executor invocation", "real executor activation", "real lock acquisition", "lockfile creation", "real memory-root access", "runtime memory mutation", "runtime memory deletion", "runtime memory purge", "live index mutation", "capsule persistence", "tomb completion", "prompt assembly", "live context retrieval", "external disclosure", "action execution", "authority escalation", "policy creation", "consent inference", "truth inference", "adapter readiness envelope creation", "live adapter admission"], "forbidden_next_steps": ["enable_executor", "invoke_executor", "activate_executor", "acquire_real_lock", "create_lockfile", "write_real_live_memory", "delete_real_live_memory", "purge_real_live_memory", "mutate_live_index", "assemble_prompt", "retrieve_live_context", "execute_action", "direct_executor_execution", "create_live_adapter", "admit_live_adapter", "create_adapter_readiness_envelope", "external_disclosure", "bypass_adapter_admission_packet"], "explicit_non_authority_boundaries": list(EXPLICIT_NON_AUTHORITY_BOUNDARIES)}),
        "real_live_memory_commit_adapter_readiness_envelope_capability": _pretty_json({"artifact_kind": "real_live_memory_commit_adapter_readiness_envelope_capability", "capability_id": "real_live_memory_commit_adapter_readiness_envelope", "category": "memory_distillation", "status": "implemented", "authority_level": "metadata_verification_only", "metadata_only": True, "proof_command_not_run": True, "cli_reference": "scripts/build_real_live_memory_commit_adapter_readiness_envelope.py", "matrix_reference": "scripts/run_work_item_review_packet_matrix.py", "docs_reference": "docs/architecture/real_live_memory_commit_adapter_readiness_envelope.md", "blocked_or_deferred_surfaces": ["future Final Live Memory Commit Review Gate", "real live memory commit adapter execution", "real memory-root access", "runtime memory write", "runtime memory deletion", "runtime memory purge", "live index mutation", "capsule persistence", "tomb completion", "prompt assembly", "live context retrieval", "provider/network/GitHub calls", "external disclosure", "action execution", "authority escalation", "policy creation", "consent inference", "truth inference", "adapter-readiness-gate bypass", "adapter-admission-packet bypass", "final-review-gate creation"], "forbidden_next_steps": ["write_live_memory_now", "delete_live_memory_now", "purge_live_memory_now", "mutate_vector_index", "mutate_live_index", "persist_capsule_now", "complete_tomb_now", "assemble_prompt_now", "retrieve_live_context", "execute_action_ingress", "direct_adapter_execution", "bypass_adapter_readiness_gate", "create_final_live_memory_commit_review_gate_now", "bypass_later_final_live_memory_commit_review_gate", "enable_external_disclosure"], "explicit_non_authority_boundaries": list(EXPLICIT_NON_AUTHORITY_BOUNDARIES)}),
        "explicit_live_memory_runtime_execution_gate_capability": _pretty_json({"artifact_kind": "explicit_live_memory_runtime_execution_gate_capability", "capability_id": "explicit_live_memory_runtime_execution_gate", "category": "memory_distillation", "status": "implemented", "authority_level": "metadata_verification_only", "metadata_only": True, "proof_command_not_run": True, "cli_reference": "scripts/build_explicit_live_memory_runtime_execution_gate.py", "matrix_reference": "scripts/run_work_item_review_packet_matrix.py", "docs_reference": "docs/architecture/explicit_live_memory_runtime_execution_gate.md", "blocked_or_deferred_surfaces": ["future real live-memory commit executor", "future operator runtime confirmation", "future post-execution audit", "real memory-root access", "runtime memory write", "runtime memory deletion", "runtime memory purge", "live index mutation", "capsule persistence", "tomb completion", "prompt assembly", "live context retrieval", "provider/network/GitHub calls", "external disclosure", "action execution", "authority escalation", "policy creation", "consent inference", "truth inference", "readiness-envelope bypass", "final-review bypass", "real-root admission bypass", "sandbox bypass", "direct executor invocation"], "forbidden_next_steps": ["write_live_memory_now", "delete_live_memory_now", "purge_live_memory_now", "mutate_vector_index", "mutate_live_index", "persist_capsule_now", "complete_tomb_now", "assemble_prompt_now", "retrieve_live_context", "execute_action_ingress", "direct_executor_invocation", "bypass_sandbox_commit_adapter", "bypass_real_root_admission_gate", "bypass_final_live_commit_review_gate", "bypass_readiness_envelope", "enable_external_disclosure"], "explicit_non_authority_boundaries": list(EXPLICIT_NON_AUTHORITY_BOUNDARIES)}),
        "real_live_memory_commit_executor_plan_packet_capability": _pretty_json({"artifact_kind": "real_live_memory_commit_executor_plan_packet_capability", "capability_id": "real_live_memory_commit_executor_plan_packet", "category": "memory_distillation", "status": "implemented", "authority_level": "metadata_verification_only", "metadata_only": True, "proof_command_not_run": True, "cli_reference": "scripts/build_real_live_memory_commit_executor_plan_packet.py", "docs_reference": "docs/architecture/real_live_memory_commit_executor_plan_packet.md", "blocked_or_deferred_surfaces": ["future real live-memory commit executor", "runtime memory mutation", "prompt assembly", "external disclosure"], "explicit_non_authority_boundaries": list(EXPLICIT_NON_AUTHORITY_BOUNDARIES)}),
        "live_executor_lock_lease_gate_capability": _pretty_json({"artifact_kind": "live_executor_lock_lease_gate_capability", "capability_id": "live_executor_lock_lease_gate", "category": "memory_distillation", "status": "implemented", "authority_level": "metadata_verification_only", "metadata_only": True, "proof_command_not_run": True, "cli_reference": "scripts/build_live_executor_lock_lease_gate.py", "docs_reference": "docs/architecture/live_executor_lock_lease_gate.md", "blocked_or_deferred_surfaces": ["future real live-memory commit executor", "real lock acquisition", "lockfile creation", "runtime memory mutation", "prompt assembly", "external disclosure"], "explicit_non_authority_boundaries": list(EXPLICIT_NON_AUTHORITY_BOUNDARIES)}),
        "live_executor_preflight_packet_capability": _pretty_json({"artifact_kind": "live_executor_preflight_packet_capability", "capability_id": "live_executor_preflight_packet", "category": "memory_distillation", "status": "implemented", "authority_level": "metadata_verification_only", "metadata_only": True, "proof_command_not_run": True, "cli_reference": "scripts/build_live_executor_preflight_packet.py", "docs_reference": "docs/architecture/live_executor_preflight_packet.md", "blocked_or_deferred_surfaces": ["future real live-memory commit executor", "future executor activation record", "real lock acquisition", "lockfile creation", "runtime memory mutation", "prompt assembly", "external disclosure"], "explicit_non_authority_boundaries": list(EXPLICIT_NON_AUTHORITY_BOUNDARIES)}),
        "live_executor_activation_record_capability": _pretty_json({"artifact_kind": "live_executor_activation_record_capability", "capability_id": "live_executor_activation_record", "category": "memory_distillation", "status": "implemented", "authority_level": "metadata_verification_only", "metadata_only": True, "proof_command_not_run": True, "cli_reference": "scripts/build_live_executor_activation_record.py", "docs_reference": "docs/architecture/live_executor_activation_record.md", "blocked_or_deferred_surfaces": ["future real live-memory commit executor", "future live executor invocation harness", "future post-execution audit", "real executor activation", "real lock acquisition", "lockfile creation", "real memory-root access", "runtime memory mutation", "runtime memory deletion", "runtime memory purge", "live index mutation", "capsule persistence", "tomb completion", "prompt assembly", "live context retrieval", "external disclosure", "action execution", "authority escalation", "policy creation", "consent inference", "truth inference"], "forbidden_next_steps": ["activate_executor", "acquire_real_lock", "create_lockfile", "write_real_live_memory", "delete_real_live_memory", "purge_real_live_memory", "mutate_live_index", "assemble_prompt", "retrieve_live_context", "execute_action", "direct_executor_invocation", "external_disclosure"], "explicit_non_authority_boundaries": list(EXPLICIT_NON_AUTHORITY_BOUNDARIES)}),
        "live_executor_invocation_harness_capability": _pretty_json({"artifact_kind": "live_executor_invocation_harness_capability", "capability_id": "live_executor_invocation_harness", "category": "memory_distillation", "status": "implemented", "authority_level": "metadata_verification_only", "metadata_only": True, "proof_command_not_run": True, "cli_reference": "scripts/build_live_executor_invocation_harness.py", "docs_reference": "docs/architecture/live_executor_invocation_harness.md", "blocked_or_deferred_surfaces": ["future real live-memory commit executor", "future live executor implementation", "future post-execution audit", "real executor invocation", "real executor activation", "real lock acquisition", "lockfile creation", "real memory-root access", "runtime memory mutation", "runtime memory deletion", "runtime memory purge", "live index mutation", "capsule persistence", "tomb completion", "prompt assembly", "live context retrieval", "external disclosure", "action execution", "authority escalation", "policy creation", "consent inference", "truth inference"], "forbidden_next_steps": ["invoke_executor", "activate_executor", "acquire_real_lock", "create_lockfile", "write_real_live_memory", "delete_real_live_memory", "purge_real_live_memory", "mutate_live_index", "assemble_prompt", "retrieve_live_context", "execute_action", "direct_executor_execution", "external_disclosure"], "explicit_non_authority_boundaries": list(EXPLICIT_NON_AUTHORITY_BOUNDARIES)}),
        "real_live_memory_commit_executor_implementation_skeleton_capability": _pretty_json({"artifact_kind": "real_live_memory_commit_executor_implementation_skeleton_capability", "capability_id": "real_live_memory_commit_executor_implementation_skeleton", "category": "memory_distillation", "status": "implemented", "authority_level": "metadata_verification_only", "metadata_only": True, "proof_command_not_run": True, "cli_reference": "scripts/build_real_live_memory_commit_executor_implementation_skeleton.py", "matrix_reference": "scripts/run_work_item_review_packet_matrix.py", "docs_reference": "docs/architecture/real_live_memory_commit_executor_implementation_skeleton.md", "blocked_or_deferred_surfaces": ["future executor enablement gate", "future real live-memory commit execution", "future post-execution audit", "real executor invocation", "real executor activation", "real lock acquisition", "lockfile creation", "real memory-root access", "runtime memory mutation", "runtime memory deletion", "runtime memory purge", "live index mutation", "capsule persistence", "tomb completion", "prompt assembly", "live context retrieval", "external disclosure", "action execution", "authority escalation", "policy creation", "consent inference", "truth inference"], "forbidden_next_steps": ["invoke_executor", "activate_executor", "acquire_real_lock", "create_lockfile", "write_real_live_memory", "delete_real_live_memory", "purge_real_live_memory", "mutate_live_index", "assemble_prompt", "retrieve_live_context", "execute_action", "direct_executor_execution", "external_disclosure", "bypass_invocation_harness"], "explicit_non_authority_boundaries": list(EXPLICIT_NON_AUTHORITY_BOUNDARIES)}),
        "real_live_memory_commit_executor_enablement_gate_capability": _pretty_json({"artifact_kind": "real_live_memory_commit_executor_enablement_gate_capability", "capability_id": "real_live_memory_commit_executor_enablement_gate", "category": "memory_distillation", "status": "implemented", "authority_level": "metadata_verification_only", "metadata_only": True, "proof_command_not_run": True, "cli_reference": "scripts/build_real_live_memory_commit_executor_enablement_gate.py", "matrix_reference": "scripts/run_work_item_review_packet_matrix.py", "docs_reference": "docs/architecture/real_live_memory_commit_executor_enablement_gate.md", "blocked_or_deferred_surfaces": ["future constrained executor enablement path", "future real live-memory commit execution", "future post-execution audit", "real executor enablement", "real executor invocation", "real executor activation", "real lock acquisition", "lockfile creation", "real memory-root access", "runtime memory mutation", "runtime memory deletion", "runtime memory purge", "live index mutation", "capsule persistence", "tomb completion", "prompt assembly", "live context retrieval", "external disclosure", "action execution", "authority escalation", "policy creation", "consent inference", "truth inference"], "forbidden_next_steps": ["enable_executor", "invoke_executor", "activate_executor", "acquire_real_lock", "create_lockfile", "write_real_live_memory", "delete_real_live_memory", "purge_real_live_memory", "mutate_live_index", "assemble_prompt", "retrieve_live_context", "execute_action", "direct_executor_execution", "external_disclosure", "bypass_executor_skeleton"], "explicit_non_authority_boundaries": list(EXPLICIT_NON_AUTHORITY_BOUNDARIES)}),
        "constrained_executor_enablement_path_packet_capability": _pretty_json({"artifact_kind": "constrained_executor_enablement_path_packet_capability", "capability_id": "constrained_executor_enablement_path_packet", "category": "memory_distillation", "status": "implemented", "authority_level": "metadata_verification_only", "metadata_only": True, "proof_command_not_run": True, "cli_reference": "scripts/build_constrained_executor_enablement_path_packet.py", "matrix_reference": "scripts/run_work_item_review_packet_matrix.py", "docs_reference": "docs/architecture/constrained_executor_enablement_path_packet.md", "blocked_or_deferred_surfaces": ["future live execution gate", "future real live-memory commit execution", "future post-execution audit", "real executor enablement", "real executor invocation", "real executor activation", "real lock acquisition", "lockfile creation", "real memory-root access", "runtime memory mutation", "runtime memory deletion", "runtime memory purge", "live index mutation", "capsule persistence", "tomb completion", "prompt assembly", "live context retrieval", "external disclosure", "action execution", "authority escalation", "policy creation", "consent inference", "truth inference"], "forbidden_next_steps": ["enable_executor", "invoke_executor", "activate_executor", "acquire_real_lock", "create_lockfile", "write_real_live_memory", "delete_real_live_memory", "purge_real_live_memory", "mutate_live_index", "assemble_prompt", "retrieve_live_context", "execute_action", "direct_executor_execution", "external_disclosure", "bypass_enablement_gate"], "explicit_non_authority_boundaries": list(EXPLICIT_NON_AUTHORITY_BOUNDARIES)}),
        ...
        "work_item_operator_confirmed_verification_run_capability": _pretty_json({
            ...
            "category": "task_work_item_operator_confirmed_verification_run",
            "status": "implemented",
            "authority_level": "bounded_workspace_verification",
            "proof_command_status": "proof_command_not_run",
            "cli_reference": "scripts/run_operator_confirmed_verification.py",
            "matrix_reference": "scripts/run_work_item_review_packet_matrix.py",
            "docs_reference": "docs/architecture/task_work_item_operator_confirmed_verification_run_wing.md",
            "required_operator_confirmation": True,
            "blocked_deferred_surfaces": ["lifecycle closure","lifecycle orchestration","rollback","cleanup","scheduler/live tracker","agent execution","branch/PR/issue mutation","network/provider/prompt/subprocess/shell"],
            "non_authority_boundaries": ["verification invocation only", "never lifecycle closure/orchestration/rollback/cleanup"],
        }),
        ...
        "work_item_lifecycle_attestation_index_verifier_capability": _pretty_json({"artifact_kind": "work_item_lifecycle_attestation_index_verifier_capability", "capability_id": "work_item_lifecycle_attestation_index_verifier", "category": "task_work_item_lifecycle_attestation_index", "status": "implemented", "authority_level": "metadata_verification_only", "proof_command_not_run": True, "cli_reference": "scripts/verify_work_item_lifecycle_attestation_index.py", "matrix_reference": "scripts/run_work_item_review_packet_matrix.py", "docs_reference": "docs/architecture/task_work_item_lifecycle_attestation_index_verifier_wing.md", "blocked_or_deferred_surfaces": ["attestation index generation", "final attestation generation", "lifecycle completion verification", "lifecycle completion dossier generation", "lifecycle closure invocation", "lifecycle orchestration", "workspace admission/preflight/execution/verification", "rollback", "cleanup", "workspace mutation", "scheduler/live tracker", "agent execution", "branch/pr/issue mutation", "network/provider/prompt/subprocess/shell"], "explicit_non_authority_boundaries": list(EXPLICIT_NON_AUTHORITY_BOUNDARIES)}),
        "work_item_lifecycle_attestation_review_digest_capability": _pretty_json({"artifact_kind": "work_item_lifecycle_attestation_review_digest_capability", "capability_id": "work_item_lifecycle_attestation_review_digest", "category": "task_work_item_lifecycle_attestation_review_digest", "status": "implemented", "authority_level": "metadata_digest_only", "proof_command_not_run": True, "cli_reference": "scripts/build_work_item_lifecycle_attestation_review_digest.py", "matrix_reference": "scripts/run_work_item_review_packet_matrix.py", "docs_reference": "docs/architecture/task_work_item_lifecycle_attestation_review_digest_wing.md", "blocked_or_deferred_surfaces": ["attestation index verification", "attestation index generation", "final attestation generation", "lifecycle completion verification", "lifecycle completion dossier generation", "lifecycle closure invocation", "lifecycle orchestration", "workspace admission/preflight/execution/verification", "rollback", "cleanup", "workspace mutation", "scheduler/live tracker", "agent execution", "branch/pr/issue mutation", "network/provider/prompt/subprocess/shell"], "explicit_non_authority_boundaries": list(EXPLICIT_NON_AUTHORITY_BOUNDARIES)}),
        "work_item_lifecycle_attestation_review_digest_verifier_capability": _pretty_json({"artifact_kind": "work_item_lifecycle_attestation_review_digest_verifier_capability", "capability_id": "work_item_lifecycle_attestation_review_digest_verifier", "category": "task_work_item_lifecycle_attestation_review_digest_verifier", "status": "implemented", "authority_level": "metadata_verification_only", "proof_command_not_run": True, "cli_reference": "scripts/verify_work_item_lifecycle_attestation_review_digest.py", "matrix_reference": "scripts/run_work_item_review_packet_matrix.py", "docs_reference": "docs/architecture/task_work_item_lifecycle_attestation_review_digest_verifier_wing.md", "blocked_or_deferred_surfaces": ["review digest generation", "attestation index verification", "attestation index generation", "final attestation generation", "lifecycle completion verification", "lifecycle completion dossier generation", "lifecycle closure invocation", "lifecycle orchestration", "workspace admission/preflight/execution/verification", "rollback", "cleanup", "workspace mutation", "scheduler/live tracker", "agent execution", "branch/pr/issue mutation", "network/provider/prompt/subprocess/shell"], "explicit_non_authority_boundaries": list(EXPLICIT_NON_AUTHORITY_BOUNDARIES)}),
        "work_item_lifecycle_attestation_review_digest_index_capability": _pretty_json({"artifact_kind": "work_item_lifecycle_attestation_review_digest_index_capability", "capability_id": "work_item_lifecycle_attestation_review_digest_index", "category": "task_work_item_lifecycle_attestation_review_digest_index", "status": "implemented", "authority_level": "metadata_digest_only", "proof_command_not_run": True, "cli_reference": "scripts/build_work_item_lifecycle_attestation_review_digest_index.py", "matrix_reference": "scripts/run_work_item_review_packet_matrix.py", "docs_reference": "docs/architecture/task_work_item_lifecycle_attestation_review_digest_index_wing.md", "blocked_or_deferred_surfaces": ["review digest verification", "review digest generation", "attestation index verification", "attestation index generation", "final attestation generation", "lifecycle completion verification", "lifecycle completion dossier generation", "lifecycle closure invocation", "lifecycle orchestration", "workspace admission/preflight/execution/verification", "rollback", "cleanup", "workspace mutation", "scheduler/live tracker", "agent execution", "branch/pr/issue mutation", "network/provider/prompt/subprocess/shell"], "explicit_non_authority_boundaries": list(EXPLICIT_NON_AUTHORITY_BOUNDARIES)}),
        "work_item_lifecycle_attestation_review_digest_index_verifier_capability": _pretty_json({"artifact_kind": "work_item_lifecycle_attestation_review_digest_index_verifier_capability", "capability_id": "work_item_lifecycle_attestation_review_digest_index_verifier", "category": "task_work_item_lifecycle_attestation_review_digest_index_verifier", "status": "implemented", "authority_level": "metadata_verification_only", "proof_command_not_run": True, "cli_reference": "scripts/verify_work_item_lifecycle_attestation_review_digest_index.py", "matrix_reference": "scripts/run_work_item_review_packet_matrix.py", "docs_reference": "docs/architecture/task_work_item_lifecycle_attestation_review_digest_index_verifier_wing.md", "blocked_or_deferred_surfaces": ["review digest index generation", "review digest verification", "review digest generation", "attestation index verification", "attestation index generation", "final attestation generation", "lifecycle completion verification", "lifecycle completion dossier generation", "lifecycle closure invocation", "lifecycle orchestration", "workspace admission/preflight/execution/verification", "rollback", "cleanup", "workspace mutation", "scheduler/live tracker", "agent execution", "branch/pr/issue mutation", "network/provider/prompt/subprocess/shell"], "explicit_non_authority_boundaries": list(EXPLICIT_NON_AUTHORITY_BOUNDARIES)}),

        "household_presence_camera_operator_grant_renewal_request_packet_capability": _pretty_json({"artifact_kind": "household_presence_camera_operator_grant_renewal_request_packet_capability", "capability_id": "household_presence_camera_operator_grant_renewal_request_packet", "category": "embodiment_governance", "status": "implemented", "authority_level": "metadata_verification_only", "metadata_only": True, "proof_command_not_run": True, "cli_reference": "scripts/build_household_presence_camera_operator_grant_renewal_request_packet.py", "matrix_reference": "scripts/run_work_item_review_packet_matrix.py", "docs_reference": "docs/architecture/household_presence_camera_operator_grant_renewal_request_packet.md", "blocked_or_deferred_surfaces": ["operator consent grant or renewal", "live camera execution", "dry-run continuation enablement", "media processing", "speaker runtime output", "external authority disclosure", "network/provider/subprocess/hardware authority"], "forbidden_next_steps": ["open_camera_now", "attempt_capture", "enable_live_capture", "enable_live_recording", "store_raw_media", "attach_media_payload", "bypass_authorization_envelope", "bypass_denial_ledger", "bypass_review_packet", "bypass_review_decision_ledger", "bypass_operator_review_trend_ledger", "bypass_policy_chain", "bypass_zone_config", "bypass_disabled_capture_boundary", "bypass_dry_run", "infer_operator_consent_from_trends", "infer_operator_consent_from_renewal_request", "convert_renewal_request_to_grant", "convert_renewal_request_to_live_readiness", "enable_speaker_output", "enable_external_disclosure"], "explicit_non_authority_boundaries": list(EXPLICIT_NON_AUTHORITY_BOUNDARIES)}),
        "household_presence_camera_dry_run_continuation_gate_capability": _pretty_json({"artifact_kind": "household_presence_camera_dry_run_continuation_gate_capability", "capability_id": "household_presence_camera_dry_run_continuation_gate", "category": "embodiment_governance", "status": "implemented", "authority_level": "metadata_verification_only", "metadata_only": True, "proof_command_not_run": True, "cli_reference": "scripts/build_household_presence_camera_dry_run_continuation_gate.py", "matrix_reference": "scripts/run_work_item_review_packet_matrix.py", "docs_reference": "docs/architecture/household_presence_camera_dry_run_continuation_gate.md", "blocked_or_deferred_surfaces": ["operator consent grant or renewal", "live camera execution", "dry-run runtime execution", "media processing", "speaker runtime output", "external authority disclosure", "network/provider/subprocess/hardware authority"], "forbidden_next_steps": ["open_camera_now", "attempt_capture", "enable_live_capture", "enable_live_recording", "store_raw_media", "attach_media_payload", "bypass_authorization_envelope", "bypass_denial_ledger", "bypass_review_packet", "bypass_review_decision_ledger", "bypass_operator_review_trend_ledger", "bypass_operator_grant_renewal_request_packet", "bypass_policy_chain", "bypass_zone_config", "bypass_disabled_capture_boundary", "bypass_dry_run", "infer_operator_consent_from_gate", "infer_operator_consent_from_trends", "infer_operator_consent_from_renewal_request", "convert_renewal_request_to_grant", "convert_dry_run_gate_to_live_readiness", "convert_dry_run_gate_to_live_capture_permission", "enable_speaker_output", "enable_external_disclosure"], "explicit_non_authority_boundaries": list(EXPLICIT_NON_AUTHORITY_BOUNDARIES)}),
        "household_presence_camera_future_live_deferral_registry_capability": _pretty_json({"artifact_kind": "household_presence_camera_future_live_deferral_registry_capability", "capability_id": "household_presence_camera_future_live_deferral_registry", "category": "embodiment_governance", "status": "implemented", "authority_level": "metadata_verification_only", "metadata_only": True, "proof_command_not_run": True, "cli_reference": "scripts/build_household_presence_camera_future_live_deferral_registry.py", "matrix_reference": "scripts/run_work_item_review_packet_matrix.py", "docs_reference": "docs/architecture/household_presence_camera_future_live_deferral_registry.md", "blocked_or_deferred_surfaces": ["operator consent grant or renewal", "live camera execution", "live candidate approval", "live review scheduling", "media processing", "speaker runtime output", "external authority disclosure", "network/provider/hardware authority"], "forbidden_next_steps": ["open_camera_now", "attempt_capture", "enable_live_capture", "enable_live_recording", "store_raw_media", "attach_media_payload", "schedule_live_capture_review", "approve_live_candidate", "mark_live_ready", "bypass_authorization_envelope", "bypass_denial_ledger", "bypass_review_packet", "bypass_review_decision_ledger", "bypass_operator_review_trend_ledger", "bypass_operator_grant_renewal_request_packet", "bypass_dry_run_continuation_gate", "bypass_policy_chain", "bypass_zone_config", "bypass_disabled_capture_boundary", "bypass_dry_run", "infer_operator_consent_from_deferral", "infer_operator_consent_from_gate", "infer_operator_consent_from_trends", "infer_operator_consent_from_renewal_request", "convert_renewal_request_to_grant", "convert_dry_run_gate_to_live_readiness", "convert_deferral_to_live_readiness", "convert_deferral_to_live_capture_permission", "enable_speaker_output", "enable_external_disclosure"], "explicit_non_authority_boundaries": list(EXPLICIT_NON_AUTHORITY_BOUNDARIES)}),
        "household_presence_camera_review_chain_summary_packet_capability": _pretty_json({"artifact_kind": "household_presence_camera_review_chain_summary_packet_capability", "capability_id": "household_presence_camera_review_chain_summary_packet", "category": "embodiment_governance", "status": "implemented", "authority_level": "metadata_verification_only", "metadata_only": True, "proof_command_not_run": True, "cli_reference": "scripts/build_household_presence_camera_review_chain_summary_packet.py", "matrix_reference": "scripts/run_work_item_review_packet_matrix.py", "docs_reference": "docs/architecture/household_presence_camera_review_chain_summary_packet.md", "blocked_or_deferred_surfaces": ["operator consent grant or renewal", "dry-run capture execution", "live camera execution", "live candidate approval", "live review scheduling", "media processing", "speaker runtime output", "external authority disclosure", "network/provider/hardware authority"], "forbidden_next_steps": ["open_camera_now", "attempt_capture", "enable_live_capture", "enable_live_recording", "store_raw_media", "attach_media_payload", "execute_dry_run_capture", "schedule_live_capture_review", "approve_live_candidate", "mark_live_ready", "bypass_authorization_envelope", "bypass_denial_ledger", "bypass_review_packet", "bypass_review_decision_ledger", "bypass_operator_review_trend_ledger", "bypass_operator_grant_renewal_request_packet", "bypass_dry_run_continuation_gate", "bypass_future_live_deferral_registry", "bypass_policy_chain", "bypass_zone_config", "bypass_disabled_capture_boundary", "bypass_dry_run", "infer_operator_consent_from_summary", "infer_operator_consent_from_chain", "infer_operator_consent_from_gate", "infer_operator_consent_from_trends", "infer_operator_consent_from_renewal_request", "convert_renewal_request_to_grant", "convert_dry_run_gate_to_live_readiness", "convert_deferral_to_live_readiness", "convert_summary_to_live_readiness", "convert_summary_to_live_capture_permission", "enable_speaker_output", "enable_external_disclosure"], "explicit_non_authority_boundaries": list(EXPLICIT_NON_AUTHORITY_BOUNDARIES)}),
    ...
    runtime_enablement_record = registry.by_id()["real_executor_runtime_enablement_packet"]
    contents["real_executor_runtime_enablement_packet_capability"] = _pretty_json({
        "artifact_kind": "real_executor_runtime_enablement_packet_capability",
        **runtime_enablement_record.to_dict(),
        "metadata_only": True,
        "proof_command_not_run": True,
        "cli_reference": "scripts/build_real_executor_runtime_enablement_packet.py",
        "matrix_reference": "scripts/run_work_item_review_packet_matrix.py",
        "docs_reference": "docs/architecture/real_executor_runtime_enablement_packet.md",
        "blocked_or_deferred_surfaces": list(runtime_enablement_record.deferred_surfaces),
        "forbidden_next_steps": ["enable_executor", "flip_runtime_flags", "execute_live_commit", "invoke_executor", "activate_executor", "acquire_real_lock", "create_lockfile", "write_real_live_memory", "delete_real_live_memory", "purge_real_live_memory", "mutate_live_index", "assemble_prompt", "retrieve_live_context", "execute_action", "disclose_externally"],
        "explicit_non_authority_boundaries": list(EXPLICIT_NON_AUTHORITY_BOUNDARIES),
    })
    runtime_gate_record = registry.by_id()["real_executor_runtime_gate"]
    contents["real_executor_runtime_gate_capability"] = _pretty_json({
        "artifact_kind": "real_executor_runtime_gate_capability",
        **runtime_gate_record.to_dict(),
        "metadata_only": True,
        "proof_command_not_run": True,
        "cli_reference": "scripts/build_real_executor_runtime_gate.py",
        "matrix_reference": "scripts/run_work_item_review_packet_matrix.py",
    ...
    run_packet_record = registry.by_id()["real_executor_run_packet"]
    contents["real_executor_run_packet_capability"] = _pretty_json({
        "artifact_kind": "real_executor_run_packet_capability",
        **run_packet_record.to_dict(),
        "metadata_only": True,
        "proof_command_not_run": True,
        "cli_reference": "scripts/build_real_executor_run_packet.py",
        "matrix_reference": "scripts/run_work_item_review_packet_matrix.py",
        "docs_reference": "docs/architecture/real_executor_run_packet.md",
        "blocked_or_deferred_surfaces": list(run_packet_record.deferred_surfaces),
        "forbidden_next_steps": ["real_executor_run_gate", "executor_run", "executor_invocation", "executor_activation", "runtime_enablement", "runtime_flag_flipping", "live_execution", "real_lock_acquisition", "lockfile_creation", "real_live_memory_write", "real_live_memory_delete", "real_live_memory_purge", "index_mutation", "prompt_assembly", "live_context_retrieval", "action_ingress", "external_disclosure"],
        "explicit_non_authority_boundaries": list(EXPLICIT_NON_AUTHORITY_BOUNDARIES),
    })

    run_gate_record = registry.by_id()["real_executor_run_gate"]
    contents["real_executor_run_gate_capability"] = _pretty_json({
        "artifact_kind": "real_executor_run_gate_capability",
        **run_gate_record.to_dict(),
        "metadata_only": True,
        "proof_command_not_run": True,
        "cli_reference": "scripts/build_real_executor_run_gate.py",
        "matrix_reference": "scripts/run_work_item_review_packet_matrix.py",
        "docs_reference": "docs/architecture/real_executor_run_gate.md",
        "blocked_or_deferred_surfaces": list(run_gate_record.deferred_surfaces),
        "forbidden_next_steps": ["real_executor_execution_plan", "executor_execution", "executor_run", "executor_invocation", "executor_activation", "runtime_enablement", "runtime_flag_flipping", "live_execution", "real_lock_acquisition", "lockfile_creation", "real_live_memory_write", "real_live_memory_delete", "real_live_memory_purge", "index_mutation", "prompt_assembly", "live_context_retrieval", "action_ingress", "external_disclosure"],
        "explicit_non_authority_boundaries": list(EXPLICIT_NON_AUTHORITY_BOUNDARIES),
    })

    execution_plan_record = registry.by_id()["real_executor_execution_plan"]
    contents["real_executor_execution_plan_capability"] = _pretty_json({
        "artifact_kind": "real_executor_execution_plan_capability",
        **execution_plan_record.to_dict(),
        "metadata_only": True,
        "proof_command_not_run": True,
        "cli_reference": "scripts/build_real_executor_execution_plan.py",
        "matrix_reference": "scripts/run_work_item_review_packet_matrix.py",
    ...
    invocation_gate_record = registry.by_id()["real_executor_execution_invocation_gate"]
    contents["real_executor_execution_invocation_gate_capability"] = _pretty_json({
        "artifact_kind": "real_executor_execution_invocation_gate_capability",
        **invocation_gate_record.to_dict(),
        "metadata_only": True,
        "proof_command_not_run": True,
        "cli_reference": "scripts/build_real_executor_execution_invocation_gate.py",
        "matrix_reference": "scripts/run_work_item_review_packet_matrix.py",
        "docs_reference": "docs/architecture/real_executor_execution_invocation_gate.md",
        "blocked_or_deferred_surfaces": list(invocation_gate_record.deferred_surfaces),
        "forbidden_next_steps": ["real_executor_execution_preflight_packet", "executor_execution", "executor_run", "executor_invocation", "executor_activation", "execution_release", "execution_permit", "execution_authorization", "runtime_enablement", "runtime_flag_flipping", "live_execution", "real_lock_acquisition", "lockfile_creation", "real_live_memory_write", "real_live_memory_delete", "real_live_memory_purge", "index_mutation", "prompt_assembly", "live_context_retrieval", "action_ingress", "external_disclosure"],
        "explicit_non_authority_boundaries": list(EXPLICIT_NON_AUTHORITY_BOUNDARIES),
    })

    preflight_packet_record = registry.by_id()["real_executor_execution_preflight_packet"]
    contents["real_executor_execution_preflight_packet_capability"] = _pretty_json({
        "artifact_kind": "real_executor_execution_preflight_packet_capability",
        **preflight_packet_record.to_dict(),
        "metadata_only": True,
        "proof_command_not_run": True,
        "cli_reference": "scripts/build_real_executor_execution_preflight_packet.py",
        "matrix_reference": "scripts/run_work_item_review_packet_matrix.py",
        "docs_reference": "docs/architecture/real_executor_execution_preflight_packet.md",
        "blocked_or_deferred_surfaces": list(preflight_packet_record.deferred_surfaces),
        "forbidden_next_steps": ["real_executor_execution_preflight_gate", "executor_preflight_execution", "executor_execution", "executor_run", "executor_invocation", "executor_activation", "execution_release", "execution_permit", "execution_authorization", "runtime_enablement", "runtime_flag_flipping", "live_execution", "real_lock_acquisition", "lockfile_creation", "real_live_memory_write", "real_live_memory_delete", "real_live_memory_purge", "index_mutation", "prompt_assembly", "live_context_retrieval", "action_ingress", "external_disclosure"],
        "explicit_non_authority_boundaries": list(EXPLICIT_NON_AUTHORITY_BOUNDARIES),
    })


    preflight_gate_record = registry.by_id()["real_executor_execution_preflight_gate"]
    contents["real_executor_execution_preflight_gate_capability"] = _pretty_json({
        "artifact_kind": "real_executor_execution_preflight_gate_capability",
        **preflight_gate_record.to_dict(),
        "metadata_only": True,
        "proof_command_not_run": True,
        "cli_reference": "scripts/build_real_executor_execution_preflight_gate.py",
        "matrix_reference": "scripts/run_work_item_review_packet_matrix.py",
        "docs_reference": "docs/architecture/real_executor_execution_preflight_gate.md",
        "blocked_or_deferred_surfaces": list(preflight_gate_record.deferred_surfaces),
        "forbidden_next_steps": ["real_executor_execution_lock_lease_packet", "executor_preflight_execution", "executor_execution", "executor_run", "executor_invocation", "executor_activation", "execution_release", "execution_permit", "execution_authorization", "runtime_enablement", "runtime_flag_flipping", "live_execution", "real_lock_acquisition", "lockfile_creation", "real_live_memory_write", "real_live_memory_delete", "real_live_memory_purge", "index_mutation", "prompt_assembly", "live_context_retrieval", "action_ingress", "external_disclosure"],
        "explicit_non_authority_boundaries": list(EXPLICIT_NON_AUTHORITY_BOUNDARIES),
    })


    lock_lease_gate_record = registry.by_id()["real_executor_execution_lock_lease_gate"]
    contents["real_executor_execution_lock_lease_gate_capability"] = _pretty_json({
        "artifact_kind": "real_executor_execution_lock_lease_gate_capability",
        **lock_lease_gate_record.to_dict(),
        "metadata_only": True,
        "proof_command_not_run": True,
        "cli_reference": "scripts/build_real_executor_execution_lock_lease_gate.py",
        "matrix_reference": "scripts/run_work_item_review_packet_matrix.py",
        "docs_reference": "docs/architecture/real_executor_execution_lock_lease_gate.md",
        "blocked_or_deferred_surfaces": list(lock_lease_gate_record.deferred_surfaces),
        "forbidden_next_steps": ["real_executor_execution_commit_plan_packet", "real_lock_acquisition", "real_lock_lease_creation", "lockfile_creation", "executor_preflight_execution", "executor_execution", "executor_run", "executor_invocation", "executor_activation", "execution_release", "execution_permit", "execution_authorization", "runtime_enablement", "runtime_flag_flipping", "live_execution", "real_live_memory_write", "real_live_memory_delete", "real_live_memory_purge", "index_mutation", "prompt_assembly", "live_context_retrieval", "action_ingress", "external_disclosure"],
        "explicit_non_authority_boundaries": list(EXPLICIT_NON_AUTHORITY_BOUNDARIES),
    })

    commit_plan_packet_record = registry.by_id()["real_executor_execution_commit_plan_packet"]
    contents["real_executor_execution_commit_plan_packet_capability"] = _pretty_json({
        "artifact_kind": "real_executor_execution_commit_plan_packet_capability",
        **commit_plan_packet_record.to_dict(),
        "metadata_only": True,
        "proof_command_not_run": True,
        "cli_reference": "scripts/build_real_executor_execution_commit_plan_packet.py",
        "matrix_reference": "scripts/run_work_item_review_packet_matrix.py",
        "docs_reference": "docs/architecture/real_executor_execution_commit_plan_packet.md",
        "blocked_or_deferred_surfaces": list(commit_plan_packet_record.deferred_surfaces),
        "forbidden_next_steps": ["real_executor_execution_commit_plan_gate", "real_executor_execution_commit_window_packet", "live_commit_execution", "commit_application", "real_lock_acquisition", "real_lock_lease_creation", "lockfile_creation", "executor_preflight_execution", "executor_execution", "executor_run", "executor_invocation", "executor_activation", "execution_release", "execution_permit", "execution_authorization", "runtime_enablement", "runtime_flag_flipping", "real_live_memory_write", "real_live_memory_delete", "real_live_memory_purge", "index_mutation", "prompt_assembly", "live_context_retrieval", "action_ingress", "external_disclosure"],
        "explicit_non_authority_boundaries": list(EXPLICIT_NON_AUTHORITY_BOUNDARIES),
    })

    commit_plan_gate_record = registry.by_id()["real_executor_execution_commit_plan_gate"]
    contents["real_executor_execution_commit_plan_gate_capability"] = _pretty_json({
        "artifact_kind": "real_executor_execution_commit_plan_gate_capability",
        **commit_plan_gate_record.to_dict(),
        "metadata_only": True,
        "proof_command_not_run": True,
        "cli_reference": "scripts/build_real_executor_execution_commit_plan_gate.py",
        "matrix_reference": "scripts/run_work_item_review_packet_matrix.py",
        "docs_reference": "docs/architecture/real_executor_execution_commit_plan_gate.md",
        "blocked_or_deferred_surfaces": list(commit_plan_gate_record.deferred_surfaces),
        "forbidden_next_steps": ["real_executor_execution_commit_window_packet", "live_commit_execution", "commit_application", "commit_window_authority", "real_lock_acquisition", "real_lock_lease_creation", "lockfile_creation", "executor_preflight_execution", "executor_execution", "executor_run", "executor_invocation", "executor_activation", "execution_release", "execution_permit", "execution_authorization", "runtime_enablement", "runtime_flag_flipping", "real_live_memory_write", "real_live_memory_delete", "real_live_memory_purge", "index_mutation", "prompt_assembly", "live_context_retrieval", "action_ingress", "external_disclosure"],
        "explicit_non_authority_boundaries": list(EXPLICIT_NON_AUTHORITY_BOUNDARIES),
    })

    commit_window_packet_record = registry.by_id()["real_executor_execution_commit_window_packet"]
    contents["real_executor_execution_commit_window_packet_capability"] = _pretty_json({
        "artifact_kind": "real_executor_execution_commit_window_packet_capability",
        **commit_window_packet_record.to_dict(),
        "metadata_only": True,
        "proof_command_not_run": True,
        "cli_reference": "scripts/build_real_executor_execution_commit_window_packet.py",
        "matrix_reference": "scripts/run_work_item_review_packet_matrix.py",
    ...
    lock_lease_packet_record = registry.by_id()["real_executor_execution_lock_lease_packet"]
    contents["real_executor_execution_lock_lease_packet_capability"] = _pretty_json({
        "artifact_kind": "real_executor_execution_lock_lease_packet_capability",
        **lock_lease_packet_record.to_dict(),
        "metadata_only": True,
        "proof_command_not_run": True,
        "cli_reference": "scripts/build_real_executor_execution_lock_lease_packet.py",
        "matrix_reference": "scripts/run_work_item_review_packet_matrix.py",
        "docs_reference": "docs/architecture/real_executor_execution_lock_lease_packet.md",
        "blocked_or_deferred_surfaces": list(lock_lease_packet_record.deferred_surfaces),
