...
_PRESETS: dict[str, CodexTaskScaffoldPreset] = {
    "developer_workflow_metadata": CodexTaskScaffoldPreset(
        ...
        default_final_report_items=("exact_files_changed", "module_api_summary", "cli_summary", "preset_ids_and_behavior", "generator_integration_behavior", "capability_proof_doc_integration", "matrix_runner_integration", "full_command_matrix_results", "pre_commit_finalizer_result", "post_commit_pr_metadata_finalizer_result", "pr_metadata_guard_result", "pr_metadata_result", "unresolved_risks"),
    ),
    "model_distribution": CodexTaskScaffoldPreset(
        "model_distribution",
        ("deterministic_publication_contract", "authority_boundary", "docs", "tests"),
        ("unregistered_authority", "model_facing_authority", "mutable_publication", "provider_administration", "credential_management"),
        ("capability_registry", "control_plane_admission", "reviewer_proof_bundle", "matrix_runner", "docs"),
        ("targeted_tests", "targeted_mypy", "docs_build", "audit"),
        ("capability_scope", "principal_scope", "effect_scope", "validation_results", "full_command_matrix_results", "unresolved_risks"),
    ),
