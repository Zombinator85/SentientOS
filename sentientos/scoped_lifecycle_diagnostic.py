...
def build_scoped_lifecycle_diagnostic(repo_root: Path) -> dict[str, Any]:
    ...
    current_orchestration_bundle = resolve_current_orchestration_bundle(
        root,
        ...
        internal_execution_result_visibility=orchestration_result,
        external_fulfillment_receipt_visibility=resolve_handoff_packet_fulfillment_lifecycle(root, effective_handoff_packet),
    )
    current_orchestration_state = dict(current_orchestration_bundle.get("current_orchestration_state") or {})
    current_orchestration_watchpoint = dict(current_orchestration_bundle.get("current_orchestration_watchpoint") or {})
    current_watchpoint_satisfaction = dict(current_orchestration_bundle.get("watchpoint_satisfaction") or {})
    re_evaluation_trigger_recommendation = dict(current_orchestration_bundle.get("re_evaluation_trigger_recommendation") or {})
    current_orchestration_resumption_candidate = dict(current_orchestration_bundle.get("current_orchestration_resumption_candidate") or {})
    current_resumed_operation_readiness = dict(current_orchestration_bundle.get("current_resumed_operation_readiness") or {})
    current_orchestration_watchpoint_brief = dict(current_orchestration_bundle.get("current_orchestration_watchpoint_brief") or {})
    current_orchestration_pressure_signal = dict(current_orchestration_bundle.get("current_orchestration_pressure_signal") or {})
    current_orchestration_wake_readiness_detector = dict(current_orchestration_bundle.get("current_orchestration_wake_readiness_detector") or {})
    current_re_evaluation_basis_brief = dict(current_orchestration_bundle.get("current_re_evaluation_basis_brief") or {})
    current_orchestration_next_move_brief = dict(current_orchestration_bundle.get("current_orchestration_next_move_brief") or {})
    current_orchestration_handoff_packet_brief = dict(current_orchestration_bundle.get("current_orchestration_handoff_packet_brief") or {})
    current_operator_facing_orchestration_brief = dict(current_orchestration_bundle.get("current_operator_facing_orchestration_brief") or {})
    current_orchestration_resolution_path_brief = dict(current_orchestration_bundle.get("current_orchestration_resolution_path_brief") or {})
    current_orchestration_closure_brief = dict(current_orchestration_bundle.get("current_orchestration_closure_brief") or {})
    current_orchestration_coherence_brief = dict(current_orchestration_bundle.get("current_orchestration_coherence_brief") or {})
    current_orchestration_digest = dict(current_orchestration_bundle.get("current_orchestration_digest") or {})
    current_orchestration_transition_brief = dict(current_orchestration_bundle.get("current_orchestration_transition_brief") or {})
    current_orchestration_export_packet = dict(current_orchestration_bundle.get("current_orchestration_export_packet") or {})
    current_orchestration_export_packet_consumer_receipt = dict(
        current_orchestration_bundle.get("current_orchestration_export_packet_consumer_receipt") or {}
    )
    current_orchestration_handoff_acceptance_posture = dict(
        current_orchestration_bundle.get("current_orchestration_handoff_acceptance_posture") or {}
    )
    ...
    return {
        ...
        "orchestration_handoff": {
            ...
            "current_orchestration_watchpoint_summary": {
                ...
                ).get("requires_conservative_hold"),
                ...
                "current_wake_readiness_classification": current_orchestration_wake_readiness_detector.get(
                    "wake_readiness_classification"
                ),
                "current_wake_readiness_posture": current_orchestration_wake_readiness_detector.get("result_posture"),
                ...
                "current_resolution_path_classification": current_orchestration_resolution_path_brief.get(
                    "resolution_path_classification"
                ),
                "current_resolution_path_centered_on": current_orchestration_resolution_path_brief.get("centered_on"),
                "current_resolution_path_posture": current_orchestration_resolution_path_brief.get("path_posture"),
                "current_resolution_path_chain_active": current_orchestration_resolution_path_brief.get(
                    "wake_resumption_next_move_chain_materially_active"
                ),
                "current_closure_classification": current_orchestration_closure_brief.get("closure_classification"),
                "current_closure_primary_waiting_on": current_orchestration_closure_brief.get(
                    "closure_primary_waiting_on"
                ),
                "current_closure_posture": current_orchestration_closure_brief.get("closure_posture"),
