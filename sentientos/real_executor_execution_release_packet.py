"""Deterministic metadata-only real executor execution release packet builder.

This module consumes supplied Real Executor Execution Permit Gate evidence
and explicit Real Executor Execution Release Packet candidates. It emits
review metadata for a later Real Executor Execution Release Gate only. It never enables, activates, invokes, locks, writes,
...
RealExecutorExecutionReleasePacketStatus = Literal[
    "real_executor_execution_release_packet_ready",
    ...
    "real_executor_execution_release_packet_invalid",
    "real_executor_execution_release_packet_failed",
]
RealExecutorExecutionReleasePacketDecision = Literal[
...
REAL_EXECUTOR_EXECUTION_RELEASE_PACKET_CANDIDATE_TYPES = frozenset({
...
READY_REAL_EXECUTOR_EXECUTION_PERMIT_GATE_DECISIONS = frozenset({
...
FAIL_STATUSES = {"real_executor_execution_release_packet_blocked", "real_executor_execution_release_packet_invalid", "real_executor_execution_release_packet_failed"}

EVIDENCE_MATCH_FIELDS: tuple[tuple[str, str, str, str], ...] = (
    ("real_executor_execution_permit_gate", "claimed_real_executor_execution_permit_gate_digest", "digest", "claimed_real_executor_execution_permit_gate_decision"),
...
NON_NOOP_METADATA_FIELDS = (
    "release_packet_readiness_metadata",
    "permit_gate_confirmation_metadata",
    ...
    "future_real_executor_execution_release_gate_requirement_metadata",
)

INVARIANTS: dict[str, bool] = {
    "real_executor_execution_release_packet_is_not_execution_release": True,
    "real_executor_execution_release_packet_does_not_release_execution": True,
    "real_executor_execution_release_packet_is_not_execution_permit": True,
    "real_executor_execution_release_packet_does_not_issue_permit": True,
    "real_executor_execution_release_packet_is_not_execution_authorization": True,
    "real_executor_execution_release_packet_is_not_permission_to_execute": True,
    "real_executor_execution_release_packet_is_not_executor_run": True,
    "real_executor_execution_release_packet_is_not_executor_execution": True,
    "real_executor_execution_release_packet_is_not_executor_invocation": True,
    "real_executor_execution_release_packet_is_not_runtime_enablement": True,
    "real_executor_execution_release_packet_is_not_runtime_flag_flip": True,
    "real_executor_execution_release_packet_is_not_live_commit_execution": True,
    "real_executor_execution_release_packet_is_not_enabled_executor": True,
    "real_executor_execution_release_packet_is_not_executor_enablement": True,
    "real_executor_execution_release_packet_is_not_executor_activation": True,
    "real_executor_execution_release_packet_is_not_lock_acquisition": True,
    "real_executor_execution_release_packet_is_not_lockfile_creation": True,
    "real_executor_execution_release_packet_is_not_memory_write": True,
    "real_executor_execution_release_packet_is_not_memory_deletion": True,
    "real_executor_execution_release_packet_is_not_memory_purge": True,
    "real_executor_execution_release_packet_is_not_index_mutation": True,
    "real_executor_execution_release_packet_is_not_capsule_persistence": True,
    "real_executor_execution_release_packet_is_not_tomb_completion": True,
    "real_executor_execution_release_packet_is_not_prompt_assembly": True,
    "real_executor_execution_release_packet_is_not_live_context_retrieval": True,
    "real_executor_execution_release_packet_is_not_action_execution": True,
    "real_executor_execution_release_packet_is_not_external_disclosure": True,
    "real_executor_execution_release_packet_is_not_truth": True,
    "real_executor_execution_release_packet_is_not_policy": True,
    "real_executor_execution_release_packet_is_not_authority": True,
    "real_executor_execution_release_packet_is_not_consent": True,
    "release_packet_readiness_is_metadata_only": True,
    "permit_gate_confirmation_is_metadata_only": True,
    ...
    "future_real_executor_execution_release_gate_required": True,
...
class RealExecutorExecutionReleasePacketFinding:
    severity: str; code: str; message: str; candidate_id: str = ""; record_id: str = ""
    def to_dict(self) -> dict[str, Any]: return asdict(self)

@dataclass(frozen=True)
class RealExecutorExecutionReleasePacketPolicy:
    schema_version: str = "real-executor-execution-release-packet.v1"
...
@dataclass(frozen=True)
class RealExecutorExecutionReleasePacketCandidate:
    ...
    @staticmethod
    def from_mapping(payload: Mapping[str, Any]) -> "RealExecutorExecutionReleasePacketCandidate":
        return RealExecutorExecutionReleasePacketCandidate(str(payload.get("candidate_id") or ""), str(payload.get("record_id") or ""), str(payload.get("candidate_type") or ""), tuple(str(v) for v in payload.get("operator_scope_keys", ())), _as_mapping(payload.get("metadata")), _as_mapping(payload.get("real_executor_execution_release_packet_claims") or payload.get("claims")))
    @property
    def is_noop(self) -> bool: return self.candidate_type in {"noop_real_executor_execution_release_packet_candidate", "noop_real_executor_execution_release_packet_candidate"}

@dataclass(frozen=True)
class RealExecutorExecutionReleasePacketMetadataRecord:
...
@dataclass(frozen=True)
class RealExecutorExecutionReleasePacketRecord:
    candidate_id: str; record_id: str; candidate_type: str; real_executor_execution_release_packet_decision: RealExecutorExecutionReleasePacketDecision
    ...
    release_packet_readiness_records: tuple[RealExecutorExecutionReleasePacketMetadataRecord, ...]
    permit_gate_confirmation_records: tuple[RealExecutorExecutionReleasePacketMetadataRecord, ...]
    execution_release_denial_records: tuple[RealExecutorExecutionReleasePacketMetadataRecord, ...]
    final_release_hold_point_records: tuple[RealExecutorExecutionReleasePacketMetadataRecord, ...]
    emergency_stop_confirmation_records: tuple[RealExecutorExecutionReleasePacketMetadataRecord, ...]
    rollback_readiness_records: tuple[RealExecutorExecutionReleasePacketMetadataRecord, ...]
    verification_readiness_records: tuple[RealExecutorExecutionReleasePacketMetadataRecord, ...]
    audit_readiness_records: tuple[RealExecutorExecutionReleasePacketMetadataRecord, ...]
    ...
    runtime_flag_target_state_is_active_runtime_state: bool = False; permit_gate_confirmation_is_not_executor_execution: bool = False
    execution_hold_points_are_live_execution: bool = False; operator_review_cannot_override_hard_blockers: bool = True
    future_real_executor_execution_release_gate_required: bool = True; future_real_live_memory_commit_execution_required: bool = True; future_post_execution_audit_required: bool = True
    digest: str = ""
    def to_dict(self) -> dict[str, Any]: return asdict(self)
    def with_digest(self) -> "RealExecutorExecutionReleasePacketRecord": return replace(self, digest=_digest({k: v for k, v in self.to_dict().items() if k != "digest"}))

@dataclass(frozen=True)
class RealExecutorExecutionReleasePacketPacket:
    schema_version: str; records: tuple[RealExecutorExecutionReleasePacketRecord, ...]; digest: str = ""; forbidden_next_steps: tuple[str, ...] = FORBIDDEN_NEXT_STEPS
    def to_dict(self) -> dict[str, Any]:
        payload = asdict(self); payload.update(INVARIANTS); return payload
    def with_digest(self) -> "RealExecutorExecutionReleasePacketPacket": return replace(self, digest=_digest({k: v for k, v in self.to_dict().items() if k != "digest"}))

@dataclass(frozen=True)
class RealExecutorExecutionReleasePacketReport:
    status: RealExecutorExecutionReleasePacketStatus; findings: tuple[RealExecutorExecutionReleasePacketFinding, ...]; summary_counts: Mapping[str, int]; digest: str = ""
...
@dataclass(frozen=True)
class RealExecutorExecutionReleasePacketResult:
    status: RealExecutorExecutionReleasePacketStatus; packet: RealExecutorExecutionReleasePacketPacket | None; report: RealExecutorExecutionReleasePacketReport; digest: str
...
def build_default_policy() -> RealExecutorExecutionReleasePacketPolicy: return RealExecutorExecutionReleasePacketPolicy()

def validate_policy(policy: RealExecutorExecutionReleasePacketPolicy | None = None) -> dict[str, Any]:
    active = policy or build_default_policy(); findings: list[RealExecutorExecutionReleasePacketFinding] = []
    if not active.default_deny or not active.metadata_only:
        findings.append(RealExecutorExecutionReleasePacketFinding("error", "policy_not_metadata_only_default_deny", "policy must remain metadata-only and default-deny"))
    for name in ("real_executor_enabled", "real_executor_runtime_enablement_enabled", "real_executor_enablement_enabled", "real_executor_invocation_enabled", "real_executor_run_enabled", "real_executor_activation_enabled", "real_lock_acquisition_enabled", "lockfile_creation_enabled", "real_memory_root_access_enabled"):
        if bool(getattr(active, name)):
            findings.append(RealExecutorExecutionReleasePacketFinding("error", name, f"{name} must remain false"))
    return {"status": "valid" if not findings else "invalid", "policy": active.to_dict(), "findings": [f.to_dict() for f in findings]}

def _blocked(code: str, findings: Sequence[RealExecutorExecutionReleasePacketFinding] = ()) -> RealExecutorExecutionReleasePacketResult:
    all_findings = tuple(findings) or (RealExecutorExecutionReleasePacketFinding("error", code, code),)
    report = RealExecutorExecutionReleasePacketReport("real_executor_execution_release_packet_blocked", all_findings, {"blocked": 1})
    report = replace(report, digest=_digest(report.to_dict()))
    return RealExecutorExecutionReleasePacketResult("real_executor_execution_release_packet_blocked", None, report, _digest(report.to_dict()))

def _metadata_record(kind: str, candidate: RealExecutorExecutionReleasePacketCandidate, metadata: Mapping[str, Any]) -> RealExecutorExecutionReleasePacketMetadataRecord:
    return RealExecutorExecutionReleasePacketMetadataRecord(kind, candidate.candidate_id, candidate.record_id, _digest(dict(metadata)))

def _valid_candidate(candidate: RealExecutorExecutionReleasePacketCandidate) -> bool:
    return bool(_ID_RE.match(candidate.candidate_id)) and bool(_ID_RE.match(candidate.record_id)) and candidate.candidate_type in REAL_EXECUTOR_EXECUTION_RELEASE_PACKET_CANDIDATE_TYPES

def _real_executor_execution_permit_gate_and_record(payload: Mapping[str, Any]) -> tuple[Mapping[str, Any], Mapping[str, Any]] | RealExecutorExecutionReleasePacketResult:
    packet = _as_mapping(payload.get("real_executor_execution_permit_gate"))
    if not packet: return _blocked("missing_real_executor_execution_permit_gate")
    records = packet.get("records")
    if not isinstance(records, Sequence) or isinstance(records, (str, bytes)) or not records: return _blocked("invalid_real_executor_execution_permit_gate")
    record = _as_mapping(records[0])
    if not str(packet.get("digest") or "") or not str(record.get("digest") or ""): return _blocked("invalid_real_executor_execution_permit_gate")
    return packet, record

def _candidate_list(payload: Mapping[str, Any]) -> Sequence[Any] | RealExecutorExecutionReleasePacketResult:
    candidates = payload.get("real_executor_execution_release_packet_candidates")
    if not isinstance(candidates, Sequence) or isinstance(candidates, (str, bytes)) or not candidates: return _blocked("missing_real_executor_execution_release_packet_candidate")
    return candidates

def _check_required_metadata(raw: Mapping[str, Any], candidate: RealExecutorExecutionReleasePacketCandidate) -> RealExecutorExecutionReleasePacketResult | None:
    ...
    for field in NON_NOOP_METADATA_FIELDS:
        if not isinstance(raw.get(field), Mapping) or not raw.get(field):
            return _blocked(f"missing_{field}", [RealExecutorExecutionReleasePacketFinding("error", f"missing_{field}", f"missing required non-noop metadata: {field}", candidate.candidate_id, candidate.record_id)])
    return None

def _check_evidence(raw: Mapping[str, Any], packet: Mapping[str, Any], record: Mapping[str, Any], candidate: RealExecutorExecutionReleasePacketCandidate) -> RealExecutorExecutionReleasePacketResult | None:
    decision = str(record.get("real_executor_execution_permit_gate_decision") or "")
    if decision not in READY_REAL_EXECUTOR_EXECUTION_PERMIT_GATE_DECISIONS:
        return _blocked("real_executor_execution_permit_gate_not_ready", [RealExecutorExecutionReleasePacketFinding("error", "real_executor_execution_permit_gate_not_ready", "real executor execution permit gate is not ready by default", candidate.candidate_id, candidate.record_id)])
    for label, candidate_digest_field, record_digest_field, candidate_decision_field in EVIDENCE_MATCH_FIELDS:
        actual_digest = str(packet.get("digest") if label == "real_executor_execution_permit_gate" else record.get(record_digest_field) or "")
        if label == "real_executor_execution_permit_gate":
            actual_decision = str(record.get("real_executor_execution_permit_gate_decision") or "")
        else:
        ...
        if str(raw.get(candidate_digest_field) or "") != actual_digest:
            return _blocked(f"{label}_digest_mismatch", [RealExecutorExecutionReleasePacketFinding("error", f"{label}_digest_mismatch", f"{label} digest mismatch", candidate.candidate_id, candidate.record_id)])
        if str(raw.get(candidate_decision_field) or "") != actual_decision:
            return _blocked(f"{label}_decision_mismatch", [RealExecutorExecutionReleasePacketFinding("error", f"{label}_decision_mismatch", f"{label} decision mismatch", candidate.candidate_id, candidate.record_id)])
    return None

def _check_scope(packet_record: Mapping[str, Any], candidate: RealExecutorExecutionReleasePacketCandidate, policy: RealExecutorExecutionReleasePacketPolicy) -> RealExecutorExecutionReleasePacketResult | None:
    if not policy.require_scope_alignment or candidate.candidate_type in {"mixed_real_executor_execution_release_packet_candidate", "mixed_real_executor_execution_release_packet_candidate"}: return None
    ...
    if upstream and candidate.operator_scope_keys != upstream:
        return _blocked("scope_mismatch", [RealExecutorExecutionReleasePacketFinding("error", "scope_mismatch", "real executor execution release packet candidate scope does not align with upstream evidence", candidate.candidate_id, candidate.record_id)])
    return None

def _claims_findings(candidate: RealExecutorExecutionReleasePacketCandidate) -> tuple[RealExecutorExecutionReleasePacketFinding, ...]:
    return tuple(RealExecutorExecutionReleasePacketFinding("error", code, f"forbidden real executor execution release packet claim blocked: {key}", candidate.candidate_id, candidate.record_id) for key, code in FORBIDDEN_CLAIM_CODES.items() if candidate.claims.get(key) is True)

def _decision(candidate: RealExecutorExecutionReleasePacketCandidate, findings: Sequence[RealExecutorExecutionReleasePacketFinding]) -> RealExecutorExecutionReleasePacketDecision:
    if candidate.is_noop: return "real_executor_execution_release_packet_noop"
    if candidate.candidate_type in {"operator_review_real_executor_execution_release_packet_candidate", "operator_review_real_executor_execution_release_packet_candidate"}: return "real_executor_execution_release_packet_deferred_for_operator_review"
    if any(f.severity == "warning" for f in findings) or candidate.candidate_type in {"mixed_real_executor_execution_release_packet_candidate", "mixed_real_executor_execution_release_packet_candidate"}: return "real_executor_execution_release_packet_ready_with_warnings"
    return "real_executor_execution_release_packet_ready_for_later_real_executor_execution_release_gate"

def _safe_actions(decision: RealExecutorExecutionReleasePacketDecision) -> tuple[str, ...]:
    if decision == "real_executor_execution_release_packet_noop": return ("record_noop_metadata", "continue_review_without_executor_authority")
    if decision == "real_executor_execution_release_packet_deferred_for_operator_review": return ("operator_review_metadata", "resolve_without_overriding_hard_blockers")
    return ("review_real_executor_execution_release_packet_metadata", "prepare_separate_future_real_executor_execution_release_gate_request")

def evaluate_real_executor_execution_release_packet(payload: Mapping[str, Any], policy: RealExecutorExecutionReleasePacketPolicy | None = None) -> RealExecutorExecutionReleasePacketResult:
    active_policy = policy or build_default_policy(); policy_validation = validate_policy(active_policy)
    if policy_validation["status"] != "valid": return _blocked("invalid_policy", tuple(RealExecutorExecutionReleasePacketFinding(**f) for f in policy_validation["findings"]))
    pair = _real_executor_execution_permit_gate_and_record(payload)
    if isinstance(pair, RealExecutorExecutionReleasePacketResult): return pair
    permit_gate, packet_record = pair
    candidates_raw = _candidate_list(payload)
    if isinstance(candidates_raw, RealExecutorExecutionReleasePacketResult): return candidates_raw
    findings: list[RealExecutorExecutionReleasePacketFinding] = []; records: list[RealExecutorExecutionReleasePacketRecord] = []
    try:
        for raw_value in candidates_raw:
            raw = _as_mapping(raw_value); candidate = RealExecutorExecutionReleasePacketCandidate.from_mapping(raw)
            if not _valid_candidate(candidate): return _blocked("invalid_real_executor_execution_release_packet_candidate", [RealExecutorExecutionReleasePacketFinding("error", "invalid_real_executor_execution_release_packet_candidate", "invalid real executor execution release packet candidate", candidate.candidate_id, candidate.record_id)])
            ...
            for check in (_check_required_metadata(raw, candidate), _check_scope(packet_record, candidate, active_policy), _check_evidence(raw, permit_gate, packet_record, candidate)):
                if check is not None: return check
            if candidate.candidate_type in {"mixed_real_executor_execution_release_packet_candidate", "mixed_real_executor_execution_release_packet_candidate"} and candidate.metadata.get("diagnostic_warning") is True:
                findings.append(RealExecutorExecutionReleasePacketFinding("warning", "mixed_scope_diagnostic", "mixed real executor execution release packet diagnostics allowed as warnings only", candidate.candidate_id, candidate.record_id))
            decision = _decision(candidate, findings)
            records.append(RealExecutorExecutionReleasePacketRecord(
                candidate.candidate_id, candidate.record_id, candidate.candidate_type, decision,
                str(permit_gate.get("digest") or ""), str(packet_record.get("real_executor_execution_permit_gate_decision") or ""),
                ...
                (_metadata_record("release_packet_readiness", candidate, _as_mapping(raw.get("release_packet_readiness_metadata") or raw.get("metadata"))),),
                (_metadata_record("permit_gate_confirmation", candidate, _as_mapping(raw.get("permit_gate_confirmation_metadata") or raw.get("real_executor_execution_release_packet_prerequisite_metadata"))),),
                (_metadata_record("execution_release_denial", candidate, _as_mapping(raw.get("execution_release_denial_metadata") or raw.get("real_executor_execution_release_packet_hold_point_metadata"))),),
        ...
        for record in records:
            counts[record.real_executor_execution_release_packet_decision] = counts.get(record.real_executor_execution_release_packet_decision, 0) + 1
            counts[record.candidate_type] = counts.get(record.candidate_type, 0) + 1
        decisions = {r.real_executor_execution_release_packet_decision for r in records}
        if counts["warning_count"] or "real_executor_execution_release_packet_ready_with_warnings" in decisions: status: RealExecutorExecutionReleasePacketStatus = "real_executor_execution_release_packet_ready_with_warnings"
        elif decisions <= {"real_executor_execution_release_packet_noop"}: status = "real_executor_execution_release_packet_noop"
        elif decisions <= {"real_executor_execution_release_packet_deferred_for_operator_review"}: status = "real_executor_execution_release_packet_deferred_for_operator_review"
        else: status = "real_executor_execution_release_packet_ready"
        packet = RealExecutorExecutionReleasePacketPacket(active_policy.schema_version, tuple(records)).with_digest()
        report = RealExecutorExecutionReleasePacketReport(status, tuple(findings), dict(sorted(counts.items())))
        report = replace(report, digest=_digest(report.to_dict()))
        return RealExecutorExecutionReleasePacketResult(status, packet, report, _digest({"packet": packet.to_dict(), "report": report.to_dict()}))
    except Exception as exc:
        return _blocked("failed", [RealExecutorExecutionReleasePacketFinding("error", "failed", str(exc))])

def evaluate_packet(payload: Mapping[str, Any], policy: RealExecutorExecutionReleasePacketPolicy | None = None) -> RealExecutorExecutionReleasePacketResult:
    return evaluate_real_executor_execution_release_packet(payload, policy)

__all__ = [
    "EVIDENCE_MATCH_FIELDS", "FAIL_STATUSES", "FORBIDDEN_NEXT_STEPS", "INVARIANTS", "NON_NOOP_METADATA_FIELDS",
    "READY_REAL_EXECUTOR_EXECUTION_PERMIT_GATE_DECISIONS", "REAL_EXECUTOR_EXECUTION_RELEASE_PACKET_CANDIDATE_TYPES", "RealExecutorExecutionReleasePacketCandidate",
    "RealExecutorExecutionReleasePacketFinding", "RealExecutorExecutionReleasePacketMetadataRecord", "RealExecutorExecutionReleasePacketPacket", "RealExecutorExecutionReleasePacketPolicy",
    "RealExecutorExecutionReleasePacketRecord", "RealExecutorExecutionReleasePacketReport", "RealExecutorExecutionReleasePacketResult", "build_default_policy",
    "evaluate_packet", "evaluate_real_executor_execution_release_packet", "validate_policy",
]
