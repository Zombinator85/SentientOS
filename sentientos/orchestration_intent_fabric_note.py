...
def orchestration_intent_fabric_note() -> dict[str, Any]:
    ...
    return {
        ...
        "current_orchestration_handoff_packet_brief": {
            "what_it_is": "a compact observational-only resolver for current packet posture in the current next-move chain",
            "machine_surface": "sentientos.orchestration_intent_fabric.resolve_current_orchestration_handoff_packet_brief",
            "classifications": [
            ...
            "derived_from_existing_surfaces_only": [
                "current orchestration state/watchpoint/satisfaction/trigger",
                "current re-evaluation basis brief",
                "current resumption candidate + resumed readiness",
                "current wake-readiness detector + pressure signal",
                "current orchestration next-move brief",
            ...
            "strict_boundaries": [
                "non-sovereign, non-authoritative, non-executing",
                "informational/conservative packet posture only; not planner/scheduler/router",
                "does not create a new truth source or mutable packet lifecycle store",
        ...
        "current_orchestration_resolution_path_brief": {
            "what_it_is": "a compact observational-only resolver that classifies which bounded current orchestration resolution-path the loop is presently centered on",
            "machine_surface": "sentientos.orchestration_intent_fabric.resolve_current_orchestration_resolution_path_brief",
            "classifications": [
            ...
            "derived_from_existing_surfaces_only": [
                ...
                "current resumption candidate + resumed readiness",
                "current wake-readiness detector + pressure signal",
                "current orchestration next-move brief + handoff packet brief + operator-facing brief",
                "active handoff packet visibility + operator-action brief visibility + operator-resolution visibility",
                "internal execution result visibility + external fulfillment receipt visibility + unified result visibility",
            ],
            "strict_boundaries": [
                "non-sovereign, non-authoritative, non-executing",
                "path classification only; not a scheduler/planner/router/decision engine",
                "does not create a new mutable truth source or orchestration layer",
                "does not imply permission to execute",
            ],
        },
        "current_orchestration_closure_brief": {
            "what_it_is": "a compact observational-only resolver that summarizes current bounded closure posture and whether closure is pending, reachable, blocked, already satisfied, or absent",
            "machine_surface": "sentientos.orchestration_intent_fabric.resolve_current_orchestration_closure_brief",
            "classifications": [
            ...
            "strict_boundaries": [
                "non-sovereign, non-authoritative, non-executing",
                "closure posture classification only; never a scheduler/planner/execution venue",
                "does not create a new mutable truth source or orchestration layer",
                "does not imply permission to execute",
            ],
        },
        ...
        "current_orchestration_transition_brief": {
            "what_it_is": "a compact observational-only resolver that classifies which bounded transition posture the current orchestration picture is presently poised for if the picture changes next under existing logic",
            "machine_surface": "sentientos.orchestration_intent_fabric.resolve_current_orchestration_transition_brief",
            "classifications": [
            ...
            "derived_from_existing_surfaces_only": [
                ...
                "current wake-readiness detector + pressure signal",
                "proposal-packet continuity review",
                "current orchestration next-move brief + handoff packet brief + operator-facing brief + resolution-path brief + closure brief + coherence brief + digest",
            ],
            "strict_boundaries": [
                "non-sovereign, non-authoritative, non-executing",
                "transition posture compression only; not a scheduler/planner/decision engine/execution venue",
                "does not create a new truth source, mutable store, or orchestration layer",
                "does not imply permission to execute",
            ],
        },
        ...
        "current_orchestration_wake_readiness_detector": {
            "meaning": "derived, non-executing current wake-readiness detector that classifies whether current watchpoint/wait posture has crossed into bounded wake-ready status under existing orchestration surfaces.",
            "machine_surface": "sentientos.orchestration_intent_fabric.resolve_current_orchestration_wake_readiness_detector",
            "derived_from_existing_surfaces_only": [
                "resolve_current_orchestration_state",
                "resolve_current_orchestration_watchpoint",
                "resolve_watchpoint_satisfaction",
        ...
        "current_re_evaluation_basis_brief": {
            "meaning": "derived, non-executing brief that states why the current re-evaluation recommendation exists under current bounded orchestration surfaces.",
            "machine_surface": "sentientos.orchestration_intent_fabric.resolve_current_re_evaluation_basis_brief",
            "derived_from_existing_surfaces_only": [
                "resolve_current_orchestration_watchpoint",
                "resolve_watchpoint_satisfaction",
                "resolve_re_evaluation_trigger_recommendation",
