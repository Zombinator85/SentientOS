...
TARGETED_TEST_LANE_ALIASES: tuple[str, ...] = (
    ...
    "sandboxed_live_memory_commit_adapter_envelope_tests",
    ...
    "guarded_executor_invocation_packet_tests",
    "real_executor_invocation_gate_tests",
    "real_executor_run_packet_tests",
    ...
    "real_executor_execution_release_packet_tests",
    "real_executor_execution_release_gate_tests",
    "real_executor_execution_activation_packet_tests",
    ...
    "real_executor_execution_preflight_gate_tests",
    "real_executor_execution_lock_lease_packet_tests",
    "real_executor_execution_lock_lease_gate_tests",
    "real_executor_execution_commit_plan_packet_tests",
    "real_executor_execution_commit_plan_gate_tests",
    "real_executor_execution_commit_window_packet_tests",
    "real_live_memory_commit_execution_gate_tests",
    "real_live_memory_commit_execution_packet_tests",
    "real_live_memory_commit_adapter_admission_gate_tests",
    "real_live_memory_commit_adapter_admission_packet_tests",
    "real_live_memory_commit_adapter_readiness_gate_tests",
    "review_packet_tests",
    ...
    "phase97_external_security_review_packet_tests",
    "phase98_external_audit_export_receipt_tests",
    "phase99_invocation_denial_attestation_tests",
    "phase100_invocation_denial_closure_tests",
    "phase101_invocation_denial_enforcement_tests",
    "phase102_invocation_denial_drift_review_tests",
    "phase103_invocation_denial_custody_checkpoint_tests",
    "governed_local_model_invocation_tests",
    "genesis_reviewed_candidate_adoption_custody_tests",
    "genesis_model_advice_runtime_closure_tests",
    "local_model_artifact_acquisition_tests",
    "local_model_production_commissioning_boundary",
    "local_model_production_commissioning_tests",
    "governed_improvement_signal_plane_tests",
    "world_state_evidence_board_tests",
    "resident_developmental_cognition_tests",
    "host_resource_observation_runtime_tests",
    ...
    "host_local_authorization_grant_custody_tests",
    "host_fulfillment_authorization_consumption_custody_tests",
    "host_fulfillment_executor_contract_readiness_runtime_tests",
    "host_dry_run_execution_runtime_tests",
    "host_dry_run_audit_closure_runtime_tests",
    ...
    "host_local_diagnostic_lifecycle_closure_tests",
    "proof_bundle_tests",
