...
def build_default_capability_registry() -> CapabilityRegistry:
    ...
    records = (
        ...
        _record("genesis_local_model_proposal_advice", "governed_improvement_signal_plane", "implemented", "proposal_only", source_paths=("sentientos/governed_local_model_invocation.py", "sentientos/genesis_forge.py"), proof_tests=("tests/test_governed_local_model_invocation.py", "tests/test_genesis_forge.py"), implemented_surfaces=("optional untrusted structured proposal advice", "deterministic fallback when denied or unavailable"), forbidden_implications=("model advice is approval", "model advice bypasses router/integrity/sandbox", "model advice triggers adoption or repository mutation")),
