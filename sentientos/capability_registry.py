...
def build_default_capability_registry() -> CapabilityRegistry:
    ...
    records = (
        ...
        _record("sandboxed_live_memory_commit_adapter", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/sandboxed_live_memory_commit_adapter.py", "scripts/build_sandboxed_live_memory_commit_adapter.py", "docs/architecture/sandboxed_live_memory_commit_adapter.md"), proof_tests=("tests/test_sandboxed_live_memory_commit_adapter.py", "tests/test_build_sandboxed_live_memory_commit_adapter_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_sandboxed_live_memory_commit_adapter.py tests/test_build_sandboxed_live_memory_commit_adapter_script.py",), implemented_surfaces=("deterministic sandbox-only JSON artifact, receipt manifest, and rollback manifest emission after safety-interlock evidence",), deferred_surfaces=("real live memory commit adapter", "real memory-root admission", "runtime memory mutation", "runtime memory deletion", "runtime memory purge", "live index mutation", "prompt assembly", "external disclosure", "action execution", "policy creation", "authority grants", "consent grants", "truth assertions"), forbidden_implications=("sandbox commit is a real memory write", "sandbox commit deletes memory", "sandbox commit purges memory", "sandbox commit mutates live indexes", "sandbox commit is truth", "sandbox commit is policy", "sandbox commit grants authority", "sandbox commit implies consent", "sandbox commit assembles prompts", "sandbox commit executes actions", "sandbox commit discloses externally")),
