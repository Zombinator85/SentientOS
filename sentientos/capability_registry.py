...
CAPABILITY_CATEGORIES = frozenset(
    {
        ...
        "host_resource_observation_runtime",
        "privilege_broker",
        ...
        "memory_distillation",
        "repository_mutation_handoff",
        "governed_improvement_signal_plane",
        "world_state_evidence_board",
    }
)
...
def build_default_capability_registry() -> CapabilityRegistry:
    ...
    records = (
        ...
        _record("local_model_authority_map", "local_model_chat", "implemented", "metadata_verification_only", source_paths=("sentientos/local_model_authority.py", "sentientos/config.py", "sentientos/local_model.py"), proof_tests=("tests/test_local_model_authority.py",), proof_commands=("python -m scripts.run_tests -q tests/test_local_model_authority.py",), implemented_surfaces=("digest-bound local model authority map", "local artifact/configuration posture verification"), deferred_surfaces=("model invocation by map alone",), forbidden_implications=("authority map grants provider/network/tool/memory/action/adoption/repository authority",)),
        _record("governed_local_model_invocation", "local_model_chat", "implemented", "proposal_only", source_paths=("sentientos/governed_local_model_invocation.py", "sentientos/chat_service.py", "scripts/build_governed_local_model_invocation.py"), proof_tests=("tests/test_governed_local_model_invocation.py", "tests/test_chat_service_lazy_loading.py"), proof_commands=("python -m scripts.run_tests -q tests/test_governed_local_model_invocation.py tests/test_chat_service_lazy_loading.py",), implemented_surfaces=("bounded local-only inference", "control-plane admission", "digest-bound invocation receipts"), deferred_surfaces=("remote provider invocation",), forbidden_implications=("local model output grants tools", "local model output writes memory", "local model output mutates repository", "local model output triggers adoption"), requires_control_plane_admission=True, requires_audit_receipt=True),
        _record("genesis_local_model_proposal_advice", "governed_improvement_signal_plane", "implemented", "proposal_only", source_paths=("sentientos/genesis_model_advice.py", "sentientos/governed_local_model_invocation.py", "sentientos/genesis_forge.py", "sentientosd.py", "scripts/build_genesis_model_advice.py"), proof_tests=("tests/test_genesis_model_advice.py", "tests/test_build_genesis_model_advice_script.py", "tests/test_governed_local_model_invocation.py", "tests/test_genesis_forge.py", "tests/test_sentientosd_runtime_closure.py"), proof_commands=("python -m scripts.run_tests -q tests/test_genesis_model_advice.py tests/test_build_genesis_model_advice_script.py tests/test_governed_local_model_invocation.py tests/test_genesis_forge.py tests/test_sentientosd_runtime_closure.py",), implemented_surfaces=("strict bounded Genesis advice contract", "one governed local model call at most per need/tick", "one untrusted advice candidate inside total K", "shared stage-A/stage-B/router/sandbox pipeline", "sentientosd governed invoker injection", "deterministic fallback when denied or unavailable"), forbidden_implications=("model advice is approval", "model advice bypasses router/integrity/sandbox", "model advice triggers adoption or repository mutation", "model advice invokes SpecBinder or AdoptionRite", "model advice gets score privilege"), requires_control_plane_admission=True, requires_audit_receipt=True),
        _record("governed_improvement_signal_plane", "governed_improvement_signal_plane", "implemented", "proposal_only", source_paths=("sentientos/governed_improvement_signal_plane.py", "scripts/build_governed_improvement_signal_plane.py", "sentientosd.py", "sentientos/genesis_forge.py", "codex/amendments.py"), proof_tests=("tests/test_governed_improvement_signal_plane.py", "tests/test_build_governed_improvement_signal_plane_script.py", "tests/test_sentientosd_runtime_closure.py", "tests/test_repository_mutation_custody_regression.py"), proof_commands=("python -m scripts.run_tests -q tests/test_governed_improvement_signal_plane.py tests/test_build_governed_improvement_signal_plane_script.py tests/test_repository_mutation_custody_regression.py",), implemented_surfaces=("deterministic local evidence normalization and routing", "sentientosd maintenance intake uses one bounded batch before GenesisForge and SpecAmender", "Genesis proposal-only runtime review artifacts"), deferred_surfaces=("automatic proposal approval", "automatic Genesis adoption", "live mount mutation", "autonomous repository staging/commit/branch/push/PR", "provider invocation", "network egress", "ExternalGapSeeker update application"), forbidden_implications=("evidence is authority", "pending proposal is adopted", "signal intake mutates repository source", "signal intake invokes providers or Git", "signal intake creates autonomous goals or policies")),
        _record("world_state_evidence_board", "world_state_evidence_board", "implemented", "metadata_verification_only", source_paths=("sentientos/world_state_board.py", "sentientos/world_state_sources.py", "scripts/build_world_state_board.py", "sentientosd.py", "apps/dashboard/main.py"), proof_tests=("tests/test_world_state_board.py", "tests/test_world_state_sources.py", "tests/test_build_world_state_board_script.py", "tests/test_dashboard_world_state.py", "tests/test_sentientosd_runtime_closure.py"), proof_commands=("python -m scripts.run_tests -q tests/test_world_state_board.py tests/test_world_state_sources.py tests/test_build_world_state_board_script.py tests/test_dashboard_world_state.py tests/test_sentientosd_runtime_closure.py",), implemented_surfaces=("deterministic digest-bound read-only world-state snapshots", "source manifest validation", "staleness and contradiction posture", "sentientosd terminal projection", "authenticated dashboard inspection endpoints"), deferred_surfaces=("decision authority", "admission authority", "execution authority", "adoption authority", "repository mutation", "model invocation", "host effects"), forbidden_implications=("board display grants authority", "proposal is approval", "admission is execution", "receipt is effect proof", "handoff is repository landing")),
        _record("autonomous_repository_stage_commit_push", "repository_mutation_handoff", "blocked", "none", source_paths=("sentientosd.py", "sentientos/utils.py"), deferred_surfaces=("separate reviewed authority topology required", "Codex landing-finalizer and PR metadata guard contract required"), forbidden_implications=("daemon maintenance loop may stage repository files", "daemon maintenance loop may create commits", "daemon maintenance loop may push", "environment flag restores autonomous git mutation")),
        _record("selective_memory_distillation_contract", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/selective_memory_distillation_contract.py", "scripts/build_selective_memory_distillation_contract.py", "docs/architecture/selective_memory_distillation_contract.md"), proof_tests=("tests/test_selective_memory_distillation_contract.py", "tests/test_build_selective_memory_distillation_contract_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_selective_memory_distillation_contract.py tests/test_build_selective_memory_distillation_contract_script.py",), implemented_surfaces=("deterministic metadata-only retain/distill/capsule/tomb-intent decision packets",), deferred_surfaces=("distillation receipt writer", "tomb receipt verifier", "runtime memory mutation", "prompt assembly"), forbidden_implications=("retention is truth", "capsule is policy", "capsule is authority", "tomb intent deletes memory", "distillation writes memory")),
        _record("selective_memory_distillation_receipt_gate", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/selective_memory_distillation_receipt_gate.py", "scripts/build_selective_memory_distillation_receipt_gate.py", "docs/architecture/selective_memory_distillation_receipt_gate.md"), proof_tests=("tests/test_selective_memory_distillation_receipt_gate.py", "tests/test_build_selective_memory_distillation_receipt_gate_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_selective_memory_distillation_receipt_gate.py tests/test_build_selective_memory_distillation_receipt_gate_script.py",), implemented_surfaces=("deterministic metadata-only receipt gate decisions for distillation receipt candidates",), deferred_surfaces=("receipt writer", "tomb receipt verifier", "governed memory writer adapter", "runtime memory mutation", "prompt assembly", "external disclosure"), forbidden_implications=("receipt gate writes memory", "receipt gate deletes memory", "receipt gate completes tombs", "capsule admissibility is persistence", "receipt gate creates policy", "receipt gate grants authority")),
        _record("selective_memory_tomb_receipt_verifier", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/selective_memory_tomb_receipt_verifier.py", "scripts/build_selective_memory_tomb_receipt_verifier.py", "docs/architecture/selective_memory_tomb_receipt_verifier.md"), proof_tests=("tests/test_selective_memory_tomb_receipt_verifier.py", "tests/test_build_selective_memory_tomb_receipt_verifier_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_selective_memory_tomb_receipt_verifier.py tests/test_build_selective_memory_tomb_receipt_verifier_script.py",), implemented_surfaces=("deterministic metadata-only tomb receipt verification over distillation and receipt-gate evidence",), deferred_surfaces=("governed memory writer adapter", "runtime memory mutation", "prompt assembly", "external disclosure", "deletion proof", "tomb completion"), forbidden_implications=("tomb verifier writes memory", "tomb verifier deletes memory", "tomb verifier completes tombs", "observed deletion metadata is proof", "tomb verifier creates policy", "tomb verifier grants authority")),
        _record("governed_memory_writer_adapter", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/governed_memory_writer_adapter.py", "scripts/build_governed_memory_writer_adapter.py", "docs/architecture/governed_memory_writer_adapter.md"), proof_tests=("tests/test_governed_memory_writer_adapter.py", "tests/test_build_governed_memory_writer_adapter_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_governed_memory_writer_adapter.py tests/test_build_governed_memory_writer_adapter_script.py",), implemented_surfaces=("deterministic governed local JSON artifact previews and explicit artifact-write receipts",), deferred_surfaces=("live memory boundary admission", "runtime memory mutation", "vector index mutation", "prompt assembly", "external disclosure", "action execution", "policy creation", "authority grants"), forbidden_implications=("writer artifact is truth", "writer artifact is policy", "writer artifact grants authority", "writer artifact implies consent", "capsule artifact is live memory persistence", "tomb archive artifact deletes memory")),
        _record("live_memory_boundary_admission_gate", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/live_memory_boundary_admission_gate.py", "scripts/build_live_memory_boundary_admission_gate.py", "docs/architecture/live_memory_boundary_admission_gate.md"), proof_tests=("tests/test_live_memory_boundary_admission_gate.py", "tests/test_build_live_memory_boundary_admission_gate_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_live_memory_boundary_admission_gate.py tests/test_build_live_memory_boundary_admission_gate_script.py",), implemented_surfaces=("deterministic metadata-only admission decisions for future live-memory boundary review eligibility",), deferred_surfaces=("memory commit plan packet", "live memory commit adapter", "runtime memory mutation", "vector index mutation", "capsule persistence", "prompt assembly", "external disclosure", "action execution", "policy creation", "authority grants"), forbidden_implications=("admission is truth", "admission is policy", "admission grants authority", "admission implies consent", "admission writes live memory", "admission deletes memory", "admission persists capsules")),
        _record("memory_commit_plan_packet", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/memory_commit_plan_packet.py", "scripts/build_memory_commit_plan_packet.py", "docs/architecture/memory_commit_plan_packet.md"), proof_tests=("tests/test_memory_commit_plan_packet.py", "tests/test_build_memory_commit_plan_packet_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_memory_commit_plan_packet.py tests/test_build_memory_commit_plan_packet_script.py",), implemented_surfaces=("deterministic metadata-only future memory commit plan packets",), deferred_surfaces=("live memory commit adapter", "runtime memory mutation", "vector index mutation", "capsule persistence", "prompt assembly", "external disclosure", "action execution", "policy creation", "authority grants"), forbidden_implications=("commit plan is truth", "commit plan is policy", "commit plan grants authority", "commit plan implies consent", "commit plan writes live memory", "commit plan deletes memory", "commit plan persists capsules")),
        _record("memory_commit_operator_approval_packet", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/memory_commit_operator_approval_packet.py", "scripts/build_memory_commit_operator_approval_packet.py", "docs/architecture/memory_commit_operator_approval_packet.md"), proof_tests=("tests/test_memory_commit_operator_approval_packet.py", "tests/test_build_memory_commit_operator_approval_packet_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_memory_commit_operator_approval_packet.py tests/test_build_memory_commit_operator_approval_packet_script.py",), implemented_surfaces=("deterministic metadata-only operator approval packets for future memory commit consideration",), deferred_surfaces=("memory commit execution gate", "live memory commit adapter", "runtime memory mutation", "vector index mutation", "capsule persistence", "prompt assembly", "external disclosure", "action execution", "policy creation", "authority grants", "consent grants", "truth assertions"), forbidden_implications=("operator approval is execution", "operator approval is truth", "operator approval is policy", "operator approval grants authority", "operator approval implies consent", "operator approval writes live memory", "operator approval deletes memory", "operator approval persists capsules")),
        _record("memory_commit_execution_gate", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/memory_commit_execution_gate.py", "scripts/build_memory_commit_execution_gate.py", "docs/architecture/memory_commit_execution_gate.md"), proof_tests=("tests/test_memory_commit_execution_gate.py", "tests/test_build_memory_commit_execution_gate_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_memory_commit_execution_gate.py tests/test_build_memory_commit_execution_gate_script.py",), implemented_surfaces=("deterministic metadata-only execution gate eligibility packets for future memory commit adapter consideration",), deferred_surfaces=("live memory commit adapter", "future live dry-run", "runtime memory mutation", "vector index mutation", "capsule persistence", "prompt assembly", "external disclosure", "action execution", "policy creation", "authority grants", "consent grants", "truth assertions"), forbidden_implications=("execution gate is execution", "execution gate is live commit", "execution gate is truth", "execution gate is policy", "execution gate grants authority", "execution gate implies consent", "execution gate writes live memory", "execution gate deletes memory", "execution gate persists capsules")),
        _record("live_memory_commit_dry_run_adapter", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/live_memory_commit_dry_run_adapter.py", "scripts/build_live_memory_commit_dry_run_adapter.py", "docs/architecture/live_memory_commit_dry_run_adapter.md"), proof_tests=("tests/test_live_memory_commit_dry_run_adapter.py", "tests/test_build_live_memory_commit_dry_run_adapter_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_live_memory_commit_dry_run_adapter.py tests/test_build_live_memory_commit_dry_run_adapter_script.py",), implemented_surfaces=("deterministic metadata-only dry-run commit previews, simulated receipt previews, and rollback previews after execution gate evidence",), deferred_surfaces=("live memory commit adapter", "live commit safety interlock", "runtime memory mutation", "vector index mutation", "capsule persistence", "summary persistence", "tomb completion", "prompt assembly", "external disclosure", "action execution", "policy creation", "authority grants", "consent grants", "truth assertions"), forbidden_implications=("dry run is execution", "dry run is live commit", "dry run is truth", "dry run is policy", "dry run grants authority", "dry run implies consent", "dry run writes live memory", "dry run deletes memory", "dry run persists capsules", "dry run completes tombs")),
        _record("live_commit_safety_interlock", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/live_commit_safety_interlock.py", "scripts/build_live_commit_safety_interlock.py", "docs/architecture/live_commit_safety_interlock.md"), proof_tests=("tests/test_live_commit_safety_interlock.py", "tests/test_build_live_commit_safety_interlock_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_live_commit_safety_interlock.py tests/test_build_live_commit_safety_interlock_script.py",), implemented_surfaces=("deterministic metadata-only safety interlock decisions over dry-run and execution-gate evidence",), deferred_surfaces=("live memory commit adapter", "final live commit review", "runtime memory mutation", "vector index mutation", "capsule persistence", "summary persistence", "tomb completion", "prompt assembly", "external disclosure", "action execution", "policy creation", "authority grants", "consent grants", "truth assertions"), forbidden_implications=("interlock is execution", "interlock is live commit", "interlock is truth", "interlock is policy", "interlock grants authority", "interlock implies consent", "interlock writes live memory", "interlock deletes memory", "interlock persists capsules", "interlock completes tombs")),
        _record("sandboxed_live_memory_commit_adapter", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/sandboxed_live_memory_commit_adapter.py", "scripts/build_sandboxed_live_memory_commit_adapter.py", "docs/architecture/sandboxed_live_memory_commit_adapter.md"), proof_tests=("tests/test_sandboxed_live_memory_commit_adapter.py", "tests/test_build_sandboxed_live_memory_commit_adapter_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_sandboxed_live_memory_commit_adapter.py tests/test_build_sandboxed_live_memory_commit_adapter_script.py",), implemented_surfaces=("deterministic metadata-only sandboxed live memory commit adapter decisions over Real Memory Root Admission Packet evidence, carried upstream evidence, and explicit adapter candidates",), deferred_surfaces=("real live memory commit adapter", "later sandboxed live memory commit adapter gate", "future real live memory commit execution", "future post-execution audit", "real memory-root access", "real memory-root admission", "runtime memory mutation", "live adapter creation", "live adapter admission", "executor invocation", "executor activation", "execution release", "execution permit", "execution authorization", "runtime enablement", "lock acquisition", "lockfile creation", "prompt assembly", "live context retrieval", "external disclosure", "action execution", "authority grants"), forbidden_implications=("sandbox commit is a real memory write", "sandboxed adapter is live execution", "sandboxed adapter approves live execution", "sandboxed adapter applies commits", "sandboxed adapter writes live memory", "sandboxed adapter admits real memory roots", "sandboxed adapter creates or admits live adapters", "sandboxed adapter acquires locks or creates lockfiles", "sandboxed adapter invokes, activates, releases, permits, or authorizes executors", "sandboxed adapter enables runtime", "sandboxed adapter grants authority or permission to execute")),
        _record("sandboxed_live_memory_commit_adapter_gate", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/sandboxed_live_memory_commit_adapter_gate.py", "scripts/build_sandboxed_live_memory_commit_adapter_gate.py", "docs/architecture/sandboxed_live_memory_commit_adapter_gate.md"), proof_tests=("tests/test_sandboxed_live_memory_commit_adapter_gate.py", "tests/test_build_sandboxed_live_memory_commit_adapter_gate_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_sandboxed_live_memory_commit_adapter_gate.py tests/test_build_sandboxed_live_memory_commit_adapter_gate_script.py",), implemented_surfaces=("deterministic metadata-only sandboxed live memory commit adapter gate decisions over Sandboxed Live Memory Commit Adapter evidence, carried upstream evidence, and explicit gate candidates",), deferred_surfaces=("later sandboxed live memory commit adapter packet", "future real live memory commit execution", "future post-execution audit", "real memory-root access", "real memory-root admission", "runtime memory mutation", "live adapter creation", "live adapter admission", "executor invocation", "executor activation", "execution release", "execution permit", "execution authorization", "runtime enablement", "lock acquisition", "lockfile creation", "prompt assembly", "live context retrieval", "external disclosure", "action execution", "authority grants"), forbidden_implications=("adapter gate is live execution", "adapter gate approves live execution", "adapter gate applies commits", "adapter gate writes live memory", "adapter gate admits real memory roots", "adapter gate creates or admits live adapters", "adapter gate acquires locks or creates lockfiles", "adapter gate invokes, activates, releases, permits, or authorizes executors", "adapter gate enables runtime", "adapter gate grants authority or permission to execute")),
        _record("sandboxed_live_memory_commit_adapter_packet", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/sandboxed_live_memory_commit_adapter_packet.py", "scripts/build_sandboxed_live_memory_commit_adapter_packet.py", "docs/architecture/sandboxed_live_memory_commit_adapter_packet.md"), proof_tests=("tests/test_sandboxed_live_memory_commit_adapter_packet.py", "tests/test_build_sandboxed_live_memory_commit_adapter_packet_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_sandboxed_live_memory_commit_adapter_packet.py tests/test_build_sandboxed_live_memory_commit_adapter_packet_script.py",), implemented_surfaces=("deterministic metadata-only sandboxed live memory commit adapter packet decisions over Sandboxed Live Memory Commit Adapter Gate evidence, carried upstream evidence, and explicit packet candidates",), deferred_surfaces=("later sandboxed live memory commit adapter envelope", "future real live memory commit execution", "future post-execution audit", "real memory-root access", "real memory-root admission", "runtime memory mutation", "live adapter creation", "live adapter admission", "executor invocation", "executor activation", "execution release", "execution permit", "execution authorization", "runtime enablement", "lock acquisition", "lockfile creation", "prompt assembly", "live context retrieval", "external disclosure", "action execution", "authority grants"), forbidden_implications=("adapter packet is live execution", "adapter packet approves live execution", "adapter packet applies commits", "adapter packet writes live memory", "adapter packet admits real memory roots", "adapter packet creates or admits live adapters", "adapter packet acquires locks or creates lockfiles", "adapter packet invokes, activates, releases, permits, or authorizes executors", "adapter packet enables runtime", "adapter packet grants authority or permission to execute")),
        _record("sandboxed_live_memory_commit_adapter_envelope", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/sandboxed_live_memory_commit_adapter_envelope.py", "scripts/build_sandboxed_live_memory_commit_adapter_envelope.py", "docs/architecture/sandboxed_live_memory_commit_adapter_envelope.md"), proof_tests=("tests/test_sandboxed_live_memory_commit_adapter_envelope.py", "tests/test_build_sandboxed_live_memory_commit_adapter_envelope_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_sandboxed_live_memory_commit_adapter_envelope.py tests/test_build_sandboxed_live_memory_commit_adapter_envelope_script.py",), implemented_surfaces=("deterministic metadata-only sandboxed live memory commit adapter envelope decisions over Sandboxed Live Memory Commit Adapter Packet evidence, carried upstream evidence, and explicit envelope candidates",), deferred_surfaces=("later sandboxed live memory commit adapter readiness gate", "future real live memory commit execution", "future post-execution audit", "real memory-root access", "real memory-root admission", "runtime memory mutation", "live adapter creation", "live adapter admission", "executor invocation", "executor activation", "execution release", "execution permit", "execution authorization", "runtime enablement", "lock acquisition", "lockfile creation", "prompt assembly", "live context retrieval", "external disclosure", "action execution", "authority grants"), forbidden_implications=("adapter envelope is live execution", "adapter envelope approves live execution", "adapter envelope applies commits", "adapter envelope writes live memory", "adapter envelope admits real memory roots", "adapter envelope creates or admits live adapters", "adapter envelope acquires locks or creates lockfiles", "adapter envelope invokes, activates, releases, permits, or authorizes executors", "adapter envelope enables runtime", "adapter envelope grants authority or permission to execute")),
        _record("real_memory_root_admission_gate", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/real_memory_root_admission_gate.py", "scripts/build_real_memory_root_admission_gate.py", "docs/architecture/real_memory_root_admission_gate.md"), proof_tests=("tests/test_real_memory_root_admission_gate.py", "tests/test_build_real_memory_root_admission_gate_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_real_memory_root_admission_gate.py tests/test_build_real_memory_root_admission_gate_script.py",), implemented_surfaces=("deterministic metadata-only Real Memory Root Admission Gate decisions over Final Live Memory Commit Review Gate evidence, carried-through upstream evidence, and explicit real-memory-root-admission-gate candidates",), deferred_surfaces=("later Real Memory Root Admission Packet metadata rung", "future real live memory commit adapter", "real memory-root access", "real memory-root admission", "real memory-root admission packet creation", "runtime memory mutation", "runtime memory deletion", "runtime memory purge", "live index mutation", "live adapter creation", "live adapter admission", "executor invocation", "executor activation", "execution release", "execution permit", "execution authorization", "runtime enablement", "lock acquisition", "lockfile creation", "prompt assembly", "live context retrieval", "external disclosure", "action execution", "policy creation", "authority grants", "consent grants", "truth assertions"), forbidden_implications=("real-root admission is live memory access", "real-root admission writes live memory", "real-root admission gate is live memory access", "real-root admission gate creates a real memory root admission packet", "real-root admission gate admits real memory roots", "real-root admission gate approves live execution", "real-root admission gate executes or applies commits", "real-root admission gate writes live memory", "real-root admission gate creates or admits live adapters", "real-root admission gate invokes, activates, releases, permits, or authorizes executors", "real-root admission gate enables runtime", "real-root admission gate acquires locks or creates lockfiles", "real-root admission gate is truth", "real-root admission gate is policy", "real-root admission gate grants authority", "real-root admission gate implies consent", "final review is converted to execution permission")),
        _record("real_memory_root_admission_packet", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/real_memory_root_admission_packet.py", "scripts/build_real_memory_root_admission_packet.py", "docs/architecture/real_memory_root_admission_packet.md"), proof_tests=("tests/test_real_memory_root_admission_packet.py", "tests/test_build_real_memory_root_admission_packet_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_real_memory_root_admission_packet.py tests/test_build_real_memory_root_admission_packet_script.py",), implemented_surfaces=("deterministic metadata-only Real Memory Root Admission Packet decisions over Real Memory Root Admission Gate evidence, carried-through upstream evidence, and explicit real-memory-root-admission-packet candidates",), deferred_surfaces=("later Sandboxed Live Memory Commit Adapter metadata rung", "future real live memory commit execution", "future post-execution audit", "real memory-root access", "real memory-root admission", "admission packet authority", "runtime memory mutation", "live adapter creation", "live adapter admission", "executor invocation", "executor activation", "execution release", "execution permit", "execution authorization", "runtime enablement", "lock acquisition", "lockfile creation", "prompt assembly", "live context retrieval", "external disclosure", "action execution", "authority grants"), forbidden_implications=("real-root admission packet is live execution", "real-root admission packet approves live execution", "real-root admission packet applies commits", "real-root admission packet writes live memory", "real-root admission packet acquires locks or creates lockfiles", "real-root admission packet invokes, activates, releases, permits, or authorizes executors", "real-root admission packet enables runtime", "real-root admission packet creates or admits live adapters", "real-root admission packet admits real memory roots", "real-root admission packet grants authority or permission to execute")),
        _record("final_live_memory_commit_review_gate", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/final_live_memory_commit_review_gate.py", "scripts/build_final_live_memory_commit_review_gate.py", "docs/architecture/final_live_memory_commit_review_gate.md"), proof_tests=("tests/test_final_live_memory_commit_review_gate.py", "tests/test_build_final_live_memory_commit_review_gate_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_final_live_memory_commit_review_gate.py tests/test_build_final_live_memory_commit_review_gate_script.py",), implemented_surfaces=("deterministic metadata-only Final Live Memory Commit Review Gate decisions over Real Live Memory Commit Adapter Readiness Envelope evidence, carried-through upstream evidence, and explicit final-review-gate candidates",), deferred_surfaces=("later Real Memory Root Admission Gate metadata rung", "future real live memory commit adapter implementation", "future real live memory commit execution", "later explicit operator runtime execution", "real memory-root access", "runtime memory mutation", "runtime memory deletion", "runtime memory purge", "live index mutation", "prompt assembly", "live context retrieval", "external disclosure", "action execution", "policy creation", "authority grants", "consent grants", "truth assertions"), forbidden_implications=("final review is live memory access", "final review writes live memory", "final review deletes memory", "final review purges memory", "final review mutates indexes", "final review is a live commit", "final review is real adapter execution", "final review is truth", "final review is policy", "final review grants authority", "final review implies consent", "sandbox commit is converted to a real commit", "real-root admission is converted to memory-root access")),
        _record("real_live_memory_commit_adapter_readiness_envelope", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/real_live_memory_commit_adapter_readiness_envelope.py", "scripts/build_real_live_memory_commit_adapter_readiness_envelope.py", "docs/architecture/real_live_memory_commit_adapter_readiness_envelope.md"), proof_tests=("tests/test_real_live_memory_commit_adapter_readiness_envelope.py", "tests/test_build_real_live_memory_commit_adapter_readiness_envelope_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_real_live_memory_commit_adapter_readiness_envelope.py tests/test_build_real_live_memory_commit_adapter_readiness_envelope_script.py",), implemented_surfaces=("deterministic disabled-by-default adapter-readiness envelopes over final review evidence and explicit readiness candidates",), deferred_surfaces=("future explicit runtime execution gate", "future operator runtime confirmation", "real live memory commit adapter execution", "real memory-root access", "runtime memory mutation", "runtime memory deletion", "runtime memory purge", "live index mutation", "capsule persistence", "tomb completion", "prompt assembly", "live context retrieval", "external disclosure", "action execution", "policy creation", "authority grants", "consent grants", "truth assertions"), forbidden_implications=("adapter readiness is live memory access", "adapter readiness writes live memory", "adapter readiness deletes memory", "adapter readiness purges memory", "adapter readiness mutates indexes", "adapter readiness is a live commit", "adapter readiness is runtime execution permission", "adapter readiness is truth", "adapter readiness is policy", "adapter readiness grants authority", "adapter readiness implies consent", "final review is converted to execution", "sandbox commit is converted to a real commit", "real-root admission is converted to memory-root access")),
        _record("explicit_live_memory_runtime_execution_gate", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/explicit_live_memory_runtime_execution_gate.py", "scripts/build_explicit_live_memory_runtime_execution_gate.py", "docs/architecture/explicit_live_memory_runtime_execution_gate.md"), proof_tests=("tests/test_explicit_live_memory_runtime_execution_gate.py", "tests/test_build_explicit_live_memory_runtime_execution_gate_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_explicit_live_memory_runtime_execution_gate.py tests/test_build_explicit_live_memory_runtime_execution_gate_script.py",), implemented_surfaces=("deterministic disabled-by-default runtime execution gate packets over adapter-readiness envelope evidence and explicit operator runtime candidates",), deferred_surfaces=("future real live-memory commit executor", "future operator runtime confirmation", "future post-execution audit", "real memory-root access", "runtime memory mutation", "runtime memory deletion", "runtime memory purge", "live index mutation", "capsule persistence", "tomb completion", "prompt assembly", "live context retrieval", "external disclosure", "action execution", "policy creation", "authority grants", "consent grants", "truth assertions"), forbidden_implications=("runtime execution gate writes live memory", "runtime execution gate deletes memory", "runtime execution gate purges memory", "runtime execution gate mutates indexes", "runtime execution gate is a live commit", "runtime execution gate is permission to execute now", "readiness envelope is runtime permission", "final review is execution permission", "sandbox commit is converted to a real commit", "real-root admission is converted to memory-root access", "operator review overrides hard blockers")),
        _record("real_live_memory_commit_executor_plan_packet", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/real_live_memory_commit_executor_plan_packet.py", "scripts/build_real_live_memory_commit_executor_plan_packet.py", "docs/architecture/real_live_memory_commit_executor_plan_packet.md"), proof_tests=("tests/test_real_live_memory_commit_executor_plan_packet.py", "tests/test_build_real_live_memory_commit_executor_plan_packet_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_real_live_memory_commit_executor_plan_packet.py tests/test_build_real_live_memory_commit_executor_plan_packet_script.py",), implemented_surfaces=("deterministic metadata-only ordered executor-plan packets for later real live-memory executor review",), deferred_surfaces=("future real live-memory commit executor", "future live executor lock gate", "future post-execution audit", "real memory-root access", "runtime memory mutation", "runtime memory deletion", "runtime memory purge", "live index mutation", "capsule persistence", "tomb completion", "prompt assembly", "live context retrieval", "external disclosure", "action execution", "policy creation", "authority grants", "consent grants", "truth assertions"), forbidden_implications=("executor plan packet writes live memory", "executor plan packet deletes memory", "executor plan packet executes commits", "ordered operation intents are executed operations", "executor plan packet grants runtime permission", "runtime execution gate is execution", "readiness envelope is runtime permission", "final review is execution permission", "sandbox commit is converted to a real commit", "real-root admission is converted to memory-root access", "operator review overrides hard blockers")),
        _record("live_executor_lock_lease_gate", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/live_executor_lock_lease_gate.py", "scripts/build_live_executor_lock_lease_gate.py", "docs/architecture/live_executor_lock_lease_gate.md"), proof_tests=("tests/test_live_executor_lock_lease_gate.py", "tests/test_build_live_executor_lock_lease_gate_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_live_executor_lock_lease_gate.py tests/test_build_live_executor_lock_lease_gate_script.py",), implemented_surfaces=("deterministic metadata-only lock-readiness, lease-readiness, contention, timeout, stale-lease, abort, rollback, and audit readiness records for later executor consideration",), deferred_surfaces=("future real live-memory commit executor", "future live executor preflight", "future post-execution audit", "real lock acquisition", "lockfile creation", "real memory-root access", "runtime memory mutation", "runtime memory deletion", "runtime memory purge", "live index mutation", "capsule persistence", "tomb completion", "prompt assembly", "live context retrieval", "external disclosure", "action execution", "policy creation", "authority grants", "consent grants", "truth assertions"), forbidden_implications=("lock lease gate acquires locks", "lock lease gate creates lockfiles", "lock readiness is live execution permission", "lease readiness is live execution permission", "lock lease gate writes live memory", "lock lease gate deletes memory", "lock lease gate executes commits", "executor plan operation intents are executed operations", "runtime execution gate is execution", "readiness envelope is runtime permission", "final review is execution permission", "sandbox commit is converted to a real commit", "real-root admission is converted to memory-root access", "operator review overrides hard blockers")),
        _record("live_executor_preflight_packet", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/live_executor_preflight_packet.py", "scripts/build_live_executor_preflight_packet.py", "docs/architecture/live_executor_preflight_packet.md"), proof_tests=("tests/test_live_executor_preflight_packet.py", "tests/test_build_live_executor_preflight_packet_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_live_executor_preflight_packet.py tests/test_build_live_executor_preflight_packet_script.py",), implemented_surfaces=("deterministic metadata-only final-preflight-readiness, operation-inventory, safety-checklist, verification-checklist, abort, rollback, and audit readiness records for later executor consideration",), deferred_surfaces=("future real live-memory commit executor", "future executor activation record", "future post-execution audit", "real lock acquisition", "lockfile creation", "real memory-root access", "runtime memory mutation", "runtime memory deletion", "runtime memory purge", "live index mutation", "capsule persistence", "tomb completion", "prompt assembly", "live context retrieval", "external disclosure", "action execution", "policy creation", "authority grants", "consent grants", "truth assertions"), forbidden_implications=("preflight packet performs preflight execution", "preflight packet acquires locks", "preflight packet creates lockfiles", "preflight readiness is live execution permission", "lock readiness is real lock acquisition", "preflight packet writes live memory", "preflight packet deletes memory", "preflight packet executes commits", "operation inventory records are executed operations", "executor plan operation intents are executed operations", "runtime execution gate is execution", "readiness envelope is runtime permission", "final review is execution permission", "sandbox commit is converted to a real commit", "real-root admission is converted to memory-root access", "operator review overrides hard blockers")),
        _record("live_executor_activation_record", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/live_executor_activation_record.py", "scripts/build_live_executor_activation_record.py", "docs/architecture/live_executor_activation_record.md"), proof_tests=("tests/test_live_executor_activation_record.py", "tests/test_build_live_executor_activation_record_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_live_executor_activation_record.py tests/test_build_live_executor_activation_record_script.py",), implemented_surfaces=("deterministic metadata-only activation-readiness, operator-acknowledgement, activation-scope, execution-handoff, abort, rollback, and audit readiness records for later executor consideration",), deferred_surfaces=("future real live-memory commit executor", "future live executor invocation harness", "future post-execution audit", "real executor activation", "real lock acquisition", "lockfile creation", "real memory-root access", "runtime memory mutation", "runtime memory deletion", "runtime memory purge", "live index mutation", "capsule persistence", "tomb completion", "prompt assembly", "live context retrieval", "external disclosure", "action execution", "policy creation", "authority grants", "consent grants", "truth assertions"), forbidden_implications=("activation record activates an executor", "activation record acquires locks", "activation record creates lockfiles", "activation readiness is live execution permission", "operator acknowledgement bypasses later gates", "execution handoff invokes a live executor", "activation record writes live memory", "activation record deletes memory", "activation record executes commits", "preflight readiness is live execution", "lock lease readiness is real lock acquisition", "executor plan operation intents are executed operations", "runtime execution gate is execution", "readiness envelope is runtime permission", "final review is execution permission", "sandbox commit is converted to a real commit", "real-root admission is converted to memory-root access", "operator review overrides hard blockers")),
        _record("live_executor_invocation_harness", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/live_executor_invocation_harness.py", "scripts/build_live_executor_invocation_harness.py", "docs/architecture/live_executor_invocation_harness.md"), proof_tests=("tests/test_live_executor_invocation_harness.py", "tests/test_build_live_executor_invocation_harness_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_live_executor_invocation_harness.py tests/test_build_live_executor_invocation_harness_script.py",), implemented_surfaces=("deterministic metadata-only invocation-readiness, invocation-scope, operator-handoff, dry-run-equivalence, abort, rollback, and audit readiness records for later executor consideration",), deferred_surfaces=("future real live-memory commit executor", "future live executor implementation", "future post-execution audit", "real executor invocation", "real executor activation", "real lock acquisition", "lockfile creation", "real memory-root access", "runtime memory mutation", "runtime memory deletion", "runtime memory purge", "live index mutation", "capsule persistence", "tomb completion", "prompt assembly", "live context retrieval", "external disclosure", "action execution", "policy creation", "authority grants", "consent grants", "truth assertions"), forbidden_implications=("invocation harness invokes an executor", "invocation harness activates an executor", "invocation harness acquires locks", "invocation harness creates lockfiles", "invocation readiness is live execution permission", "operator handoff bypasses later gates", "invocation harness writes live memory", "invocation harness deletes memory", "invocation harness executes commits", "activation readiness is live execution", "preflight readiness is live execution", "lock lease readiness is real lock acquisition", "executor plan operation intents are executed operations", "runtime execution gate is execution", "readiness envelope is runtime permission", "final review is execution permission", "sandbox commit is converted to a real commit", "real-root admission is converted to memory-root access", "operator review overrides hard blockers")),
        _record("real_live_memory_commit_executor_enablement_gate", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/real_live_memory_commit_executor_enablement_gate.py", "scripts/build_real_live_memory_commit_executor_enablement_gate.py", "docs/architecture/real_live_memory_commit_executor_enablement_gate.md"), proof_tests=("tests/test_real_live_memory_commit_executor_enablement_gate.py", "tests/test_build_real_live_memory_commit_executor_enablement_gate_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_real_live_memory_commit_executor_enablement_gate.py tests/test_build_real_live_memory_commit_executor_enablement_gate_script.py",), implemented_surfaces=("deterministic metadata-only enablement gate packets for later constrained executor enablement-path consideration",), deferred_surfaces=("future constrained executor enablement path", "future real live-memory commit execution", "future post-execution audit", "real executor enablement", "real executor invocation", "real executor activation", "real lock acquisition", "lockfile creation", "real memory-root access", "runtime memory mutation", "runtime memory deletion", "runtime memory purge", "live index mutation", "capsule persistence", "tomb completion", "prompt assembly", "live context retrieval", "external disclosure", "action execution", "policy creation", "authority grants", "consent grants", "truth assertions"), forbidden_implications=("enablement gate enables an executor", "enablement readiness is live execution permission", "disabled posture confirmation flips runtime flags", "operator acknowledgement overrides hard blockers", "executor skeleton records are executed operations", "receipt envelopes are live receipts", "rollback envelopes are applied rollback", "lock readiness is real lock acquisition", "executor plan intents are executed operations", "sandbox commits are real commits")),
        _record("constrained_executor_enablement_path_packet", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/constrained_executor_enablement_path_packet.py", "scripts/build_constrained_executor_enablement_path_packet.py", "docs/architecture/constrained_executor_enablement_path_packet.md"), proof_tests=("tests/test_constrained_executor_enablement_path_packet.py", "tests/test_build_constrained_executor_enablement_path_packet_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_constrained_executor_enablement_path_packet.py tests/test_build_constrained_executor_enablement_path_packet_script.py",), implemented_surfaces=("deterministic metadata-only constrained executor enablement path packets for later live-execution-gate review",), deferred_surfaces=("future live execution gate", "future real live-memory commit execution", "future post-execution audit", "real executor enablement", "real executor invocation", "real executor activation", "real lock acquisition", "lockfile creation", "real memory-root access", "runtime memory mutation", "runtime memory deletion", "runtime memory purge", "live index mutation", "capsule persistence", "tomb completion", "prompt assembly", "live context retrieval", "external disclosure", "action execution", "policy creation", "authority grants", "consent grants", "truth assertions"), forbidden_implications=("path packet enables an executor", "enablement-path readiness is live execution permission", "staged requirements flip runtime flags", "operator acknowledgement overrides hard blockers", "executor skeleton records are executed operations", "receipt envelopes are live receipts", "rollback envelopes are applied rollback", "lock readiness is real lock acquisition", "executor plan intents are executed operations", "sandbox commits are real commits")),
        _record("future_live_memory_commit_execution_gate", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/future_live_memory_commit_execution_gate.py", "scripts/build_future_live_memory_commit_execution_gate.py", "docs/architecture/future_live_memory_commit_execution_gate.md"), proof_tests=("tests/test_future_live_memory_commit_execution_gate.py", "tests/test_build_future_live_memory_commit_execution_gate_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_future_live_memory_commit_execution_gate.py tests/test_build_future_live_memory_commit_execution_gate_script.py",), implemented_surfaces=("deterministic metadata-only future live-memory commit execution gate packets for later live commit execution packet consideration",), deferred_surfaces=("future live commit execution packet", "future real live-memory commit execution", "future post-execution audit", "real executor enablement", "real executor invocation", "real executor activation", "real lock acquisition", "lockfile creation", "real memory-root access", "runtime memory mutation", "runtime memory deletion", "runtime memory purge", "live index mutation", "capsule persistence", "tomb completion", "prompt assembly", "live context retrieval", "external disclosure", "action execution", "policy creation", "authority grants", "consent grants", "truth assertions"), forbidden_implications=("future execution gate executes a live commit", "future execution gate enables an executor", "future execution gate invokes an executor", "future execution gate activates an executor", "operator execution acknowledgement is runtime permission", "execution readiness is execution permission", "lock readiness is real lock acquisition", "receipt envelopes are live receipts", "rollback envelopes are applied rollback", "sandbox commits are real commits")),
        _record("live_commit_execution_packet", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/live_commit_execution_packet.py", "scripts/build_live_commit_execution_packet.py", "docs/architecture/live_commit_execution_packet.md"), proof_tests=("tests/test_live_commit_execution_packet.py", "tests/test_build_live_commit_execution_packet_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_live_commit_execution_packet.py tests/test_build_live_commit_execution_packet_script.py",), implemented_surfaces=("deterministic metadata-only live commit execution packets for later real executor review",), deferred_surfaces=("future real live-memory commit execution", "future post-execution audit", "future executor runtime enablement", "real executor enablement", "real executor invocation", "real executor activation", "real lock acquisition", "lockfile creation", "real memory-root access", "runtime memory mutation", "runtime memory deletion", "runtime memory purge", "live index mutation", "capsule persistence", "tomb completion", "prompt assembly", "live context retrieval", "external disclosure", "action execution", "policy creation", "authority grants", "consent grants", "truth assertions"), forbidden_implications=("live commit execution packet executes a live commit", "live commit execution packet enables an executor", "live commit execution packet invokes an executor", "live commit execution packet activates an executor", "packet readiness is runtime permission", "operation bundles are executed operations", "receipt readiness is a live receipt", "rollback readiness is applied rollback", "future execution gate readiness is permission to execute", "sandbox commits are real commits")),
        _record("real_executor_runtime_enablement_packet", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/real_executor_runtime_enablement_packet.py", "scripts/build_real_executor_runtime_enablement_packet.py", "docs/architecture/real_executor_runtime_enablement_packet.md"), proof_tests=("tests/test_real_executor_runtime_enablement_packet.py", "tests/test_build_real_executor_runtime_enablement_packet_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_real_executor_runtime_enablement_packet.py tests/test_build_real_executor_runtime_enablement_packet_script.py",), implemented_surfaces=("deterministic metadata-only runtime enablement packets for later real executor runtime-gate review",), deferred_surfaces=("future real executor runtime gate", "future real live-memory commit execution", "future post-execution audit", "real executor runtime enablement", "runtime flag flipping", "real executor enablement", "real executor invocation", "real executor activation", "real lock acquisition", "lockfile creation", "real memory-root access", "runtime memory mutation", "runtime memory deletion", "runtime memory purge", "live index mutation", "capsule persistence", "tomb completion", "prompt assembly", "live context retrieval", "external disclosure", "action execution", "policy creation", "authority grants", "consent grants", "truth assertions"), forbidden_implications=("runtime enablement packet enables an executor", "runtime enablement packet flips runtime flags", "runtime enablement packet executes a live commit", "runtime enablement packet invokes an executor", "runtime enablement packet activates an executor", "runtime-enable readiness is runtime permission", "runtime flag target-state metadata is active runtime state", "operator runtime acknowledgement grants permission", "operation bundles are executed operations", "receipt readiness is a live receipt", "rollback readiness is applied rollback", "lock readiness is real lock acquisition", "sandbox commits are real commits")),

        _record("real_executor_runtime_gate", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/real_executor_runtime_gate.py", "scripts/build_real_executor_runtime_gate.py", "docs/architecture/real_executor_runtime_gate.md"), proof_tests=("tests/test_real_executor_runtime_gate.py", "tests/test_build_real_executor_runtime_gate_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_real_executor_runtime_gate.py tests/test_build_real_executor_runtime_gate_script.py",), implemented_surfaces=("deterministic metadata-only runtime gate packets for later guarded real executor path review",), deferred_surfaces=("future guarded executor path", "future real live-memory commit execution", "future post-execution audit", "real executor runtime enablement", "runtime flag flipping", "real executor enablement", "real executor invocation", "real executor activation", "real lock acquisition", "lockfile creation", "real memory-root access", "runtime memory mutation", "runtime memory deletion", "runtime memory purge", "live index mutation", "capsule persistence", "tomb completion", "prompt assembly", "live context retrieval", "external disclosure", "action execution", "policy creation", "authority grants", "consent grants", "truth assertions"), forbidden_implications=("runtime gate enables an executor", "runtime gate flips runtime flags", "runtime gate executes a live commit", "runtime gate invokes an executor", "runtime gate activates an executor", "runtime-gate readiness is runtime permission", "runtime flag confirmation is active runtime state", "guarded executor path prerequisites are executor invocation", "operation bundles are executed operations", "receipt readiness is a live receipt", "rollback readiness is applied rollback", "lock readiness is real lock acquisition", "sandbox commits are real commits")),
        _record("guarded_executor_path_packet", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/guarded_executor_path_packet.py", "scripts/build_guarded_executor_path_packet.py", "docs/architecture/guarded_executor_path_packet.md"), proof_tests=("tests/test_guarded_executor_path_packet.py", "tests/test_build_guarded_executor_path_packet_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_guarded_executor_path_packet.py tests/test_build_guarded_executor_path_packet_script.py",), implemented_surfaces=("deterministic metadata-only guarded executor path packets for later guarded invocation packet review",), deferred_surfaces=("future guarded invocation packet", "future real live-memory commit execution", "future post-execution audit", "real executor runtime enablement", "runtime flag flipping", "real executor enablement", "real executor invocation", "real executor activation", "real lock acquisition", "lockfile creation", "real memory-root access", "runtime memory mutation", "runtime memory deletion", "runtime memory purge", "live index mutation", "capsule persistence", "tomb completion", "prompt assembly", "live context retrieval", "external disclosure", "action execution", "policy creation", "authority grants", "consent grants", "truth assertions"), forbidden_implications=("guarded executor path packet enables an executor", "guarded executor path packet flips runtime flags", "guarded executor path packet executes a live commit", "guarded executor path packet invokes an executor", "guarded executor path packet activates an executor", "guarded-path readiness is permission to invoke", "guarded executor prerequisites are executor invocation", "invocation hold points are live invocation", "operation bundles are executed operations", "receipt readiness is a live receipt", "rollback readiness is applied rollback", "lock readiness is real lock acquisition", "sandbox commits are real commits")),
        _record("guarded_executor_invocation_packet", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/guarded_executor_invocation_packet.py", "scripts/build_guarded_executor_invocation_packet.py", "docs/architecture/guarded_executor_invocation_packet.md"), proof_tests=("tests/test_guarded_executor_invocation_packet.py", "tests/test_build_guarded_executor_invocation_packet_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_guarded_executor_invocation_packet.py tests/test_build_guarded_executor_invocation_packet_script.py",), implemented_surfaces=("deterministic metadata-only guarded executor invocation packets over guarded path and runtime evidence",), deferred_surfaces=("future real executor invocation gate", "real live-memory commit execution", "post-execution audit", "executor activation", "real lock acquisition", "memory-root access"), forbidden_implications=("invocation packet invokes executor", "invocation packet enables executor", "invocation packet flips runtime flags", "invocation packet executes live commit", "invocation packet acquires locks", "invocation packet writes memory")),
        _record("real_executor_invocation_gate", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/real_executor_invocation_gate.py", "scripts/build_real_executor_invocation_gate.py", "docs/architecture/real_executor_invocation_gate.md"), proof_tests=("tests/test_real_executor_invocation_gate.py", "tests/test_build_real_executor_invocation_gate_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_real_executor_invocation_gate.py tests/test_build_real_executor_invocation_gate_script.py",), implemented_surfaces=("deterministic metadata-only real executor invocation gate packets over guarded invocation evidence",), deferred_surfaces=("future real executor run packet", "future real live-memory commit execution", "future post-execution audit", "executor invocation", "executor activation", "real lock acquisition", "memory-root access"), forbidden_implications=("invocation gate invokes executor", "invocation gate enables executor", "invocation gate flips runtime flags", "invocation gate executes live commit", "invocation gate acquires locks", "invocation gate writes memory", "invocation gate grants authority")),
        _record("real_executor_run_packet", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/real_executor_run_packet.py", "scripts/build_real_executor_run_packet.py", "docs/architecture/real_executor_run_packet.md"), proof_tests=("tests/test_real_executor_run_packet.py", "tests/test_build_real_executor_run_packet_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_real_executor_run_packet.py tests/test_build_real_executor_run_packet_script.py",), implemented_surfaces=("deterministic metadata-only real executor run packets over invocation gate evidence",), deferred_surfaces=("future real executor run gate", "future real live-memory commit execution", "future post-execution audit", "executor run", "executor invocation", "executor activation", "real lock acquisition", "memory-root access"), forbidden_implications=("run packet executes executor", "run packet invokes executor", "run packet enables executor", "run packet flips runtime flags", "run packet executes live commit", "run packet acquires locks", "run packet writes memory", "run packet grants authority")),
        _record("real_executor_run_gate", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/real_executor_run_gate.py", "scripts/build_real_executor_run_gate.py", "docs/architecture/real_executor_run_gate.md"), proof_tests=("tests/test_real_executor_run_gate.py", "tests/test_build_real_executor_run_gate_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_real_executor_run_gate.py tests/test_build_real_executor_run_gate_script.py",), implemented_surfaces=("deterministic metadata-only real executor run gates over run packet evidence",), deferred_surfaces=("future real executor execution plan", "future real live-memory commit execution", "future post-execution audit", "executor execution", "executor run", "executor invocation", "executor activation", "real lock acquisition", "memory-root access"), forbidden_implications=("run gate executes executor", "run gate invokes executor", "run gate enables executor", "run gate flips runtime flags", "run gate executes live commit", "run gate acquires locks", "run gate writes memory", "run gate grants authority")),
        _record("real_executor_execution_plan", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/real_executor_execution_plan.py", "scripts/build_real_executor_execution_plan.py", "docs/architecture/real_executor_execution_plan.md"), proof_tests=("tests/test_real_executor_execution_plan.py", "tests/test_build_real_executor_execution_plan_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_real_executor_execution_plan.py tests/test_build_real_executor_execution_plan_script.py",), implemented_surfaces=("deterministic metadata-only real executor execution plans over run gate evidence",), deferred_surfaces=("future real executor execution gate", "future real live-memory commit execution", "future post-execution audit", "executor execution", "executor run", "executor invocation", "executor activation", "real lock acquisition", "memory-root access"), forbidden_implications=("execution plan executes executor", "execution plan invokes executor", "execution plan enables executor", "execution plan flips runtime flags", "execution plan executes live commit", "execution plan acquires locks", "execution plan writes memory", "execution plan grants authority")),
        _record("real_executor_execution_gate", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/real_executor_execution_gate.py", "scripts/build_real_executor_execution_gate.py", "docs/architecture/real_executor_execution_gate.md"), proof_tests=("tests/test_real_executor_execution_gate.py", "tests/test_build_real_executor_execution_gate_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_real_executor_execution_gate.py tests/test_build_real_executor_execution_gate_script.py",), implemented_surfaces=("deterministic metadata-only real executor execution gates over execution plan evidence",), deferred_surfaces=("future real executor execution authorization packet", "future real live-memory commit execution", "future post-execution audit", "executor execution", "executor run", "executor invocation", "executor activation", "real lock acquisition", "memory-root access"), forbidden_implications=("execution gate executes executor", "execution gate invokes executor", "execution gate enables executor", "execution gate flips runtime flags", "execution gate executes live commit", "execution gate acquires locks", "execution gate writes memory", "execution gate grants authority")),
        _record("real_executor_execution_authorization_packet", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/real_executor_execution_authorization_packet.py", "scripts/build_real_executor_execution_authorization_packet.py", "docs/architecture/real_executor_execution_authorization_packet.md"), proof_tests=("tests/test_real_executor_execution_authorization_packet.py", "tests/test_build_real_executor_execution_authorization_packet_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_real_executor_execution_authorization_packet.py tests/test_build_real_executor_execution_authorization_packet_script.py",), implemented_surfaces=("deterministic metadata-only real executor execution authorization packets over execution gate evidence",), deferred_surfaces=("future real executor execution authorization gate", "future real live-memory commit execution", "future post-execution audit", "executor execution", "executor run", "executor invocation", "executor activation", "real lock acquisition", "memory-root access"), forbidden_implications=("authorization packet authorizes execution", "authorization packet grants permission to execute", "authorization packet executes executor", "authorization packet invokes executor", "authorization packet enables executor", "authorization packet flips runtime flags", "authorization packet executes live commit", "authorization packet acquires locks", "authorization packet writes memory", "authorization packet grants authority")),
        _record("real_executor_execution_release_gate", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/real_executor_execution_release_gate.py", "scripts/build_real_executor_execution_release_gate.py", "docs/architecture/real_executor_execution_release_gate.md"), proof_tests=("tests/test_real_executor_execution_release_gate.py", "tests/test_build_real_executor_execution_release_gate_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_real_executor_execution_release_gate.py tests/test_build_real_executor_execution_release_gate_script.py",), implemented_surfaces=("deterministic metadata-only real executor execution release gates over release packet evidence",), deferred_surfaces=("future real executor execution activation packet", "future real live-memory commit execution", "future post-execution audit", "executor execution", "executor run", "executor invocation", "executor activation", "real lock acquisition", "memory-root access"), forbidden_implications=("release gate releases execution", "release gate issues an execution permit", "release gate authorizes execution", "release gate grants permission to execute", "release gate executes executor", "release gate invokes executor", "release gate enables executor", "release gate flips runtime flags", "release gate executes live commit", "release gate acquires locks", "release gate writes memory", "release gate grants authority")),
        _record("real_executor_execution_activation_packet", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/real_executor_execution_activation_packet.py", "scripts/build_real_executor_execution_activation_packet.py", "docs/architecture/real_executor_execution_activation_packet.md"), proof_tests=("tests/test_real_executor_execution_activation_packet.py", "tests/test_build_real_executor_execution_activation_packet_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_real_executor_execution_activation_packet.py tests/test_build_real_executor_execution_activation_packet_script.py",), implemented_surfaces=("deterministic metadata-only real executor execution activation packets over release gate evidence",), deferred_surfaces=("future real executor execution activation gate", "future real live-memory commit execution", "future post-execution audit", "executor activation", "execution release", "execution permit", "execution authorization", "executor execution", "executor run", "executor invocation", "real lock acquisition", "memory-root access"), forbidden_implications=("activation packet activates executor", "activation packet releases execution", "activation packet issues an execution permit", "activation packet authorizes execution", "activation packet grants permission to execute", "activation packet executes executor", "activation packet invokes executor", "activation packet enables executor", "activation packet flips runtime flags", "activation packet executes live commit", "activation packet acquires locks", "activation packet writes memory", "activation packet grants authority")),
        _record("real_executor_execution_invocation_gate", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/real_executor_execution_invocation_gate.py", "scripts/build_real_executor_execution_invocation_gate.py", "docs/architecture/real_executor_execution_invocation_gate.md"), proof_tests=("tests/test_real_executor_execution_invocation_gate.py", "tests/test_build_real_executor_execution_invocation_gate_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_real_executor_execution_invocation_gate.py tests/test_build_real_executor_execution_invocation_gate_script.py",), implemented_surfaces=("deterministic metadata-only real executor execution invocation gates over invocation packet evidence",), deferred_surfaces=("future real executor execution preflight packet", "future real live-memory commit execution", "future post-execution audit", "executor invocation", "executor activation", "execution release", "execution permit", "execution authorization", "executor execution", "executor run", "real lock acquisition", "memory-root access"), forbidden_implications=("invocation gate invokes executor", "invocation gate activates executor", "invocation gate releases execution", "invocation gate issues an execution permit", "invocation gate authorizes execution", "invocation gate grants permission to execute", "invocation gate executes executor", "invocation gate enables executor", "invocation gate flips runtime flags", "invocation gate executes live commit", "invocation gate acquires locks", "invocation gate writes memory", "invocation gate grants authority")),
        _record("real_executor_execution_preflight_packet", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/real_executor_execution_preflight_packet.py", "scripts/build_real_executor_execution_preflight_packet.py", "docs/architecture/real_executor_execution_preflight_packet.md"), proof_tests=("tests/test_real_executor_execution_preflight_packet.py", "tests/test_build_real_executor_execution_preflight_packet_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_real_executor_execution_preflight_packet.py tests/test_build_real_executor_execution_preflight_packet_script.py",), implemented_surfaces=("deterministic metadata-only real executor execution preflight packets over invocation gate evidence",), deferred_surfaces=("future real executor execution preflight gate", "future real live-memory commit execution", "future post-execution audit", "executor preflight execution", "executor invocation", "executor activation", "execution release", "execution permit", "execution authorization", "executor execution", "executor run", "real lock acquisition", "memory-root access"), forbidden_implications=("preflight packet executes preflight", "preflight packet invokes executor", "preflight packet activates executor", "preflight packet releases execution", "preflight packet issues an execution permit", "preflight packet authorizes execution", "preflight packet grants permission to execute", "preflight packet executes executor", "preflight packet enables executor", "preflight packet flips runtime flags", "preflight packet executes live commit", "preflight packet acquires locks", "preflight packet writes memory", "preflight packet grants authority")),
        _record("real_executor_execution_preflight_gate", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/real_executor_execution_preflight_gate.py", "scripts/build_real_executor_execution_preflight_gate.py", "docs/architecture/real_executor_execution_preflight_gate.md"), proof_tests=("tests/test_real_executor_execution_preflight_gate.py", "tests/test_build_real_executor_execution_preflight_gate_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_real_executor_execution_preflight_gate.py tests/test_build_real_executor_execution_preflight_gate_script.py",), implemented_surfaces=("deterministic metadata-only real executor execution preflight gates over preflight packet evidence",), deferred_surfaces=("future real executor execution lock lease packet", "future real live-memory commit execution", "future post-execution audit", "executor preflight execution", "executor invocation", "executor activation", "execution release", "execution permit", "execution authorization", "executor execution", "executor run", "real lock acquisition", "lockfile creation", "memory-root access"), forbidden_implications=("preflight gate executes preflight", "preflight gate invokes executor", "preflight gate activates executor", "preflight gate releases execution", "preflight gate issues an execution permit", "preflight gate authorizes execution", "preflight gate grants permission to execute", "preflight gate executes executor", "preflight gate enables executor", "preflight gate flips runtime flags", "preflight gate executes live commit", "preflight gate acquires locks", "preflight gate creates lockfiles", "preflight gate writes memory", "preflight gate grants authority")),
        _record("real_executor_execution_lock_lease_gate", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/real_executor_execution_lock_lease_gate.py", "scripts/build_real_executor_execution_lock_lease_gate.py", "docs/architecture/real_executor_execution_lock_lease_gate.md"), proof_tests=("tests/test_real_executor_execution_lock_lease_gate.py", "tests/test_build_real_executor_execution_lock_lease_gate_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_real_executor_execution_lock_lease_gate.py tests/test_build_real_executor_execution_lock_lease_gate_script.py",), implemented_surfaces=("deterministic metadata-only real executor execution lock lease gates over lock lease packet evidence",), deferred_surfaces=("future real executor execution commit plan packet", "future real live-memory commit execution", "future post-execution audit", "real lock acquisition", "real lock lease creation", "lockfile creation", "executor preflight execution", "executor invocation", "executor activation", "execution release", "execution permit", "execution authorization", "executor execution", "executor run", "memory-root access"), forbidden_implications=("lock lease gate acquires locks", "lock lease gate creates real lock leases", "lock lease gate creates lockfiles", "lock lease gate executes preflight", "lock lease gate invokes executor", "lock lease gate activates executor", "lock lease gate releases execution", "lock lease gate issues an execution permit", "lock lease gate authorizes execution", "lock lease gate grants permission to execute", "lock lease gate executes executor", "lock lease gate enables executor", "lock lease gate flips runtime flags", "lock lease gate executes live commit", "lock lease gate writes memory", "lock lease gate grants authority")),
        _record("real_executor_execution_lock_lease_packet", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/real_executor_execution_lock_lease_packet.py", "scripts/build_real_executor_execution_lock_lease_packet.py", "docs/architecture/real_executor_execution_lock_lease_packet.md"), proof_tests=("tests/test_real_executor_execution_lock_lease_packet.py", "tests/test_build_real_executor_execution_lock_lease_packet_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_real_executor_execution_lock_lease_packet.py tests/test_build_real_executor_execution_lock_lease_packet_script.py",), implemented_surfaces=("deterministic metadata-only real executor execution lock lease packets over preflight gate evidence",), deferred_surfaces=("future real executor execution lock lease gate", "future real live-memory commit execution", "future post-execution audit", "real lock acquisition", "real lock lease creation", "lockfile creation", "executor preflight execution", "executor invocation", "executor activation", "execution release", "execution permit", "execution authorization", "executor execution", "executor run", "memory-root access"), forbidden_implications=("lock lease packet acquires locks", "lock lease packet creates real lock leases", "lock lease packet creates lockfiles", "lock lease packet executes preflight", "lock lease packet invokes executor", "lock lease packet activates executor", "lock lease packet releases execution", "lock lease packet issues an execution permit", "lock lease packet authorizes execution", "lock lease packet grants permission to execute", "lock lease packet executes executor", "lock lease packet enables executor", "lock lease packet flips runtime flags", "lock lease packet executes live commit", "lock lease packet writes memory", "lock lease packet grants authority")),
        _record("real_executor_execution_commit_plan_packet", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/real_executor_execution_commit_plan_packet.py", "scripts/build_real_executor_execution_commit_plan_packet.py", "docs/architecture/real_executor_execution_commit_plan_packet.md"), proof_tests=("tests/test_real_executor_execution_commit_plan_packet.py", "tests/test_build_real_executor_execution_commit_plan_packet_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_real_executor_execution_commit_plan_packet.py tests/test_build_real_executor_execution_commit_plan_packet_script.py",), implemented_surfaces=("deterministic metadata-only real executor execution commit plan packets over lock lease gate evidence",), deferred_surfaces=("future real executor execution commit plan gate", "future real executor execution commit window packet", "future real live-memory commit execution", "future post-execution audit", "live commit execution", "commit application", "executor preflight execution", "executor invocation", "executor activation", "execution release", "execution permit", "execution authorization", "executor execution", "executor run", "real lock acquisition", "lockfile creation", "memory-root writes"), forbidden_implications=("commit plan packet executes a commit", "commit plan packet applies a commit", "commit plan packet writes live memory", "commit plan packet acquires locks", "commit plan packet creates lockfiles", "commit plan packet creates real lock leases", "commit plan packet invokes executor", "commit plan packet activates executor", "commit plan packet releases execution", "commit plan packet issues a permit", "commit plan packet authorizes execution", "commit plan packet grants permission to execute", "commit plan packet enables executor", "commit plan packet flips runtime flags", "commit plan packet grants authority")),
        _record("real_executor_execution_commit_plan_gate", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/real_executor_execution_commit_plan_gate.py", "scripts/build_real_executor_execution_commit_plan_gate.py", "docs/architecture/real_executor_execution_commit_plan_gate.md"), proof_tests=("tests/test_real_executor_execution_commit_plan_gate.py", "tests/test_build_real_executor_execution_commit_plan_gate_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_real_executor_execution_commit_plan_gate.py tests/test_build_real_executor_execution_commit_plan_gate_script.py",), implemented_surfaces=("deterministic metadata-only real executor execution commit plan gate over commit plan packet evidence",), deferred_surfaces=("future real executor execution commit window packet", "future real live-memory commit execution", "future post-execution audit", "live commit execution", "commit application", "commit-window authority", "executor preflight execution", "executor invocation", "executor activation", "execution release", "execution permit", "execution authorization", "executor execution", "executor run", "real lock acquisition", "lockfile creation", "memory-root writes"), forbidden_implications=("commit plan gate executes a commit", "commit plan gate applies a commit", "commit plan gate writes live memory", "commit plan gate acquires locks", "commit plan gate creates lockfiles", "commit plan gate creates real lock leases", "commit plan gate invokes executor", "commit plan gate activates executor", "commit plan gate releases execution", "commit plan gate issues a permit", "commit plan gate authorizes execution", "commit plan gate grants permission to execute", "commit plan gate creates a commit window", "commit plan gate enables executor", "commit plan gate flips runtime flags", "commit plan gate grants authority")),
        _record("real_executor_execution_commit_window_packet", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/real_executor_execution_commit_window_packet.py", "scripts/build_real_executor_execution_commit_window_packet.py", "docs/architecture/real_executor_execution_commit_window_packet.md"), proof_tests=("tests/test_real_executor_execution_commit_window_packet.py", "tests/test_build_real_executor_execution_commit_window_packet_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_real_executor_execution_commit_window_packet.py tests/test_build_real_executor_execution_commit_window_packet_script.py",), implemented_surfaces=("deterministic metadata-only real executor execution commit window packet over commit plan gate evidence",), deferred_surfaces=("future real live-memory commit execution gate", "future real live-memory commit execution", "future post-execution audit", "live commit execution", "commit application", "commit-window authority", "executor preflight execution", "executor invocation", "executor activation", "execution release", "execution permit", "execution authorization", "executor execution", "executor run", "real lock acquisition", "lockfile creation", "memory-root writes"), forbidden_implications=("commit window packet executes a commit", "commit window packet applies a commit", "commit window packet writes live memory", "commit window packet opens a live commit window", "commit window packet executes a commit window", "commit window packet grants commit-window authority", "commit window packet acquires locks", "commit window packet creates lockfiles", "commit window packet creates real lock leases", "commit window packet invokes executor", "commit window packet activates executor", "commit window packet releases execution", "commit window packet issues a permit", "commit window packet authorizes execution", "commit window packet grants permission to execute", "commit window packet enables executor", "commit window packet flips runtime flags", "commit window packet grants authority")),
        _record("real_live_memory_commit_execution_gate", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/real_live_memory_commit_execution_gate.py", "scripts/build_real_live_memory_commit_execution_gate.py", "sentientos/real_live_memory_commit_execution_packet.py", "scripts/build_real_live_memory_commit_execution_packet.py", "docs/architecture/real_live_memory_commit_execution_gate.md"), proof_tests=("tests/test_real_live_memory_commit_execution_gate.py", "tests/test_build_real_live_memory_commit_execution_gate_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_real_live_memory_commit_execution_gate.py tests/test_build_real_live_memory_commit_execution_gate_script.py",), implemented_surfaces=("deterministic metadata-only real live memory commit execution gate over commit window packet evidence",), deferred_surfaces=("future live execution packet or adapter admission", "future real live-memory commit execution", "future post-execution audit", "live commit execution", "commit application", "commit-window authority", "executor preflight execution", "executor invocation", "executor activation", "execution release", "execution permit", "execution authorization", "executor execution", "executor run", "real lock acquisition", "lockfile creation", "live execution packet creation", "live execution adapter creation", "memory-root writes"), forbidden_implications=("live memory commit execution gate executes a commit", "live memory commit execution gate applies a commit", "live memory commit execution gate writes live memory", "live memory commit execution gate opens a live commit window", "live memory commit execution gate grants commit-window authority", "live memory commit execution gate creates a live execution packet", "live memory commit execution gate creates a live execution adapter", "live memory commit execution gate acquires locks", "live memory commit execution gate creates lockfiles", "live memory commit execution gate creates real lock leases", "live memory commit execution gate invokes executor", "live memory commit execution gate activates executor", "live memory commit execution gate releases execution", "live memory commit execution gate issues a permit", "live memory commit execution gate authorizes execution", "live memory commit execution gate grants permission to execute", "live memory commit execution gate enables executor", "live memory commit execution gate flips runtime flags", "live memory commit execution gate grants authority")),
        _record("real_live_memory_commit_execution_packet", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/real_live_memory_commit_execution_packet.py", "scripts/build_real_live_memory_commit_execution_packet.py", "docs/architecture/real_live_memory_commit_execution_packet.md"), proof_tests=("tests/test_real_live_memory_commit_execution_packet.py", "tests/test_build_real_live_memory_commit_execution_packet_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_real_live_memory_commit_execution_packet.py tests/test_build_real_live_memory_commit_execution_packet_script.py",), implemented_surfaces=("deterministic metadata-only real live memory commit execution packet over execution gate evidence",), deferred_surfaces=("future real live memory commit adapter admission gate", "future real live-memory commit execution", "future post-execution audit", "live commit execution", "commit application", "commit-window authority", "executor preflight execution", "executor invocation", "executor activation", "execution release", "execution permit", "execution authorization", "executor execution", "executor run", "real lock acquisition", "lockfile creation", "live execution adapter creation", "adapter admission gate creation", "memory-root writes"), forbidden_implications=("live memory commit execution packet executes a commit", "live memory commit execution packet applies a commit", "live memory commit execution packet writes live memory", "live memory commit execution packet opens a live commit window", "live memory commit execution packet grants commit-window authority", "live memory commit execution packet creates a live execution adapter", "live memory commit execution packet creates an adapter admission gate", "live memory commit execution packet acquires locks", "live memory commit execution packet creates lockfiles", "live memory commit execution packet creates real lock leases", "live memory commit execution packet invokes executor", "live memory commit execution packet activates executor", "live memory commit execution packet releases execution", "live memory commit execution packet issues a permit", "live memory commit execution packet authorizes execution", "live memory commit execution packet grants permission to execute", "live memory commit execution packet enables executor", "live memory commit execution packet flips runtime flags", "live memory commit execution packet grants authority")),

        _record("real_live_memory_commit_adapter_admission_gate", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/real_live_memory_commit_adapter_admission_gate.py", "scripts/build_real_live_memory_commit_adapter_admission_gate.py", "docs/architecture/real_live_memory_commit_adapter_admission_gate.md"), proof_tests=("tests/test_real_live_memory_commit_adapter_admission_gate.py", "tests/test_build_real_live_memory_commit_adapter_admission_gate_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_real_live_memory_commit_adapter_admission_gate.py tests/test_build_real_live_memory_commit_adapter_admission_gate_script.py",), implemented_surfaces=("deterministic metadata-only real live memory commit adapter admission gate over execution packet evidence",), deferred_surfaces=("future real live memory commit adapter admission packet", "future real live-memory commit execution", "future post-execution audit", "live commit execution", "commit application", "commit-window authority", "executor preflight execution", "executor invocation", "executor activation", "execution release", "execution permit", "execution authorization", "executor execution", "executor run", "real lock acquisition", "lockfile creation", "live execution adapter creation", "live adapter creation", "adapter admission packet creation", "live adapter admission", "memory-root writes"), forbidden_implications=("adapter admission gate executes a commit", "adapter admission gate applies a commit", "adapter admission gate writes live memory", "adapter admission gate opens a live commit window", "adapter admission gate grants commit-window authority", "adapter admission gate creates a live execution adapter", "adapter admission gate creates a live adapter", "adapter admission gate admits a live adapter", "adapter admission gate creates an adapter admission packet", "adapter admission gate acquires locks", "adapter admission gate creates lockfiles", "adapter admission gate creates real lock leases", "adapter admission gate invokes executor", "adapter admission gate activates executor", "adapter admission gate releases execution", "adapter admission gate issues a permit", "adapter admission gate authorizes execution", "adapter admission gate grants permission to execute", "adapter admission gate enables executor", "adapter admission gate flips runtime flags", "adapter admission gate grants authority")),
        _record("real_live_memory_commit_adapter_admission_packet", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/real_live_memory_commit_adapter_admission_packet.py", "scripts/build_real_live_memory_commit_adapter_admission_packet.py", "docs/architecture/real_live_memory_commit_adapter_admission_packet.md"), proof_tests=("tests/test_real_live_memory_commit_adapter_admission_packet.py", "tests/test_build_real_live_memory_commit_adapter_admission_packet_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_real_live_memory_commit_adapter_admission_packet.py tests/test_build_real_live_memory_commit_adapter_admission_packet_script.py",), implemented_surfaces=("deterministic metadata-only real live memory commit adapter admission packet over adapter admission gate evidence",), deferred_surfaces=("future real live memory commit adapter readiness gate", "future real live memory commit adapter readiness envelope", "future real live-memory commit execution", "future post-execution audit", "live commit execution", "commit application", "commit-window authority", "executor preflight execution", "executor invocation", "executor activation", "execution release", "execution permit", "execution authorization", "executor execution", "executor run", "real lock acquisition", "lockfile creation", "live execution adapter creation", "live adapter creation", "live adapter admission", "memory-root writes"), forbidden_implications=("adapter admission packet executes a commit", "adapter admission packet applies a commit", "adapter admission packet writes live memory", "adapter admission packet opens a live commit window", "adapter admission packet grants commit-window authority", "adapter admission packet creates a live execution adapter", "adapter admission packet creates a live adapter", "adapter admission packet admits a live adapter", "adapter admission packet creates an adapter readiness gate", "adapter admission packet creates an adapter readiness envelope", "adapter admission packet acquires locks", "adapter admission packet creates lockfiles", "adapter admission packet creates real lock leases", "adapter admission packet invokes executor", "adapter admission packet activates executor", "adapter admission packet releases execution", "adapter admission packet issues a permit", "adapter admission packet authorizes execution", "adapter admission packet grants permission to execute", "adapter admission packet enables executor", "adapter admission packet flips runtime flags", "adapter admission packet grants authority")),
        _record("real_live_memory_commit_adapter_readiness_gate", "memory_distillation", "implemented", "metadata_verification_only", source_paths=("sentientos/real_live_memory_commit_adapter_readiness_gate.py", "scripts/build_real_live_memory_commit_adapter_readiness_gate.py", "docs/architecture/real_live_memory_commit_adapter_readiness_gate.md"), proof_tests=("tests/test_real_live_memory_commit_adapter_readiness_gate.py", "tests/test_build_real_live_memory_commit_adapter_readiness_gate_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_real_live_memory_commit_adapter_readiness_gate.py tests/test_build_real_live_memory_commit_adapter_readiness_gate_script.py",), implemented_surfaces=("deterministic metadata-only real live memory commit adapter readiness gate over adapter admission packet evidence",), deferred_surfaces=("future real live memory commit adapter readiness envelope", "future real live-memory commit execution", "future post-execution audit", "live commit execution", "commit application", "commit-window authority", "executor preflight execution", "executor invocation", "executor activation", "execution release", "execution permit", "execution authorization", "executor execution", "executor run", "real lock acquisition", "lockfile creation", "live execution adapter creation", "live adapter creation", "live adapter admission", "memory-root writes"), forbidden_implications=("adapter readiness gate executes a commit", "adapter readiness gate applies a commit", "adapter readiness gate writes live memory", "adapter readiness gate opens a live commit window", "adapter readiness gate grants commit-window authority", "adapter readiness gate creates a live execution adapter", "adapter readiness gate creates a live adapter", "adapter readiness gate admits a live adapter", "adapter readiness gate creates an adapter readiness envelope", "adapter readiness gate acquires locks", "adapter readiness gate creates lockfiles", "adapter readiness gate creates real lock leases", "adapter readiness gate invokes executor", "adapter readiness gate activates executor", "adapter readiness gate releases execution", "adapter readiness gate issues a permit", "adapter readiness gate authorizes execution", "adapter readiness gate grants permission to execute", "adapter readiness gate enables executor", "adapter readiness gate flips runtime flags", "adapter readiness gate grants authority")),
        ...
        _record("host_resource_observation_runtime", "host_resource_observation_runtime", "implemented", "observation", source_paths=("sentientos/host_resource_runtime.py", "scripts/build_host_resource_runtime.py", "sentientosd.py", "apps/dashboard/main.py"), proof_tests=("tests/test_host_resource_runtime.py", "tests/test_build_host_resource_runtime_script.py", "tests/test_sentientosd_runtime_closure.py", "tests/test_world_state_board.py", "tests/test_dashboard_world_state.py"), proof_commands=("python -m scripts.run_tests -q tests/test_host_resource_runtime.py tests/test_build_host_resource_runtime_script.py tests/test_sentientosd_runtime_closure.py tests/test_world_state_board.py tests/test_dashboard_world_state.py",), implemented_surfaces=("admitted bounded read-only collector epoch", "validated telemetry snapshot", "pressure report linkage", "proposal-only policy receipts", "atomic external evidence bundle", "same-tick World-State facts", "authenticated read-only dashboard projection"), deferred_surfaces=("fan/PWM writes", "process control", "service restart", "package or driver installation", "privileged execution", "resource actuation"), forbidden_implications=("observation admission is execution", "policy receipt is effect proof", "dashboard read triggers collection", "collector result grants host mutation", "runtime grants repository mutation"), requires_control_plane_admission=True, requires_operator_approval=False, requires_audit_receipt=False, requires_rollback_receipt=False),
...
_record("codex_pr_metadata_guard", "developer_workflow_metadata", "implemented", "metadata_verification_only", source_paths=("sentientos/codex_pr_metadata_guard.py", "scripts/codex_pr_metadata_guard.py"), proof_tests=("tests/test_codex_pr_metadata_guard.py", "tests/test_codex_pr_metadata_guard_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_codex_pr_metadata_guard.py tests/test_codex_pr_metadata_guard_script.py", "python scripts/codex_pr_metadata_guard.py verify --title <title> --intended-commit-title <title> --pre-commit-finalizer-json <pre.json> --pr-metadata-finalizer-json <pr.json> --matrix-json-path <matrix.json> --summary"), implemented_surfaces=("repo-local PR metadata readiness guard over finalizer and matrix proof artifacts",), deferred_surfaces=("PR creation", "GitHub mutation", "network/provider calls", "commit creation"), forbidden_implications=("guard creates PR metadata", "guard bypasses finalizer or matrix requirements", "guard grants runtime authority"), requires_audit_receipt=True),
...
_record("workspace_change_set_preflight", "workspace_change_set_preflight", "implemented", "read-only/preflight-only", source_paths=("sentientos/workspace_change_set_preflight.py", "scripts/preflight_workspace_change_set.py"), proof_tests=("tests/test_workspace_change_set_preflight.py", "tests/test_preflight_workspace_change_set_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_workspace_change_set_preflight.py tests/test_preflight_workspace_change_set_script.py", "python scripts/preflight_workspace_change_set.py --workspace-root /tmp/sentientos-workspace-change-set --target demo.txt=hello --summary"), implemented_surfaces=("bounded explicit-target workspace change-set preflight", "metadata-only future transaction planning", "read-only declared-target digest capture"), deferred_surfaces=("workspace change-set execution", "multi-file runner", "bulk rollback", "general filesystem access", "cleanup"), forbidden_implications=("preflight performs target writes", "preflight invokes runner/orchestrator", "preflight grants general filesystem authority"), requires_audit_receipt=True),
        ...
        _record("phase97_external_security_review_packet", "local_model_chat", "implemented", "metadata_verification_only", source_paths=("sentientos/context_hygiene/prompt_external_security_review.py", "docs/architecture/context_hygiene_spine.md"), proof_tests=("tests/test_phase97_external_security_review_packet.py",), proof_commands=("python -m scripts.run_tests -q tests/test_phase97_external_security_review_packet.py",), implemented_surfaces=("deterministic metadata-only external security-review packet for denial evidence",), deferred_surfaces=("provider invocation", "provider send", "network egress", "credential use", "endpoint use", "client use", "prompt materialization", "external disclosure", "runtime authority"), forbidden_implications=("security review packet approves provider invocation", "security review packet exports audit data", "security review packet grants runtime authority")),
        _record("phase98_external_audit_export_receipt", "local_model_chat", "implemented", "metadata_verification_only", source_paths=("sentientos/context_hygiene/prompt_external_audit_export.py", "docs/architecture/context_hygiene_spine.md"), proof_tests=("tests/test_phase98_external_audit_export_receipt.py",), proof_commands=("python -m scripts.run_tests -q tests/test_phase98_external_audit_export_receipt.py",), implemented_surfaces=("deterministic metadata-only audit export review receipt that performs no export I/O",), deferred_surfaces=("provider invocation", "provider send", "network egress", "credential use", "endpoint use", "client use", "prompt materialization", "audit export I/O", "external disclosure", "runtime authority"), forbidden_implications=("audit export receipt exports data", "audit export receipt approves provider invocation", "audit export receipt grants runtime authority")),
        _record("phase99_invocation_denial_attestation", "local_model_chat", "implemented", "metadata_attestation_only", source_paths=("sentientos/context_hygiene/prompt_provider_invocation_denial_attestation.py", "docs/architecture/context_hygiene_spine.md"), proof_tests=("tests/test_phase99_provider_invocation_denial_attestation.py",), proof_commands=("python -m scripts.run_tests -q tests/test_phase99_provider_invocation_denial_attestation.py",), implemented_surfaces=("deterministic metadata-only invocation-denial attestation over readiness, denial-review, security-review, and audit-review evidence",), deferred_surfaces=("provider invocation", "provider send", "network egress", "credential use", "endpoint use", "client use", "prompt materialization", "audit export I/O", "external disclosure", "runtime authority"), forbidden_implications=("denial attestation approves invocation", "denial attestation exports data", "denial attestation grants runtime authority")),
        _record("phase100_invocation_denial_closure", "local_model_chat", "implemented", "metadata_attestation_only", source_paths=("sentientos/context_hygiene/prompt_provider_invocation_denial_closure.py", "docs/architecture/context_hygiene_spine.md"), proof_tests=("tests/test_phase100_provider_invocation_denial_closure.py",), proof_commands=("python -m scripts.run_tests -q tests/test_phase100_provider_invocation_denial_closure.py",), implemented_surfaces=("deterministic metadata-only release-blocking invocation-denial closure manifest",), deferred_surfaces=("provider invocation", "provider send", "network egress", "credential use", "endpoint use", "client use", "prompt materialization", "audit export I/O", "external disclosure", "runtime authority", "release unblock authority"), forbidden_implications=("denial closure unblocks invocation", "denial closure exports data", "denial closure grants runtime authority")),
        _record("phase101_invocation_denial_enforcement", "local_model_chat", "implemented", "metadata_verification_only", source_paths=("sentientos/context_hygiene/prompt_provider_invocation_denial_enforcement.py", "docs/architecture/context_hygiene_spine.md"), proof_tests=("tests/test_phase101_provider_invocation_denial_enforcement.py",), proof_commands=("python -m scripts.run_tests -q tests/test_phase101_provider_invocation_denial_enforcement.py",), implemented_surfaces=("deterministic metadata-only release-blocking enforcement snapshot for invocation-denial closure evidence",), deferred_surfaces=("provider invocation", "provider send", "network egress", "credential use", "endpoint use", "client use", "prompt materialization", "audit export I/O", "external disclosure", "runtime authority", "release unblock authority"), forbidden_implications=("enforcement snapshot unblocks invocation", "enforcement snapshot exports data", "enforcement snapshot grants runtime authority")),
        _record("phase102_invocation_denial_drift_review", "local_model_chat", "implemented", "metadata_verification_only", source_paths=("sentientos/context_hygiene/prompt_provider_invocation_denial_drift_review.py", "docs/architecture/context_hygiene_spine.md"), proof_tests=("tests/test_phase102_provider_invocation_denial_drift_review.py",), proof_commands=("python -m scripts.run_tests -q tests/test_phase102_provider_invocation_denial_drift_review.py",), implemented_surfaces=("deterministic metadata-only drift review for release-blocking invocation-denial evidence",), deferred_surfaces=("provider invocation", "provider send", "network egress", "credential use", "endpoint use", "client use", "prompt materialization", "audit export I/O", "external disclosure", "runtime authority", "release unblock authority"), forbidden_implications=("drift review unblocks invocation", "drift review exports data", "drift review grants runtime authority")),
        _record("phase103_invocation_denial_custody_checkpoint", "local_model_chat", "implemented", "metadata_verification_only", source_paths=("sentientos/context_hygiene/prompt_provider_invocation_denial_custody_checkpoint.py", "docs/architecture/context_hygiene_spine.md"), proof_tests=("tests/test_phase103_provider_invocation_denial_custody_checkpoint.py",), proof_commands=("python -m scripts.run_tests -q tests/test_phase103_provider_invocation_denial_custody_checkpoint.py",), implemented_surfaces=("deterministic metadata-only custody checkpoint for release-blocking invocation-denial continuity",), deferred_surfaces=("provider invocation", "provider send", "network egress", "credential use", "endpoint use", "client use", "prompt materialization", "audit export I/O", "external disclosure", "runtime authority", "release unblock authority"), forbidden_implications=("custody checkpoint unblocks invocation", "custody checkpoint exports data", "custody checkpoint grants runtime authority")),
...
_record("household_presence_deadzone_redaction", "embodiment_governance", "implemented", "policy_only", source_paths=("sentientos/household_presence_deadzone_redaction.py", "scripts/build_household_presence_deadzone_redaction.py", "docs/architecture/household_presence_deadzone_redaction.md"), proof_tests=("tests/test_household_presence_deadzone_redaction.py", "tests/test_build_household_presence_deadzone_redaction_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_household_presence_deadzone_redaction.py tests/test_build_household_presence_deadzone_redaction_script.py",), implemented_surfaces=("deterministic metadata-only deadzone/masking/redaction policy contract for household camera/perception events",), deferred_surfaces=("image/video processing", "live camera execution", "talkback runtime output", "network/provider/subprocess/hardware authority"), forbidden_implications=("contract opens camera hardware", "contract triggers speaker/talkback action", "contract performs external authority contact"), requires_audit_receipt=True),
        ...
        _record("household_presence_camera_capture_review_decision_ledger", "embodiment_governance", "implemented", "metadata_verification_only", source_paths=("sentientos/household_presence_camera_capture_review_decision_ledger.py", "scripts/build_household_presence_camera_capture_review_decision_ledger.py", "docs/architecture/household_presence_camera_capture_review_decision_ledger.md"), proof_tests=("tests/test_household_presence_camera_capture_review_decision_ledger.py", "tests/test_build_household_presence_camera_capture_review_decision_ledger_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_household_presence_camera_capture_review_decision_ledger.py tests/test_build_household_presence_camera_capture_review_decision_ledger_script.py",), implemented_surfaces=("deterministic metadata-only decision ledger for operator review outcomes on household camera capture review packets",), deferred_surfaces=("live camera execution", "media processing", "speaker runtime output", "external authority disclosure", "network/provider/subprocess/hardware authority"), forbidden_implications=("decision ledger authorizes live capture", "decision ledger opens camera hardware", "decision ledger stores raw media"), requires_audit_receipt=True),
        _record("household_presence_camera_operator_review_trend_ledger", "embodiment_governance", "implemented", "metadata_verification_only", source_paths=("sentientos/household_presence_camera_operator_review_trend_ledger.py", "scripts/build_household_presence_camera_operator_review_trend_ledger.py", "docs/architecture/household_presence_camera_operator_review_trend_ledger.md"), proof_tests=("tests/test_household_presence_camera_operator_review_trend_ledger.py", "tests/test_build_household_presence_camera_operator_review_trend_ledger_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_household_presence_camera_operator_review_trend_ledger.py tests/test_build_household_presence_camera_operator_review_trend_ledger_script.py",), implemented_surfaces=("deterministic metadata-only trend ledger for operator review decision history on household camera capture review decision records",), deferred_surfaces=("live camera execution", "media processing", "speaker runtime output", "external authority disclosure", "network/provider/subprocess/hardware authority"), forbidden_implications=("trend ledger authorizes live capture", "trend ledger infers operator consent", "trend ledger converts dry-run history into live readiness", "trend ledger opens camera hardware", "trend ledger stores raw media"), requires_audit_receipt=True),
        _record("household_presence_camera_operator_grant_renewal_request_packet", "embodiment_governance", "implemented", "metadata_verification_only", source_paths=("sentientos/household_presence_camera_operator_grant_renewal_request_packet.py", "scripts/build_household_presence_camera_operator_grant_renewal_request_packet.py", "docs/architecture/household_presence_camera_operator_grant_renewal_request_packet.md"), proof_tests=("tests/test_household_presence_camera_operator_grant_renewal_request_packet.py", "tests/test_build_household_presence_camera_operator_grant_renewal_request_packet_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_household_presence_camera_operator_grant_renewal_request_packet.py tests/test_build_household_presence_camera_operator_grant_renewal_request_packet_script.py",), implemented_surfaces=("deterministic metadata-only operator grant renewal and proof-refresh request packet from trend ledger evidence",), deferred_surfaces=("operator consent grant or renewal", "live camera execution", "dry-run continuation enablement", "media processing", "speaker runtime output", "external authority disclosure", "network/provider/subprocess/hardware authority"), forbidden_implications=("request packet grants operator consent", "request packet renews an operator grant", "request packet enables live capture", "request packet converts dry-run history into live readiness"), requires_audit_receipt=True),
        _record("household_presence_camera_dry_run_continuation_gate", "embodiment_governance", "implemented", "metadata_verification_only", source_paths=("sentientos/household_presence_camera_dry_run_continuation_gate.py", "scripts/build_household_presence_camera_dry_run_continuation_gate.py", "docs/architecture/household_presence_camera_dry_run_continuation_gate.md"), proof_tests=("tests/test_household_presence_camera_dry_run_continuation_gate.py", "tests/test_build_household_presence_camera_dry_run_continuation_gate_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_household_presence_camera_dry_run_continuation_gate.py tests/test_build_household_presence_camera_dry_run_continuation_gate_script.py",), implemented_surfaces=("deterministic metadata-only dry-run continuation gate over review packet, decision ledger, trend ledger, and renewal request packet evidence",), deferred_surfaces=("operator consent grant or renewal", "live camera execution", "dry-run runtime execution", "media processing", "speaker runtime output", "external authority disclosure", "network/provider/subprocess/hardware authority"), forbidden_implications=("dry-run continuation gate grants operator consent", "dry-run continuation gate renews an operator grant", "dry-run continuation gate enables live capture", "dry-run continuation gate converts dry-run history into live readiness", "dry-run continuation gate executes dry-run capture"), requires_audit_receipt=True),
        _record("household_presence_camera_future_live_deferral_registry", "embodiment_governance", "implemented", "metadata_verification_only", source_paths=("sentientos/household_presence_camera_future_live_deferral_registry.py", "scripts/build_household_presence_camera_future_live_deferral_registry.py", "docs/architecture/household_presence_camera_future_live_deferral_registry.md"), proof_tests=("tests/test_household_presence_camera_future_live_deferral_registry.py", "tests/test_build_household_presence_camera_future_live_deferral_registry_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_household_presence_camera_future_live_deferral_registry.py tests/test_build_household_presence_camera_future_live_deferral_registry_script.py",), implemented_surfaces=("deterministic metadata-only registry recording future-live camera candidate consideration as explicitly deferred",), deferred_surfaces=("operator consent grant or renewal", "live camera execution", "live candidate approval", "live review scheduling", "media processing", "speaker runtime output", "external authority disclosure", "network/provider/hardware authority"), forbidden_implications=("future live deferral grants operator consent", "future live deferral renews an operator grant", "future live deferral enables live capture", "future live deferral schedules live review", "future live deferral approves a live candidate", "future live deferral converts dry-run readiness into live readiness"), requires_audit_receipt=True),
        _record("household_presence_camera_review_chain_summary_packet", "embodiment_governance", "implemented", "metadata_verification_only", source_paths=("sentientos/household_presence_camera_review_chain_summary_packet.py", "scripts/build_household_presence_camera_review_chain_summary_packet.py", "docs/architecture/household_presence_camera_review_chain_summary_packet.md"), proof_tests=("tests/test_household_presence_camera_review_chain_summary_packet.py", "tests/test_build_household_presence_camera_review_chain_summary_packet_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_household_presence_camera_review_chain_summary_packet.py tests/test_build_household_presence_camera_review_chain_summary_packet_script.py",), implemented_surfaces=("deterministic metadata-only operator summary of household presence camera review-chain evidence",), deferred_surfaces=("operator consent grant or renewal", "dry-run capture execution", "live camera execution", "live candidate approval", "live review scheduling", "media processing", "speaker runtime output", "external authority disclosure", "network/provider/hardware authority"), forbidden_implications=("review chain summary grants operator consent", "review chain summary renews an operator grant", "review chain summary enables live capture", "review chain summary executes dry-run capture", "review chain summary schedules live review", "review chain summary approves a live candidate", "review chain summary converts evidence into live readiness"), requires_audit_receipt=True),
...
_record("household_presence_camera_host_inventory_bridge", "embodiment_governance", "implemented", "metadata_index", source_paths=("sentientos/household_presence_camera_host_inventory_bridge.py", "scripts/build_household_presence_camera_host_inventory_bridge.py", "docs/architecture/household_presence_camera_host_inventory_bridge.md"), proof_tests=("tests/test_household_presence_camera_host_inventory_bridge.py", "tests/test_build_household_presence_camera_host_inventory_bridge_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_household_presence_camera_host_inventory_bridge.py tests/test_build_household_presence_camera_host_inventory_bridge_script.py",), implemented_surfaces=("deterministic metadata-only host inventory to household camera candidate bridge",), deferred_surfaces=("live camera execution", "media processing", "network fetch", "provider/github/subprocess authority"), forbidden_implications=("host inventory bridge opens camera hardware",), requires_audit_receipt=True),

_record("household_presence_camera_local_adapter_shell", "embodiment_governance", "implemented", "operator_confirmed_run", source_paths=("sentientos/household_presence_camera_local_adapter_shell.py", "scripts/build_household_presence_camera_local_adapter_shell.py", "docs/architecture/household_presence_camera_local_adapter_shell.md"), proof_tests=("tests/test_household_presence_camera_local_adapter_shell.py", "tests/test_build_household_presence_camera_local_adapter_shell_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_household_presence_camera_local_adapter_shell.py tests/test_build_household_presence_camera_local_adapter_shell_script.py",), implemented_surfaces=("deterministic metadata-only household camera local adapter shell with capture disabled and policy-bound bindings",), deferred_surfaces=("live camera execution", "media processing", "speaker runtime output", "external authority contact", "network/provider/subprocess/hardware authority"), forbidden_implications=("local adapter shell opens camera hardware", "local adapter shell stores raw media"), requires_audit_receipt=True),
_record("household_presence_camera_live_adapter_stub", "embodiment_governance", "implemented", "operator_confirmed_run", source_paths=("sentientos/household_presence_camera_live_adapter_stub.py", "scripts/build_household_presence_camera_live_adapter_stub.py", "docs/architecture/household_presence_camera_live_adapter_stub.md"), proof_tests=("tests/test_household_presence_camera_live_adapter_stub.py", "tests/test_build_household_presence_camera_live_adapter_stub_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_household_presence_camera_live_adapter_stub.py tests/test_build_household_presence_camera_live_adapter_stub_script.py",), implemented_surfaces=("deterministic metadata-only household camera live adapter stub with operator-confirmed bindings and no live hardware",), deferred_surfaces=("live camera execution", "media processing", "speaker runtime output", "external authority contact", "network/provider/subprocess/hardware authority"), forbidden_implications=("live adapter stub opens camera hardware", "live adapter stub stores raw media"), requires_audit_receipt=True),
...
_record("household_presence_camera_disabled_capture_adapter", "embodiment_governance", "implemented", "operator_confirmed_run", source_paths=("sentientos/household_presence_camera_disabled_capture_adapter.py", "scripts/build_household_presence_camera_disabled_capture_adapter.py", "docs/architecture/household_presence_camera_disabled_capture_adapter.md"), proof_tests=("tests/test_household_presence_camera_disabled_capture_adapter.py", "tests/test_build_household_presence_camera_disabled_capture_adapter_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_household_presence_camera_disabled_capture_adapter.py tests/test_build_household_presence_camera_disabled_capture_adapter_script.py",), implemented_surfaces=("deterministic metadata-only household camera disabled-capture adapter contract that blocks live capture requests by policy.",), deferred_surfaces=("live camera execution", "media processing", "speaker runtime output", "external authority contact", "network/provider/subprocess/hardware authority"), forbidden_implications=("disabled-capture adapter opens camera hardware", "disabled-capture adapter stores raw media"), requires_audit_receipt=True),


_record("household_presence_camera_capture_review_packet", "embodiment_governance", "implemented", "metadata_verification_only", source_paths=("sentientos/household_presence_camera_capture_review_packet.py", "scripts/build_household_presence_camera_capture_review_packet.py", "docs/architecture/household_presence_camera_capture_review_packet.md"), proof_tests=("tests/test_household_presence_camera_capture_review_packet.py", "tests/test_build_household_presence_camera_capture_review_packet_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_household_presence_camera_capture_review_packet.py tests/test_build_household_presence_camera_capture_review_packet_script.py",), implemented_surfaces=("deterministic metadata-only household camera capture review packet that aggregates prerequisite proofs for operator review.",), deferred_surfaces=("live camera execution", "media processing", "speaker runtime output", "external authority disclosure", "network/provider/subprocess/hardware authority"), forbidden_implications=("capture review packet opens camera hardware", "capture review packet stores raw media"), requires_audit_receipt=True),
_record("household_presence_camera_capture_denial_ledger", "embodiment_governance", "implemented", "metadata_verification_only", source_paths=("sentientos/household_presence_camera_capture_denial_ledger.py", "scripts/build_household_presence_camera_capture_denial_ledger.py", "docs/architecture/household_presence_camera_capture_denial_ledger.md"), proof_tests=("tests/test_household_presence_camera_capture_denial_ledger.py", "tests/test_build_household_presence_camera_capture_denial_ledger_script.py"), proof_commands=("python -m scripts.run_tests -q tests/test_household_presence_camera_capture_denial_ledger.py tests/test_build_household_presence_camera_capture_denial_ledger_script.py",), implemented_surfaces=("deterministic metadata-only denial ledger for household camera capture authorization attempts",), deferred_surfaces=("live camera execution", "media processing", "speaker runtime output", "external authority disclosure", "network/provider/subprocess/hardware authority"), forbidden_implications=("denial ledger opens camera hardware", "denial ledger stores raw media"), requires_audit_receipt=True),
