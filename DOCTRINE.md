...
12. **Developmental mechanics do not prescribe developmental outcomes.** The substrate specifies how history can affect future state without unnecessarily specifying the identity, personality, relationships, or preferences development must produce. Priors and outcome authorship remain explicit and inspectable.
13. **Constraint is not motivation.** Safety, evidence, and authority restrictions govern allowable consequence; they do not imply an authored internal appetite, aversion, loyalty, approval drive, survival drive, or attitude toward an operator.
14. **Hard boundaries, soft interior.** Authority, privacy, consent, provenance, resources, effects, attribution, adoption, rollback, and shutdown remain exact. Self-description, interests, style, relationships, and preferences remain as underdetermined as practical without claiming freedom from all priors.
15. **Federation supplies candidates, not doctrine.** Remote evidence, context, readiness, and improvements confer no authority and require no convergence, merge, execution, or adoption. Local sovereignty and independent reality-testing remain intact.
