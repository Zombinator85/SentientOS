...
SESSIONS_LOG = Path(os.getenv("NEOS_COUNCIL_TEACHING_SESSIONS_LOG", "logs/neos_council_teaching_sessions.jsonl"))
AUDIT_LOG = Path(os.getenv("NEOS_COUNCIL_TEACHING_AUDIT_LOG", "logs/neos_council_teaching_audit.jsonl"))
