...
## Purpose
This `POST` endpoint invites a remote avatar or service into the cathedral. The request is logged and a short consent procedure occurs before any data is exchanged.
