...
- `tests/test_host_local_diagnostic_lifecycle_closure.py::test_process_death_after_packet_rename_recovers_pointer_without_rewriting_packet`
- `tests/test_host_local_diagnostic_lifecycle_closure.py::test_process_death_with_staging_releases_lock_and_next_builder_reconciles_residue`
- `tests/test_host_local_diagnostic_lifecycle_closure.py::test_process_shared_lock_allows_only_one_publication_critical_section`
- `tests/test_host_local_diagnostic_lifecycle_closure.py::test_malformed_or_symlinked_staging_residue_fails_closed_without_unrelated_deletion`
- `tests/test_host_local_diagnostic_lifecycle_closure.py::test_cross_process_results_bind_one_closure_and_packet_digest`
