...
2. Run `python collect_schema_integrity issues.py` on your logs.
...
6. Update `docs/CONTRIBUTORS.md` with your name under **Audit Contributors**.

Your contribution will be remembered in the ledger and README. Monthly sprints recap integrity issue counts
and highlight new contributors on the [Cathedral Integrity issues Dashboard](CATHEDRAL_WOUNDS_DASHBOARD.md).
Sprint metrics are summarized in [SPRINT_LEDGER.md](SPRINT_LEDGER.md) after each workshop.

## Community Highlights
Contributor stories and healed counts are shared in a monthly recap post titled
...
**Share Your Contributor Story** issue template. Merged stories appear in the ledger
and will be mentioned during public meetings.

## Public Recap and Outreach
After each sprint publish a short "Cathedral Healing Sprint Recap" on your blog or social channel. Include metrics from `docs/SPRINT_LEDGER.md` and a brief contributor story. Link back to this repository and invite reviewers to audit your ledger.
