...
def append_memory(text: str, tags: List[str] | None = None, source: str = "unknown", emotion: str | None = None) -> str:
...
def write_mem(text: str, tags: List[str] | None = None, source: str = "unknown", emotion: str | None = None) -> str:
    return append_memory(text, tags, source, emotion)
