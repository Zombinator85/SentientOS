...
MODULE_SPECIFIC_METADATA_FIELD_ALLOWLIST: Mapping[str, frozenset[str]] = {
    ...
    "sentientos/context_hygiene/prompt_provider_invocation_denial_enforcement.py": frozenset(
        {
            ...
            "phase100_closure_manifest_id",
            "phase100_closure_digest",
            "expected_phase100_closure_digest",
            "phase100_digest_match",
            "phase100_closure_status",
            "phase100_release_blocker_status",
            "prompt_boundary_guardrail_clean",
            "architecture_boundaries_clean",
            "architecture_classification_clean",
            "architecture_classification_digest",
            "provider_invocation_denial_enforcement_snapshot_only",
            "phase101_enforcement_snapshot",
            "phase100_closure_manifest_consumed",
    ...
    "sentientos/context_hygiene/prompt_provider_invocation_denial_drift_review.py": frozenset(
        {
            ...
            "phase100_closure_manifest_id",
            "phase100_closure_digest",
            "phase100_computed_closure_digest",
            "phase100_closure_status",
            "phase100_release_blocker_status",
            "phase101_enforcement_snapshot_id",
            "phase101_enforcement_digest",
            "phase101_computed_enforcement_digest",
            "phase101_expected_phase100_closure_digest",
            "phase101_enforcement_status",
            "phase101_release_blocked",
            "architecture_classification_digest",
            "architecture_classification_clean",
            "architecture_provider_invocation_allowed",
            "architecture_runtime_authority_allowed",
            "prompt_boundary_scan_status",
            "prompt_boundary_scan_target_count",
            "prompt_boundary_scan_finding_count",
            "prompt_boundary_phase100_target_present",
            "prompt_boundary_phase101_target_present",
            "prompt_boundary_phase102_target_present",
            "allowlist_label_count",
            "allowlist_metadata_only",
            "metadata_only_source_count",
            "closure_enforcement_status_consistency",
            "release_blocker_consistency",
            "architecture_classification_consistency",
            "prompt_boundary_scan_coverage_consistency",
            "no_provider_no_network_no_export_no_runtime_no_prompt_text_consistency",
            "no_clearance_no_unblock_consistency",
            "drift_review_id",
            "drift_status",
            "drift_scope",
            "drift_ref",
            "drift_label",
            "drift_digest",
            "phase102_drift_review",
            "provider_invocation_denial_drift_review_only",
            "drift_clean_or_fail_closed",
            "prompt_assembler_modified",
            "provider_invocation_performed",
            "network_egress_performed",
            "export_io_performed",
    ...
    "sentientos/context_hygiene/prompt_provider_invocation_denial_custody_checkpoint.py": frozenset(
        {
            ...
            "phase101_enforcement_status",
            "phase101_release_blocked",
            "phase102_drift_review_id",
            "phase102_drift_digest",
            "phase102_computed_drift_digest",
            "phase102_phase100_closure_digest",
            "phase102_phase101_enforcement_digest",
            "phase102_drift_status",
            "phase102_release_blocked",
            "strict_audit_status",
            "strict_audit_command_result",
            "strict_audit_verified",
            "immutable_manifest_status",
            "immutable_manifest_command_result",
            ...
            "prompt_boundary_phase101_target_present",
            "prompt_boundary_phase102_target_present",
            "prompt_boundary_phase103_target_present",
            "allowlist_label_count",
            "allowlist_metadata_only",
            "metadata_only_source_count",
            "phase100_closure_custody",
            "phase101_enforcement_custody",
            "phase102_drift_review_custody",
            "strict_audit_verification_custody",
            "immutable_manifest_verification_custody",
            "architecture_classification_custody",
            "prompt_boundary_scan_custody",
            "release_blocker_continuity",
            "no_provider_no_network_no_export_no_runtime_no_prompt_text_continuity",
            "no_clearance_no_unblock_continuity",
            ...
            "checkpoint_label",
            "custody_digest",
            "phase103_custody_checkpoint",
            "provider_invocation_denial_custody_checkpoint_only",
            "custody_clean_or_fail_closed",
            "audit_verified",
            "immutable_verified",
            "prompt_assembler_modified",
            "provider_invocation_performed",
