...
from sentientos.real_memory_root_admission_packet import (  # noqa: E402
    FAIL_STATUSES,
...
FIXTURE_ROOT = Path("tests/fixtures/real_memory_root_admission_packet")
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Build deterministic metadata-only Real Memory Root Admission Packet evidence.")
    ...
    if args.command == "validate":
        if args.packet:
            result = evaluate_real_memory_root_admission_packet(_load(args.packet))
