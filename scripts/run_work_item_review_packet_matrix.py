...
def default_matrix_commands() -> list[MatrixCommand]:
    commands = [
        ...
        MatrixCommand("host_fulfillment_authorization_consumption_custody_tests", ("python", "-m", "scripts.run_tests", "-q", "tests/test_host_fulfillment_authorization_runtime.py", "tests/test_build_host_fulfillment_authorization_runtime_script.py", "tests/test_host_local_authorization_runtime.py", "tests/test_local_authorization_grant.py", "tests/test_fulfillment_authorization.py", "tests/test_fulfillment_executor_contract.py", "tests/test_control_plane_kernel.py", "tests/test_sentientosd_runtime_closure.py", "tests/test_world_state_board.py", "tests/test_dashboard_world_state.py", "tests/test_capability_registry.py", "tests/test_reviewer_proof_bundle.py", "tests/test_codex_validation_matrix_lane_contract.py", "tests/test_repository_mutation_custody_regression.py")),
        ...
        MatrixCommand("codex_landing_commit_body_binding_tests", ("python", "-m", "scripts.run_tests", "-q", "tests/test_codex_landing_evidence_binding.py", "tests/test_verify_codex_landing_evidence_binding_script.py", "tests/test_codex_finalize_landing.py", "tests/test_codex_pr_metadata_guard.py", "tests/test_build_codex_landing_evidence_body_script.py", "tests/test_codex_pr_landing_gate.py", "tests/test_codex_landing_supervisor.py", "tests/test_codex_validation_matrix_lane_contract.py")),
