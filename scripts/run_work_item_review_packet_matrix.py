...
def default_matrix_commands() -> list[MatrixCommand]:
    commands = [
        ...
        MatrixCommand("local_model_artifact_acquisition_tests", ("python", "-m", "scripts.run_tests", "-q", "tests/test_local_model_artifact_acquisition.py", "tests/test_local_model_artifact_acquisition_script.py")),
        MatrixCommand("local_model_production_commissioning_tests", ("python", "-m", "scripts.run_tests", "-q", "tests/test_local_model_production_commissioning.py")),
        MatrixCommand("local_model_production_commissioning_boundary", ("python", "scripts/verify_local_model_production_commissioning.py")),
        ...
        MatrixCommand("resident_developmental_cognition_tests", ("python", "-m", "scripts.run_tests", "-q", "tests/test_developmental_model_replacement_campaign.py", "tests/test_developmental_model_replacement_experiment.py", "tests/test_developmental_history_intervention_experiment.py", "tests/test_resident_developmental_cognition.py", "tests/test_resident_developmental_writeback.py", "tests/test_resident_developmental_writeback_capability_admission.py", "tests/test_runtime_admission.py", "tests/test_governed_local_model_invocation.py", "tests/test_sentientosd_runtime_closure.py", "tests/test_capability_registry.py")),
        ...
        MatrixCommand("docs_build", ("python", "scripts/build_docs.py", "--bootstrap-if-missing")),
