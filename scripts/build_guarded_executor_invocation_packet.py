...
from sentientos.guarded_executor_invocation_packet import (  # noqa: E402
    FAIL_STATUSES,
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Build deterministic metadata-only guarded executor invocation packets.")
    ...
    if args.command == "validate":
        if args.packet:
            result = evaluate_guarded_executor_invocation_packet(_load(args.packet))
