...
FIXTURE_ROOT = Path("tests/fixtures/real_executor_runtime_enablement_packet")
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Build deterministic metadata-only real executor runtime enablement packets.")
    ...
    if args.command == "validate":
        if args.packet:
            result = evaluate_real_executor_runtime_enablement_packet(_load(args.packet))
