...
from sentientos.final_live_memory_commit_review_gate import (  # noqa: E402
    FAIL_STATUSES,
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Build deterministic metadata-only Final Live Memory Commit Review Gate evidence.")
    ...
    if args.command == "validate":
        if args.gate:
            result = evaluate_final_live_memory_commit_review_gate(_load(args.gate))
