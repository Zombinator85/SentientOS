...
def emit_contract_status(output_path: Path = DEFAULT_OUTPUT) -> dict[str, Any]:
    ...
    contracts = [
        ...
        _artifact_status(domain_name="federation_quorum_policy", artifact_path=Path("glow/federation/federation_quorum_policy.json"), git_sha=git_sha),
        _artifact_status(domain_name="governance_digest_status", artifact_path=Path("glow/federation/governance_digest.json"), git_sha=git_sha),
        _artifact_status(domain_name="peer_governance_digests", artifact_path=Path("glow/federation/peer_governance_digests.json"), git_sha=git_sha),
        ...
        _artifact_status(domain_name="pulse_protocol_posture", artifact_path=Path("glow/federation/pulse_protocol_posture.json"), git_sha=git_sha),
        _artifact_status(domain_name="equivocation_summary", artifact_path=Path("glow/federation/equivocation_summary.json"), git_sha=git_sha),
        ...
        _artifact_status(domain_name="baseline_verification_status", artifact_path=Path("glow/contracts/baseline_verification_status.json"), git_sha=git_sha),
        _artifact_status(domain_name="run_tests_provenance", artifact_path=Path("glow/test_runs/test_run_provenance.json"), git_sha=git_sha),
        _artifact_status(domain_name="run_tests_failure_digest", artifact_path=Path("glow/test_runs/test_failure_digest.json"), git_sha=git_sha),
        _artifact_status(domain_name="mypy_ratchet_status", artifact_path=Path("glow/contracts/typing_ratchet_status.json"), git_sha=git_sha),
        _artifact_status(domain_name="mypy_ratchet_event_status", artifact_path=Path("glow/forge/ratchets/mypy_ratchet_status.json"), git_sha=git_sha),
        _artifact_status(domain_name="run_tests_latest_pointer", artifact_path=Path("glow/observatory/broad_lane/run_tests_latest_pointer.json"), git_sha=git_sha),
        _artifact_status(domain_name="mypy_latest_pointer", artifact_path=Path("glow/observatory/broad_lane/mypy_latest_pointer.json"), git_sha=git_sha),
...
def _protected_mutation_proof_status(*, git_sha: str, repo_root: Path) -> dict[str, Any]:
    ...
    report_payload = {
        ...
        "covered_corridor_non_bypass_model": non_bypass_model_definition(),
        "report_scope": {
