...
FIXTURE_ROOT = Path("tests/fixtures/live_executor_activation_record")
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Build deterministic metadata-only live executor activation records.")
    ...
    if args.command == "validate":
        if args.packet:
            result = evaluate_live_executor_activation_record(_load(args.packet))
