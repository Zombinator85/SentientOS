...
from sentientos.real_executor_execution_activation_packet import (  # noqa: E402
    FAIL_STATUSES,
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Build deterministic metadata-only real executor execution activation packets.")
    ...
    if args.command == "validate":
        if args.packet:
            result = evaluate_real_executor_execution_activation_packet(_load(args.packet))
