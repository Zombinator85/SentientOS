...
from sentientos.real_memory_root_admission_gate import (  # noqa: E402
    FAIL_STATUSES,
...
FIXTURE_ROOT = Path("tests/fixtures/real_memory_root_admission_gate")
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Build deterministic metadata-only Real Memory Root Admission Gate evidence.")
    ...
    if args.command == "validate":
        if args.gate:
            result = evaluate_real_memory_root_admission_gate(_load(args.gate))
