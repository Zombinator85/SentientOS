...
FIXTURE_ROOT = Path("tests/fixtures/live_commit_execution_packet")
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Build deterministic metadata-only live commit execution packets.")
    ...
    if args.command == "validate":
        if args.packet:
            result = evaluate_live_commit_execution_packet(_load(args.packet))
