...
from sentientos.real_live_memory_commit_adapter_admission_gate import (  # noqa: E402
    FAIL_STATUSES,
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Build deterministic metadata-only real live memory commit adapter admission gate evidence.")
    ...
    if args.command == "validate":
        if args.gate:
            result = evaluate_real_live_memory_commit_adapter_admission_gate(_load(args.gate))
