...
FIXTURE_ROOT = Path("tests/fixtures/constrained_executor_enablement_path_packet")
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Build deterministic metadata-only constrained executor enablement path packets.")
    ...
    if args.command == "validate":
        if args.packet:
            result = evaluate_constrained_executor_enablement_path_packet(_load(args.packet))
