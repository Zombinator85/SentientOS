...
from sentientos.real_executor_execution_commit_plan_packet import (  # noqa: E402
    FAIL_STATUSES,
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Build deterministic metadata-only real executor execution commit plan packets.")
    ...
    if args.command == "validate":
        if args.packet:
            result = evaluate_real_executor_execution_commit_plan_packet(_load(args.packet))
