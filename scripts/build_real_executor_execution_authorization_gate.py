...
from sentientos.real_executor_execution_authorization_gate import (  # noqa: E402
    FAIL_STATUSES,
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Build deterministic metadata-only real executor execution authorization gates.")
    ...
    if args.command == "validate":
        if args.packet:
            result = evaluate_real_executor_execution_authorization_gate(_load(args.packet))
