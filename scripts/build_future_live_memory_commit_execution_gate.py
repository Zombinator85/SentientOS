...
FIXTURE_ROOT = Path("tests/fixtures/future_live_memory_commit_execution_gate")
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Build deterministic metadata-only future live memory commit execution gate packets.")
    ...
    if args.command == "validate":
        if args.packet:
            result = evaluate_future_live_memory_commit_execution_gate(_load(args.packet))
